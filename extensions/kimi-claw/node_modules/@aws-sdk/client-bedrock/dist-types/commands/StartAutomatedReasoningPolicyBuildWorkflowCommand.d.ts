...
import type { StartAutomatedReasoningPolicyBuildWorkflowRequest, StartAutomatedReasoningPolicyBuildWorkflowResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const StartAutomatedReasoningPolicyBuildWorkflowCommand_base: {
    new (input: StartAutomatedReasoningPolicyBuildWorkflowCommandInput): import("@smithy/core/client").CommandImpl<StartAutomatedReasoningPolicyBuildWorkflowCommandInput, StartAutomatedReasoningPolicyBuildWorkflowCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: StartAutomatedReasoningPolicyBuildWorkflowCommandInput): import("@smithy/core/client").CommandImpl<StartAutomatedReasoningPolicyBuildWorkflowCommandInput, StartAutomatedReasoningPolicyBuildWorkflowCommandOutput, BedrockClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
