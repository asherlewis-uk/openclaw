...
export const olmmachine_pushSecretToVerifiedDevices: (a: number, b: number, c: number) => any;
...
export const pkencryption_encrypt: (a: number, b: number, c: number) => [number, number, number];
export const pkencryption_encryptString: (a: number, b: number, c: number) => [number, number, number];
...
export const dehydrateddevicekey_createRandomKey: () => number;
export const wasm_bindgen__convert__closures_____invoke__h689504eec2264107: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h689504eec2264107_2: (a: number, b: number, c: any) => [number, number];
export const wasm_bindgen__convert__closures_____invoke__h7c82816401be08ca: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hbb6cab84dd9a19ee: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h0cab3a90231ee393: (a: number, b: number) => void;
