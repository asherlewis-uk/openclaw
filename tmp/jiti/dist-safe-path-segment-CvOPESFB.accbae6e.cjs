"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = assertSafePathSegment;exports.r = sanitizeSafePathSegment;exports.t = assertSafePathPrefix;var _pathBlG8lhgR = require("./path-BlG8lhgR.js");
...
function assertSafePathSegment(segment, options = {}) {
  if (!isSafePathSegment(segment, options)) throw new _pathBlG8lhgR.m("invalid-path", `${options.label ?? "path segment"} must be a safe path segment`);
  return segment;
}
