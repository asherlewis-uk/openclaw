...
var _publicSurfaceLoaderDWEAPKsr = require("./public-surface-loader-DWEAPKsr.js");
...
function tryLoadBundledProviderPolicySurface(pluginId) {
  for (const artifactBasename of PROVIDER_POLICY_ARTIFACT_CANDIDATES) try {
    const mod = (0, _publicSurfaceLoaderDWEAPKsr.t)({
      dirName: pluginId,
      artifactBasename
    });
...
function resolveBundledProviderPolicyPluginId(providerId, options = {}) {
  ...
  if (!(0, _bundledDirLBl9nCAz.n)()) return null;
  const registry = options.manifestRegistry ?? (0, _manifestRegistryDgt5vVG.t)();
