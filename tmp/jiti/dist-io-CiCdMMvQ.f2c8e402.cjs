"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.$ = resolveOwnerDisplaySetting;exports.A = applyConfigOverrides;exports.B = resolveManagedUnsetPathsForWrite;exports.C = validateConfigObjectRaw;exports.D = collectPluginSchemaMetadata;exports.E = collectChannelSchemaMetadata;exports.F = asResolvedSourceConfig;exports.G = formatInvalidConfigDetails;exports.H = shouldAttemptLastKnownGoodRecovery;exports.I = asRuntimeConfig;exports.J = getShellEnvAppliedKeys;exports.K = createPreUpdateConfigSnapshot;exports.L = resolveNormalizedProviderModelMaxTokens;exports.M = resetConfigOverrides;exports.N = setConfigOverride;exports.O = void 0;exports.P = unsetConfigOverride;exports.Q = shouldEnableShellEnvFallback;exports.R = normalizeProviderConfigForConfigDefaults;exports.S = validateConfigObject;exports.T = validateConfigObjectWithPlugins;exports.U = void 0;exports.V = isPluginLocalInvalidConfigSnapshot;exports.W = createInvalidConfigError;exports.X = loadShellEnvFallback;exports.Y = getShellPathFromLoginShell;exports.Z = resolveShellEnvFallbackTimeoutMs;exports._ = recoverConfigFromLastKnownGood;exports.a = loadConfig;exports.b = writeConfigFile;exports.c = promoteConfigSnapshotToLastKnownGood;exports.d = readConfigFileSnapshotForWrite;exports.f = readConfigFileSnapshotWithPluginMetadata;exports.g = recoverConfigFromJsonRootSuffix;exports.h = readSourceConfigSnapshotForWrite;exports.i = getRuntimeConfig;exports.j = getConfigOverrides;exports.k = resolveShellEnvExpectedKeys;exports.l = readBestEffortConfig;exports.m = readSourceConfigSnapshot;exports.n = clearConfigCache;exports.o = parseConfigJson5;exports.p = readSourceConfigBestEffort;exports.q = maintainConfigBackups;exports.r = createConfigIO;exports.s = projectConfigOntoRuntimeSourceSnapshot;exports.t = void 0;exports.u = readConfigFileSnapshot;exports.v = registerConfigWriteListener;exports.w = validateConfigObjectRawWithPlugins;exports.x = collectUnsupportedSecretRefPolicyIssues;exports.y = resolveConfigSnapshotHash;exports.z = applyUnsetPathsForWrite;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _env2YgvpOLV = require("./env-2YgvpOLV.js");
...
var _modelCatalogD79ZM1tY = require("./model-catalog-D79ZM1tY.js");
...
var _dotenvBqDzcyf = require("./dotenv-BqDzcyf3.js");
var _installedPluginIndexRecordsDPYBTNTT = require("./installed-plugin-index-records-DPYBTNTT.js");
var _safeTextC1oixi3E = require("./safe-text-C1oixi3E.js");
var _includesBMPFSevO = require("./includes-BMPFSevO.js");
var _ioAuditDv2J8w = require("./io.audit-Dv2J8w16.js");
var _issueFormatBTP4B7ls = require("./issue-format-BTP4B7ls.js");
var _modelRefSharedYYG_idXj = require("./model-ref-shared-yYG_idXj.js");
var _mergePatchB1KO8sev = require("./merge-patch-B1KO8sev.js");
var _defaultsCWlUbhpa = require("./defaults-CWlUbhpa.js");
var _thinkingUKUPba = require("./thinking-uKUPba90.js");
var _talkBq6cfNcc = require("./talk-Bq6cfNcc.js");
var _execSafeBinTrustIrNaZViN = require("./exec-safe-bin-trust-IrNaZViN.js");
var _nixModeWriteGuardDxCJ9lzV = require("./nix-mode-write-guard-DxCJ9lzV.js");
var _pluginInstallConfigMigrationBUtgszyI = require("./plugin-install-config-migration-BUtgszyI.js");
var _configPathsDZHM3IlU = require("./config-paths-DZHM3IlU.js");
...
var _bundledCompatDMyny7PJ = require("./bundled-compat-DMyny7PJ.js");
var _schemaValidatorWgurAMJR = require("./schema-validator-wgurAMJR.js");
var _webSearchInstallCatalog0huIerhQ = require("./web-search-install-catalog-0huIerhQ.js");
var _avatarPolicyDynSJggC = require("./avatar-policy-DynSJggC.js");
var _modelRefsByh1O5l = require("./model-refs-Byh1O5l0.js");
var _zodSchemaCoreQTf3ki3e = require("./zod-schema.core-QTf3ki3e.js");
var _zodSchema6ON220xK = require("./zod-schema-6ON220xK.js");
var _version8VAMXiY = require("./version-8VA-MXiY.js");
...
function shouldEnableShellEnvFallback(env) {
  return (0, _env2YgvpOLV.t)(env.OPENCLAW_LOAD_SHELL_ENV);
}
function shouldDeferShellEnvFallback(env) {
  return (0, _env2YgvpOLV.t)(env.OPENCLAW_DEFER_SHELL_ENV_FALLBACK);
}
...
function collectReferencedAgentIds(cfg) {
  ...
  ids.add((0, _sessionKeyCQewiu8n.c)(defaultAgentId));
  for (const entry of agents) if (entry?.id) ids.add((0, _sessionKeyCQewiu8n.c)(entry.id));
  const bindings = cfg.bindings;
  if (Array.isArray(bindings)) for (const binding of bindings) {
    const id = binding?.agentId;
    if (typeof id === "string" && id.trim()) ids.add((0, _sessionKeyCQewiu8n.c)(id));
  }
  return [...ids];
}
function resolveEffectiveAgentDir(cfg, agentId, deps) {
  const id = (0, _sessionKeyCQewiu8n.c)(agentId);
  const trimmed = (Array.isArray(cfg.agents?.list) ? cfg.agents?.list.find((agent) => (0, _sessionKeyCQewiu8n.c)(agent.id) === id)?.agentDir : void 0)?.trim();
...
async function createPreUpdateConfigSnapshot(params) {
  ...
  const snapshotKey = _nodePath.default.resolve(params.configPath);
...
function createClobberedSiblingSnapshot(params) {
  return {
    name: params.entry,
    path: _nodePath.default.join(params.dir, params.entry),
...
async function listClobberedSiblings(deps, dir, prefix) {
  try {
    ...
    for (const entry of entries) {
      ...
      const stat = await deps.fs.promises.stat(_nodePath.default.join(dir, entry)).catch(() => null);
...
function formatInvalidConfigDetails(issues) {
  return issues.map((issue) => `- ${(0, _safeTextC1oixi3E.t)(issue.path || "<root>")}: ${(0, _safeTextC1oixi3E.t)(issue.message)}`).join("\n");
}
...
const AUTO_MANAGED_CONFIG_META_PATHS = exports.U = [["meta", AUTO_MANAGED_CONFIG_META_FIELDS.lastTouchedVersion], ["meta", AUTO_MANAGED_CONFIG_META_FIELDS.lastTouchedAt]];
function stampConfigWriteMetadata(cfg, now = (/* @__PURE__ */new Date()).toISOString(), version = _versionDmRkhYua.n) {
  return {
    ...cfg,
    meta: {
      ...cfg.meta,
...
async function recoverConfigFromLastKnownGood$1(params) {
  ...
  const issueSummary = (0, _issueFormatBTP4B7ls.r)([...snapshot.issues, ...snapshot.legacyIssues]);
  ...
  await (0, _ioAuditDv2J8w.t)(createConfigObserveAuditAppendParams(deps, {
    ts: now,
    configPath: snapshot.path,
...
function normalizeModelProviderCatalogRefsForWrite(config) {
  ...
  for (const [provider, providerConfig] of Object.entries(providers)) {
    ...
    const models = providerConfig.models.map((model) => {
      ...
      const id = (0, _modelRefSharedYYG_idXj.r)(provider, trimmed);
...
function hasPathValue(value, path) {
  ...
  if ((0, _prototypeKeysCxs5UffD.t)(head) || !Object.prototype.hasOwnProperty.call(value, head)) return false;
...
function mergeMissingExplicitValues(currentValue, explicitValue) {
  ...
  const next = { ...currentValue };
  for (const [key, childExplicitValue] of Object.entries(explicitValue)) {
    if ((0, _prototypeKeysCxs5UffD.t)(key)) continue;
...
function injectExplicitlySetPaths(params) {
  ...
  for (const path of params.explicitSetPaths) {
    if (path.length === 0 || path.some(_prototypeKeysCxs5UffD.t)) continue;
...
function resolvePersistCandidateForWrite(params) {
  ...
  const persistedBase = preserveUntouchedIncludes({
    patch,
    rootAuthoredConfig,
    persistedCandidate: (0, _mergePatchB1KO8sev.t)(projectedSource, patch)
  });
...
function unsetPathForWriteAt(value, pathSegments, depth) {
  ...
  if ((0, _prototypeKeysCxs5UffD.t)(segment) || !isWritePlainObject(value) || !hasOwnObjectKey(value, segment)) return {
    changed: false,
    value
  };
  if (isLeaf) {
...
function normalizeProviderConfigForConfigDefaults(params) {
  const normalized = (0, _thinkingUKUPba.v)(params.provider, { manifestRegistry: params.manifestRegistry })?.normalizeConfig?.({
...
function applyProviderConfigDefaultsForConfig(params) {
  return (0, _thinkingUKUPba.v)(params.provider, { manifestRegistry: params.manifestRegistry })?.applyConfigDefaults?.({
    provider: params.provider,
...
function applyTalkConfigNormalization(config) {
  return (0, _talkBq6cfNcc.n)(config);
}
  ...
  if (providerConfig) {
    ...
    for (const [providerId, provider] of Object.entries(providerConfig)) {
      ...
      const nextModels = models.map((model) => {
        ...
        const id = (0, _modelRefSharedYYG_idXj.r)(providerId, raw.id);
        ...
        const contextWindow = isPositiveNumber(raw.contextWindow) ? raw.contextWindow : _defaultsCWlUbhpa.t;
...
function normalizeExecSafeBinProfilesInConfig(cfg) {
  const normalizeExec = (exec) => {
    ...
    const normalizedProfiles = (0, _execSafeBinTrustIrNaZViN.k)(typedExec.safeBinProfiles);
    typedExec.safeBinProfiles = Object.keys(normalizedProfiles).length > 0 ? normalizedProfiles : void 0;
    const normalizedTrustedDirs = (0, _execSafeBinTrustIrNaZViN.i)(typedExec.safeBinTrustedDirs);
...
function sanitizeOverrideValue(value, seen = /* @__PURE__ */new WeakSet()) {
  ...
  for (const [key, entry] of Object.entries(value)) {
    if (entry === void 0 || (0, _prototypeKeysCxs5UffD.t)(key)) continue;
...
function mergeOverrides(base, override) {
  ...
  for (const [key, value] of Object.entries(override)) {
    if (value === void 0 || (0, _prototypeKeysCxs5UffD.t)(key)) continue;
...
function setConfigOverride(pathRaw, value) {
  const parsed = (0, _configPathsDZHM3IlU.n)(pathRaw);
  if (!parsed.ok || !parsed.path) return {
    ok: false,
    error: parsed.error ?? "Invalid path."
  };
  (0, _configPathsDZHM3IlU.r)(overrides, parsed.path, sanitizeOverrideValue(value));
  return { ok: true };
}
function unsetConfigOverride(pathRaw) {
  ...
  return {
    ok: true,
    removed: (0, _configPathsDZHM3IlU.i)(overrides, parsed.path)
  };
}
...
function resolveShellEnvExpectedKeys(env) {
  return [...new Set([
  ...(0, _providerEnvVarsRuZeKVfu.n)({ env }),
  ...(0, _channelEnvVarsBqBNZvnV.n)({ env }),
...
function materializeBundledModelProviderOverlays(config) {
  ...
  for (const [providerId, providerConfig] of Object.entries(providers)) {
    if (!(0, _zodSchemaCoreQTf3ki3e.I)(providerId) || providerConfig.baseUrl && Array.isArray(providerConfig.models)) continue;
...
function stripPreservedLegacyRootKeysForValidation(raw, keys) {
  if (!keys || keys.length === 0 || !(0, _utilsCKsuXgDI.c)(raw)) return raw;
  const next = { ...raw };
...
function formatMissingOfficialExternalPluginWarning(pluginId, opts) {
  const catalogEntry = (0, _officialExternalPluginCatalogDBaj9fiE.t)(pluginId);
  if (!catalogEntry) return null;
  const install = (0, _officialExternalPluginCatalogDBaj9fiE.c)(catalogEntry);
...
function isObjectSecretRefCandidate(value) {
  ...
  return (0, _typesSecretsCJS3n8Im.o)(value) !== null;
}
...
function mapZodIssueToConfigIssue(issue) {
  ...
  const allowedValuesSummary = (0, _schemaValidatorWgurAMJR.r)(collectAllowedValuesFromUnknownIssue(issue));
  ...
  return {
    path,
    message: (0, _schemaValidatorWgurAMJR.n)(message, allowedValuesSummary),
...
function collectExplicitPluginReferences(raw) {
  ...
  if (!(0, _utilsCKsuXgDI.c)(raw) || !(0, _utilsCKsuXgDI.c)(raw.plugins)) return references;
  const { plugins } = raw;
  if ((0, _utilsCKsuXgDI.c)(plugins.entries)) for (const pluginId of Object.keys(plugins.entries)) {
    const normalized = (0, _configStateCOhlckC.o)(pluginId);
  ...
  for (const [key, target] of [["allow", references.allow], ["deny", references.deny]]) {
    ...
    for (const entry of value) {
      ...
      const normalized = (0, _configStateCOhlckC.o)(entry);
      if (normalized) target.add(normalized);
    }
  }
  if ((0, _utilsCKsuXgDI.c)(plugins.slots)) for (const [slotId, pluginId] of Object.entries(plugins.slots)) {
...
function isWorkspaceAvatarPath(value, workspaceDir) {
  ...
  return (0, _avatarPolicyDynSJggC.o)(workspaceRoot, _nodePath.default.resolve(workspaceRoot, value));
}
function validateIdentityAvatar(config) {
  ...
  for (const [index, entry] of agents.entries()) {
    ...
    if (!avatar) continue;
    if ((0, _avatarPolicyDynSJggC.r)(avatar) || (0, _avatarPolicyDynSJggC.i)(avatar)) continue;
    ...
    if ((0, _avatarPolicyDynSJggC.n)(avatar) && !(0, _avatarPolicyDynSJggC.c)(avatar)) {
      issues.push({
        path: `agents.list.${index}.identity.avatar`,
        message: "identity.avatar must be a workspace-relative path, http(s) URL, or data URI."
      });
    ...
    if (!isWorkspaceAvatarPath(avatar, (0, _agentScopeConfigDCRwWQZy.o)(config, entry.id ?? (0, _agentScopeConfigDCRwWQZy.c)(config)))) issues.push({
      path: `agents.list.${index}.identity.avatar`,
...
function validateGatewayTailscaleBind(config) {
  ...
  if (bindMode === "custom" && (0, _ipCh1Tjj_.i)(customBindHost) && (0, _ipCh1Tjj_.f)(customBindHost)) return [];
  return [{
    path: "gateway.bind",
...
function validateConfigObjectRaw(raw, opts) {
  ...
  const validated = _zodSchema6ON220xK.t.safeParse(normalizedRaw);
...
function validateConfigObjectWithPluginsBase(raw, opts) {
  ...
  const loadValidationRegistry = () => {
    ...
    registryInfo = { registry: (0, _pluginMetadataSnapshotYo9W2SZ.i)({
        config,
        workspaceDir: (0, _agentScopeConfigDCRwWQZy.o)(config, (0, _agentScopeConfigDCRwWQZy.c)(config)) ?? void 0,
  ...
  const ensureCompatConfig = () => {
    ...
    compatConfig = (0, _bundledCompatDMyny7PJ.t)({
      config,
  ...
  const ensureNormalizedPlugins = () => {
    const info = ensureRegistry();
    if (!info.normalizedPlugins) info.normalizedPlugins = (0, _configStateCOhlckC.s)(ensureCompatConfig().plugins);
  ...
  const ensureInstalledPluginRecordIds = () => {
    ...
    try {
      installedPluginRecordIds = new Set(Object.keys((0, _installedPluginIndexRecordReaderDR3h__QQ.n)({ env: opts.env })).map(_configStateCOhlckC.o));
    } catch {
  ...
  const hasStalePluginEvidenceForUnknownChannel = (channelId) => {
    const normalizedChannelId = (0, _configStateCOhlckC.o)(channelId);
    if (!normalizedChannelId || ensureKnownIds().has(normalizedChannelId)) return false;
    const pluginConfig = config.plugins;
    if (Array.isArray(pluginConfig?.allow) && pluginConfig.allow.some((pluginId) => (0, _configStateCOhlckC.o)(pluginId) === normalizedChannelId)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.entries) && Object.keys(pluginConfig.entries).some((pluginId) => (0, _configStateCOhlckC.o)(pluginId) === normalizedChannelId)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.installs) && Object.keys(pluginConfig.installs).some((pluginId) => (0, _configStateCOhlckC.o)(pluginId) === normalizedChannelId)) return true;
  ...
  const collectKnownWebSearchProviderIds = () => {
    return [...new Set([...collectActiveWebSearchProviderIds(), ...(0, _webSearchInstallCatalog0huIerhQ.t)().map((entry) => entry.provider.id.trim()).filter((providerId) => providerId.length > 0)])].toSorted((left, right) => left.localeCompare(right));
  };
  const hasPluginEvidenceForWebSearchProvider = (...pluginOrProviderIds) => {
    const candidateIds = new Set(pluginOrProviderIds.map((id) => (0, _configStateCOhlckC.o)(id)).filter((id) => id.length > 0));
    if (candidateIds.size === 0) return false;
    const matches = (pluginId) => candidateIds.has((0, _configStateCOhlckC.o)(pluginId));
    const pluginConfig = config.plugins;
    if (Array.isArray(pluginConfig?.allow) && pluginConfig.allow.some(matches)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.entries) && Object.keys(pluginConfig.entries).some(matches)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.installs) && Object.keys(pluginConfig.installs).some(matches)) return true;
  ...
  const hasStalePluginEvidenceForUnknownWebSearchProvider = (providerId) => {
    const normalizedProviderId = (0, _configStateCOhlckC.o)(providerId);
  ...
  const validateWebSearchProvider = () => {
    ...
    const installCatalogEntry = (0, _webSearchInstallCatalog0huIerhQ.t)().find((entry) => entry.provider.id === trimmed);
  ...
  const validateConfiguredModelRefs = () => {
    const configuredRefs = (0, _modelRefsByh1O5l.n)(config);
    if (configuredRefs.length === 0) return;
    const { registry } = ensureRegistry();
    const suppressedModels = /* @__PURE__ */new Map();
    for (const suppression of (0, _modelCatalogD79ZM1tY.r)({ registry }).suppressions) {
  ...
  if (config.channels && (0, _utilsCKsuXgDI.c)(config.channels)) for (const key of Object.keys(config.channels)) {
    ...
    if (!result.ok) {
      for (const error of result.errors) {
        const path = error.path === "<root>" ? `channels.${trimmed}` : `channels.${trimmed}.${error.path}`;
        issues.push({
          path,
  ...
  for (const channelId of _idsCRqUrRLW.t) heartbeatChannelIds.add((0, _stringCoerceLndEvhRk.a)(channelId));
  const validateHeartbeatTarget = (target, path) => {
    ...
    if ((0, _idsCRqUrRLW.r)(trimmed)) return;
  ...
  for (const diag of registry.diagnostics) {
    ...
    if (diag.pluginId) {
      const normalizedPluginId = (0, _configStateCOhlckC.o)(diag.pluginId);
  ...
  const blockedDiagnosticSourceMatchesPluginId = (diagnostic, pluginId) => {
    const normalizedPluginId = (0, _configStateCOhlckC.o)(pluginId);
    if (!normalizedPluginId) return false;
    const sourcePath = normalizeBlockedDiagnosticPath(diagnostic.source);
    if (!sourcePath) return false;
    if ((0, _configStateCOhlckC.o)(_nodePath.default.basename(sourcePath)) === normalizedPluginId || (0, _configStateCOhlckC.o)(_nodePath.default.basename(_nodePath.default.dirname(sourcePath))) === normalizedPluginId) return true;
    ...
    for (const loadPath of loadPaths) {
      ...
      if ((0, _configStateCOhlckC.o)(_nodePath.default.basename(resolvedLoadPath)) !== normalizedPluginId) continue;
  ...
  const findBlockedPluginDiagnostic = (pluginId) => {
    const direct = blockedPluginDiagnostics.get(pluginId) ?? blockedPluginDiagnostics.get((0, _configStateCOhlckC.o)(pluginId));
  ...
  const pushMissingPluginIssue = (path, pluginId, opts) => {
    ...
    if (opts?.warnOnly && opts.officialInstallHint !== false) {
      const externalInstallWarning = opts.missingMessage ?? formatMissingOfficialExternalPluginWarning(pluginId);
  ...
  for (const record of registry.plugins) {
    ...
    const activationState = (0, _configStateCOhlckC.l)({
      id: pluginId,
    ...
    if (enabled) {
      const memoryDecision = (0, _configStateCOhlckC.d)({
        id: pluginId,
        kind: record.kind,
        slot: memorySlot,
      ...
      if (memoryDecision.selected && (0, _slotsMFUVcT3n.r)(record.kind, "memory")) selectedMemoryPluginId = pluginId;
    }
    ...
    if (enabled || entryHasConfig) if (record.configSchema) {
      const res = (0, _schemaValidatorWgurAMJR.t)({
...
async function writeConfigHealthState(deps, state) {
  ...
  try {
    ...
    deps.logger.warn(`Config health-state write failed: ${healthPath}: ${(0, _errorsIxwfrboQ.i)(err)}`);
  }
}
...
function warnIfConfigFromFuture(cfg, logger) {
  ...
  if (!touched) return;
  if ((0, _version8VAMXiY.r)(_versionDmRkhYua.n, touched)) {
    if (warnedFutureTouchedVersions.has(touched)) return;
    warnedFutureTouchedVersions.add(touched);
    logger.warn([
    `Your OpenClaw config was written by version ${touched}, but this command is running ${_versionDmRkhYua.n}.`,
...
async function recoverConfigFromJsonRootSuffixWithDeps(params) {
  ...
  if (!validateConfigObjectWithPlugins((0, _pluginInstallConfigMigrationBUtgszyI.n)(resolveConfigForRead(resolved, params.deps.env).resolvedConfigRaw), {
    env: params.deps.env,
...
function resolveConfigIncludesForRead(parsed, configPath, deps) {
  return (0, _includesBMPFSevO.a)(parsed, configPath, {
    readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
    readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesBMPFSevO.i)({
      includePath,
      resolvedPath,
      rootRealDir,
      ioFs: deps.fs
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
  if (!raw || typeof raw !== "object") return [];
  const { findDoctorLegacyConfigIssues } = await Promise.resolve().then(() => jitiImport("./legacy-config-issues-B_zKm-Ns.js").then((m) => _interopRequireWildcard(m)));
...
function createConfigIO(overrides = {}) {
  ...
  function migrateAndStripShippedPluginInstallConfigRecords(configRaw, options = {}) {
    const installRecords = (0, _pluginInstallConfigMigrationBUtgszyI.t)(configRaw);
    const stripped = (0, _pluginInstallConfigMigrationBUtgszyI.n)(configRaw);
    ...
    try {
      ...
      const filePath = (0, _installedPluginIndexRecordsDPYBTNTT.i)({
        env: deps.env,
        stateDir
      });
      const previousFile = captureFileSnapshotSync(filePath);
      const existingRecords = (0, _installedPluginIndexRecordReaderDR3h__QQ.n)({
        env: deps.env,
        stateDir
      });
      const nextRecords = {
      ...
      if (Object.keys(installRecords).some((pluginId) => !(pluginId in existingRecords))) (0, _installedPluginIndexRecordsDPYBTNTT.c)(nextRecords, {
        config: coerceConfig(stripped),
        env: deps.env,
        stateDir
      });
      const rootConfigRaw = options.rootConfigRaw;
      if (rootConfigRaw !== void 0 && Object.keys((0, _pluginInstallConfigMigrationBUtgszyI.t)(rootConfigRaw)).length > 0) {
        const persistedRootParsed = (0, _pluginInstallConfigMigrationBUtgszyI.n)(rootConfigRaw);
      ...
      deps.logger.warn(`Config (${configPath}): could not migrate shipped plugins.installs records into the plugin index: ${(0, _errorsIxwfrboQ.i)(err)}`);
  ...
  function retainRuntimeOnlyShippedPluginInstallConfigRecords(config, sourceRaw) {
    const installRecords = (0, _pluginInstallConfigMigrationBUtgszyI.t)(sourceRaw);
  ...
  function ensureShippedPluginInstallConfigRecordsMigratedForWrite(snapshot) {
    const installRecords = {
      ...(0, _pluginInstallConfigMigrationBUtgszyI.t)(snapshot.sourceConfig),
      ...(0, _pluginInstallConfigMigrationBUtgszyI.t)(snapshot.parsed)
    };
    ...
    try {
      (0, _installedPluginIndexRecordsDPYBTNTT.c)({
        ...installRecords,
        ...existingRecords
      }, {
        config: coerceConfig((0, _pluginInstallConfigMigrationBUtgszyI.n)(snapshot.sourceConfig)),
        env: deps.env,
        stateDir
      });
      return {
      ...
      throw new Error(`Config write blocked: shipped plugins.installs records in ${configPath} could not be migrated into the plugin index. Fix state directory permissions or run openclaw plugins registry --refresh, then retry. ${(0, _errorsIxwfrboQ.i)(err)}`, { cause: err });
    }
  }
  ...
  function loadConfig() {
    try {
      ...
      const loadValidationPluginMetadataSnapshot = (config) => {
        ...
        pluginMetadataSnapshot = (0, _pluginMetadataSnapshotYo9W2SZ.i)({
          config: metadataConfig,
          workspaceDir: (0, _agentScopeConfigDCRwWQZy.o)(metadataConfig, (0, _agentScopeConfigDCRwWQZy.c)(metadataConfig)),
          env: deps.env
        });
      ...
      if (validated.warnings.length > 0) {
        const details = validated.warnings.map((iss) => `- ${(0, _safeTextC1oixi3E.t)(iss.path || "<root>")}: ${(0, _safeTextC1oixi3E.t)(iss.message)}`).join("\n");
  ...
  async function readConfigFileSnapshotInternal() {
    ...
    try {
      ...
      try {
        ...
        const message = err instanceof _includesBMPFSevO.n ? err.message : `Include resolution failed: ${String(err)}`;
  ...
  async function readSourceConfigBestEffort() {
    ...
    try {
      ...
      return coerceConfig((0, _pluginInstallConfigMigrationBUtgszyI.n)(resolveConfigForRead(resolved, deps.env).resolvedConfigRaw));
    } catch {
      return {};
    }
  }
  async function writeConfigFile(cfg, options = {}) {
    (0, _nixModeWriteGuardDxCJ9lzV.n)({
      configPath,
      env: deps.env
    });
    ...
    if (snapshot.valid && snapshot.exists) {
      ...
      try {
        const resolvedIncludes = (0, _includesBMPFSevO.a)(snapshot.parsed, configPath, {
          readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
          readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesBMPFSevO.i)({
            includePath,
            resolvedPath,
    ...
    const logConfigOverwrite = () => {
      ...
      if (!(0, _loggerD7Ndr2M.b)() && deps.env.OPENCLAW_CONFIG_OVERWRITE_LOG !== "1" && !shouldLogInVitest) return;
      deps.logger.warn((0, _ioAuditDv2J8w.a)({
        configPath,
    ...
    const auditRecordBase = (0, _ioAuditDv2J8w.r)({
      configPath,
      env: deps.env,
      existsBefore: snapshot.exists,
      previousHash: previousHash ?? null,
    ...
    try {
      const result = await (0, _replaceFileDfT5iHv.n)({
        filePath: configPath,
        content: json,
        dirMode: 448,
        mode: 384,
...
function registerConfigWriteListener(listener) {
  return (0, _runtimeSnapshotCXpARQsx.d)(listener);
}
...
function projectConfigOntoRuntimeSourceSnapshot(config) {
  ...
  return coerceConfig((0, _mergePatchB1KO8sev.t)(coerceConfig(projectSourceOntoRuntimeShape(runtimeConfigSourceSnapshot, runtimeConfigSnapshot)), createMergePatch(runtimeConfigSnapshot, config)));
}
function loadConfig() {
  return (0, _runtimeSnapshotCXpARQsx.l)(() => createConfigIO().loadConfig());
}
...
async function writeConfigFile(cfg, options = {}) {
  ...
  (0, _nixModeWriteGuardDxCJ9lzV.n)({ configPath: io.configPath });
  let nextCfg = cfg;
  const runtimeConfigSnapshot = (0, _runtimeSnapshotCXpARQsx.i)();
  const runtimeConfigSourceSnapshot = (0, _runtimeSnapshotCXpARQsx.s)();
  const hadRuntimeSnapshot = Boolean(runtimeConfigSnapshot);
  const hadBothSnapshots = Boolean(runtimeConfigSnapshot && runtimeConfigSourceSnapshot);
  if (hadBothSnapshots) nextCfg = coerceConfig((0, _mergePatchB1KO8sev.t)(runtimeConfigSourceSnapshot, createMergePatch(runtimeConfigSnapshot, cfg)));
  ...
  if (options.skipRuntimeSnapshotRefresh && !hadRuntimeSnapshot && !(0, _runtimeSnapshotCXpARQsx.o)()) return writeResult;
