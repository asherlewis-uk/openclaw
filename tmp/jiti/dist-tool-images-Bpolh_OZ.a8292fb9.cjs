"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemCH8Q21Y = require("./subsystem-C-H8Q21Y.js");
var _base64DYWkx = require("./base64-DYWkx191.js");
var _mediaServicesDMHz4YUI = require("./media-services-dMHz4YUI.js");
...
const log = (0, _subsystemCH8Q21Y.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _mediaServicesDMHz4YUI.c)(buf);
  ...
  const sideGrid = (0, _mediaServicesDMHz4YUI.o)(params.maxDimensionPx, sideStart);
  let smallest = null;
  let processorUnavailableError;
  for (const side of sideGrid) {
    for (const quality of _mediaServicesDMHz4YUI.r) {
      let out;
      try {
        out = await (0, _mediaServicesDMHz4YUI.p)({
          buffer: buf,
          maxSide: side,
          quality,
        ...
        if ((0, _mediaServicesDMHz4YUI.u)(err)) {
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64DYWkx.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
