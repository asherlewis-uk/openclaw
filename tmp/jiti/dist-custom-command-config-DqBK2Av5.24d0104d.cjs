"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = normalizeSlashCommandName;exports.r = resolveCustomCommands;exports.t = normalizeCommandDescription;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
//#region src/shared/custom-command-config.ts
const DEFAULT_PREFIX = "/";
function normalizeSlashCommandName(value) {
  const trimmed = value.trim();
  if (!trimmed) return "";
  return (0, _stringCoerceLndEvhRk.a)(trimmed.startsWith(DEFAULT_PREFIX) ? trimmed.slice(1) : trimmed).replace(/-/g, "_");
}
