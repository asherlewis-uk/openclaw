...
var _securityPathBXEjHAGL = require("./security-path-BXEjHAGL.js");
...
function doPluginHttpRoutesOverlap(a, b) {
  const aPath = (0, _securityPathBXEjHAGL.r)(a.path);
  const bPath = (0, _securityPathBXEjHAGL.r)(b.path);
  ...
  return prefixMatchPath((0, _securityPathBXEjHAGL.r)((a.match === "exact" ? a : b).path), (0, _securityPathBXEjHAGL.r)(prefixRoute.path));
}
