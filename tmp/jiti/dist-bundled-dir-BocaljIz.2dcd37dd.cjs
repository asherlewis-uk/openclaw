...
function resolvePackageRootsForBundledPlugins() {
  return [(0, _openclawRootDDaGBMF_.n)({ argv1: process.argv[1] }), (0, _openclawRootDDaGBMF_.n)({ moduleUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-dir-BocaljIz.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
}
...
function resolveTrustedExistingOverride(resolvedOverride) {
  ...
  const modulePackageRoot = (0, _openclawRootDDaGBMF_.n)({ moduleUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-dir-BocaljIz.js" });
...
function resolveBundledPluginsDirUncached(env) {
  ...
  try {
    ...
    })) ? null : argvRoot, (0, _openclawRootDDaGBMF_.n)({ moduleUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-dir-BocaljIz.js" })].filter((entry, index, all) => Boolean(entry) && all.indexOf(entry) === index);
  ...
  try {
    let cursor = _nodePath.default.dirname((0, _nodeUrl.fileURLToPath)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-dir-BocaljIz.js"));
    for (let i = 0; i < 6; i += 1) {
