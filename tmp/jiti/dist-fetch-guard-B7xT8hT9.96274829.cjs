"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = withTrustedEnvProxyGuardedFetchMode;exports.i = withStrictGuardedFetchMode;exports.n = fetchWithSsrFGuard;exports.o = withTrustedExplicitProxyGuardedFetchMode;exports.r = retainSafeHeadersForCrossOriginRedirectHeaders;exports.t = void 0;var _loggerDtrz4Rfi = require("./logger-Dtrz4Rfi.js");
var _proxyEnvBl2eQt0u = require("./proxy-env-Bl2eQt0u.js");
var _undiciRuntimeDzZbpePE = require("./undici-runtime-DzZbpePE.js");
var _undiciGlobalDispatcherDbxuiFXu = require("./undici-global-dispatcher-DbxuiFXu.js");
var _fetchHeadersDaqi8X9C = require("./fetch-headers-Daqi8X9C.js");
var _redirectHeadersDX3qwOnF = require("./redirect-headers-DX3qwOnF.js");
var _ssrfCYoLqc2K = require("./ssrf-CYoLqc2K.js");
var _fetchTimeoutBxQNNg4F = require("./fetch-timeout-BxQNNg4F.js");
var _runtimeFetchUdH5CUp = require("./runtime-fetch-UdH5CUp4.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/infra/net/fetch-guard.ts
function resolveDispatcherTimeoutMs(fromParams) {
  if (fromParams !== void 0) return fromParams;
  if (_undiciGlobalDispatcherDbxuiFXu.n !== void 0) return _undiciGlobalDispatcherDbxuiFXu.n;
}
...
function createPolicyDispatcherWithoutPinnedDns(dispatcherPolicy, timeoutMs) {
  ...
  if (dispatcherPolicy.mode === "direct") return (0, _undiciRuntimeDzZbpePE.t)(dispatcherPolicy.connect ? { connect: { ...dispatcherPolicy.connect } } : void 0, timeoutMs);
  if (dispatcherPolicy.mode === "env-proxy") return (0, _undiciRuntimeDzZbpePE.n)({
  ...
  if (dispatcherPolicy.proxyTls) return (0, _undiciRuntimeDzZbpePE.r)({
    uri: proxyUrl,
    requestTls: { ...dispatcherPolicy.proxyTls }
  }, timeoutMs);
  return (0, _undiciRuntimeDzZbpePE.r)({ uri: proxyUrl }, timeoutMs);
}
async function assertExplicitProxyAllowed(dispatcherPolicy, lookupFn, policy) {
  ...
  await (0, _ssrfCYoLqc2K.g)(parsedProxyUrl.hostname, {
    lookupFn,
    policy: proxyPolicy
  });
}
...
function retainSafeHeadersForCrossOriginRedirectHeaders(headers) {
  return (0, _redirectHeadersDX3qwOnF.t)(headers);
}
async function captureGuardedFetchExchange(params) {
  ...
  const { captureHttpExchange } = await Promise.resolve().then(() => jitiImport("./runtime-4AdLFVW0.js").then((m) => _interopRequireWildcard(m)));
  captureHttpExchange({
    url: params.url,
...
function retainSafeHeadersForCrossOriginRedirect(init) {
  ...
  return {
    ...init,
    headers: (0, _redirectHeadersDX3qwOnF.t)(init.headers)
  };
}
function dropBodyHeaders(headers) {
  if (!headers) return headers;
  const nextHeaders = new Headers((0, _fetchHeadersDaqi8X9C.t)(headers));
...
async function fetchWithSsrFGuard(params) {
  ...
  const { signal, cleanup, refresh } = (0, _fetchTimeoutBxQNNg4F.n)({
  ...
  const release = async (dispatcher) => {
    ...
    released = true;
    cleanup();
    await (0, _ssrfCYoLqc2K.i)(dispatcher ?? void 0);
  };
  const visited = new Set([params.url]);
  let currentUrl = params.url;
  let currentInit = (0, _fetchHeadersDaqi8X9C.n)(params.init ? { ...params.init } : void 0);
  let redirectCount = 0;
  while (true) {
    let parsedUrl;
    try {
    ...
    try {
      ...
      const canUseTrustedEnvProxy = mode === GUARDED_FETCH_MODE.TRUSTED_ENV_PROXY && (0, _proxyEnvBl2eQt0u.c)(parsedUrl.toString());
      const canUseManagedProxy = mode === GUARDED_FETCH_MODE.STRICT && isManagedProxyActive() && (0, _proxyEnvBl2eQt0u.i)();
      const timeoutMs = resolveDispatcherTimeoutMs(params.timeoutMs);
      if (canUseTrustedEnvProxy || params.pinDns === false) (0, _ssrfCYoLqc2K.n)(parsedUrl.hostname, params.policy);
      if (canUseTrustedEnvProxy) dispatcher = (0, _undiciRuntimeDzZbpePE.n)(void 0, timeoutMs);else
      if (canUseManagedProxy) {
        await (0, _ssrfCYoLqc2K.g)(parsedUrl.hostname, {
          lookupFn: params.lookupFn,
          policy: params.policy
        });
        dispatcher = (0, _undiciRuntimeDzZbpePE.n)(void 0, timeoutMs);
      } else if (usesTrustedExplicitProxyMode) {
        (0, _ssrfCYoLqc2K.n)(parsedUrl.hostname, params.policy);
        ...
        dispatcher = createPolicyDispatcherWithoutPinnedDns(params.dispatcherPolicy, timeoutMs);
      } else dispatcher = (0, _ssrfCYoLqc2K.a)(await (0, _ssrfCYoLqc2K.g)(parsedUrl.hostname, {
        lookupFn: params.lookupFn,
        policy: params.policy
      ...
      }) || (0, _runtimeFetchUdH5CUp.r)(defaultFetch);
      const response = Boolean(dispatcher) && !supportsDispatcherInit ? await (0, _runtimeFetchUdH5CUp.t)(parsedUrl.toString(), init) : await defaultFetch(parsedUrl.toString(), init);
      ...
      if (isRedirectStatus(response.status)) {
        ...
        await (0, _ssrfCYoLqc2K.i)(dispatcher);
        currentUrl = nextUrl;
        continue;
      }
      return {
      ...
      if (err instanceof _ssrfCYoLqc2K.t) (0, _loggerDtrz4Rfi.a)(`security: blocked URL fetch (${params.auditContext ?? "url-fetch"}) targetOrigin=${parsedUrl.origin} reason=${err.message}`);
      await release(dispatcher);
      throw err;
    }
  }
}
//#endregion /* v9-d27805da4cc0fe1f */
