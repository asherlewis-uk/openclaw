"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGlobalDedupeCache;exports.t = createDedupeCache;var _globalSingletonB2nbp4Tq = require("./global-singleton-B2nbp4Tq.js");
var _mapSizeDV7sj3ro = require("./map-size-DV7sj3ro.js");
...
function createDedupeCache(options) {
  ...
  const prune = (now) => {
    ...
    (0, _mapSizeDV7sj3ro.t)(cache, maxSize);
  };
...
function resolveGlobalDedupeCache(key, options) {
  return (0, _globalSingletonB2nbp4Tq.n)(key, () => createDedupeCache(options));
}
//#endregion /* v9-0b5dda017295fda7 */
