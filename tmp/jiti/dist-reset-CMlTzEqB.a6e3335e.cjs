"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = void 0;exports.c = resolveSessionResetPolicy;exports.i = resolveThreadFlag;exports.n = resolveChannelResetConfig;exports.o = evaluateSessionFreshness;exports.r = resolveSessionResetType;exports.s = resolveDailyResetAtMs;exports.t = isThreadSessionKey;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
const DEFAULT_RESET_MODE = exports.a = "daily";
...
function isThreadSessionKey(sessionKey) {
  return Boolean((0, _storeLoadBzczsLeI.w)(sessionKey).threadId);
}
function resolveSessionResetType(params) {
  ...
  const normalized = (0, _stringCoerceLndEvhRk.a)(params.sessionKey);
...
function resolveChannelResetConfig(params) {
  ...
  const normalized = (0, _messageChannelJqYBZqnL.u)(params.channel);
  const fallback = (0, _stringCoerceLndEvhRk.s)(params.channel);
  const key = normalized ?? fallback;
  if (!key) return;
  return resetByChannel[key];
}
//#endregion /* v9-9fec04c07ca0d0a1 */
