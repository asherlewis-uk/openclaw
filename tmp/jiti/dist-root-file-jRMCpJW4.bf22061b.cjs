"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = openRootFileSync;exports.n = matchRootFileOpenFailure;exports.r = openRootFile;exports.t = canUseRootFileOpen;var _rootPathBgCKz8X = require("./root-path-BgCKz8X4.js");
var _pinnedOpenBRMz46d = require("./pinned-open-BRMz46d0.js");
...
function openRootFileSync(params) {
  ...
  const resolved = resolveRootFilePathGeneric({
    ...
    resolve: (absolutePath) => (0, _rootPathBgCKz8X.i)({
      absolutePath,
...
function openRootFileResolved(params) {
  const opened = (0, _pinnedOpenBRMz46d.t)({
...
async function openRootFile(params) {
  ...
  const maybeResolved = resolveRootFilePathGeneric({
    absolutePath: params.absolutePath,
    resolve: (absolutePath) => (0, _rootPathBgCKz8X.r)({
      absolutePath,
      rootPath: params.rootPath,
      rootCanonicalPath: params.rootRealPath,
      boundaryLabel: params.boundaryLabel,
