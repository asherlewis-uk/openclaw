"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = defineBundledChannelSetupEntry;exports.r = loadBundledEntryExportSync;exports.t = defineBundledChannelEntry;var _stringCoerceDyL154ka = require("./string-coerce-DyL154ka.js");
var _rootFileJRMCpJW = require("./root-file-jRMCpJW4.js");
require("./boundary-file-read-CBe_wA_B.js");
var _pluginModuleLoaderCacheCWzNCn = require("./plugin-module-loader-cache-CWzNCn04.js");
var _sdkAliasDMSovejl = require("./sdk-alias-DMSovejl.js");
var _configSchemaW3cGqPeU = require("./config-schema-w3cGqPeU.js");
var _pluginLoadProfileDOnG9jJ = require("./plugin-load-profile-DOnG9jJ5.js");
var _nodeModule = require("node:module");
var _nodeUrl = require("node:url");
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
//#region src/plugin-sdk/channel-entry-contract.ts
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/channel-entry-contract-BH7SpPFD.js");
...
function resolveSpecifierCandidates(modulePath) {
  const ext = (0, _stringCoerceDyL154ka.a)(_nodePath.default.extname(modulePath));
...
function resolveBundledEntryModuleCandidates(importMetaUrl, specifier) {
  ...
  const packageRoot = (0, _sdkAliasDMSovejl.l)({
...
function getSourceModuleLoader(modulePath, options) {
  return (0, _pluginModuleLoaderCacheCWzNCn.r)({
    cache: moduleLoaders,
    modulePath,
    importerUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/channel-entry-contract-BH7SpPFD.js",
    preferBuiltDist: true,
    loaderFilename: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/channel-entry-contract-BH7SpPFD.js",
...
function canTryNodeRequireBuiltModule(modulePath) {
  ...
  ".mjs",
  ".cjs"].
  includes((0, _stringCoerceDyL154ka.a)(_nodePath.default.extname(modulePath)));
}
function loadBundledEntryModuleSync(importMetaUrl, specifier, options = {}) {
  ...
  let loaded;
  const profile = (0, _pluginLoadProfileDOnG9jJ.r)();
  ...
  if (canTryNodeRequireBuiltModule(modulePath)) try {
    ...
    loaded = moduleLoader((0, _pluginModuleLoaderCacheCWzNCn.s)(modulePath));
  } else
  {
    const moduleLoader = getSourceModuleLoader(modulePath, options);
    sourceLoaderReadyMs = profile ? performance.now() : 0;
  ...
  if (profile) {
    ...
    console.error((0, _pluginLoadProfileDOnG9jJ.n)({
...
function defineBundledChannelEntry({ id, name, description, importMetaUrl, plugin, outbound, secrets, configSchema, runtime, accountInspect, features, registerCliMetadata, registerFull }) {
  const resolvedConfigSchema = typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaW3cGqPeU.o)();
  ...
  return {
    ...
    register(api) {
      ...
      if (api.registrationMode === "tool-discovery") {
        (0, _pluginLoadProfileDOnG9jJ.t)({
          pluginId: id,
          source: importMetaUrl
        })("bundled-register:registerFull", () => registerFull?.(api));
        return;
      }
      const profile = (0, _pluginLoadProfileDOnG9jJ.t)({
        pluginId: id,
        source: importMetaUrl
      });
