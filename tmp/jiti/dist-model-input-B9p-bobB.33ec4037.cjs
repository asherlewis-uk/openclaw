"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveAgentModelTimeoutMsValue;exports.i = resolveAgentModelPrimaryValue;exports.n = normalizeAgentModelRefForConfig;exports.o = toAgentModelListLike;exports.r = resolveAgentModelFallbackValues;exports.t = normalizeAgentModelMapForConfig;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function resolveAgentModelPrimaryValue(model) {
  return (0, _stringCoerceLndEvhRk.p)(model);
}
...
function toAgentModelListLike(model) {
  if (typeof model === "string") {
    const primary = (0, _stringCoerceLndEvhRk.c)(model);
...
function normalizeAgentModelRefForConfig(model) {
  ...
  return modelKeyForConfig((0, _providerIdCz7K6wgK.r)(trimmed.slice(0, slash)), (0, _providerModelIdNormalize_TvLuZl.n)(trimmed.slice(slash + 1)));
}
