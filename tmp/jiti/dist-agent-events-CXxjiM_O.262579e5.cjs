...
function emitAgentEvent(event) {
  ...
  (0, _listenersC4WrDNP.t)(state.listeners, enriched);
}
...
function onAgentEvent(listener) {
  return (0, _listenersC4WrDNP.n)(getAgentEventState().listeners, listener);
}
