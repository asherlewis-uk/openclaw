...
require("./fs-safe-advanced-jUnIgHPM.js");
...
const OPENCLAW_PACKAGE_ROOT = (0, _sdkAliasBOEr.l)({
  modulePath: (0, _nodeUrl.fileURLToPath)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/public-surface-loader-CHXRvo6d.js"),
  moduleUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/public-surface-loader-CHXRvo6d.js"
}) ?? (0, _nodeUrl.fileURLToPath)(new URL("../..", "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/public-surface-loader-CHXRvo6d.js"));
const publicSurfaceModuleCache = /* @__PURE__ */new Map();
const sourceArtifactRequire = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/public-surface-loader-CHXRvo6d.js");
...
function createResolutionKey(params) {
  const bundledPluginsDir = (0, _bundledDirBocaljIz.n)();
...
function resolvePublicSurfaceLocationUncached(params) {
  const bundledPluginsDir = (0, _bundledDirBocaljIz.n)();
  const modulePath = (0, _publicSurfaceRuntimeHv340Ieq.i)({
...
function getModuleLoader(modulePath) {
  return (0, _pluginModuleLoaderCacheCXUDv7JF.n)({
    cache: moduleLoaders,
    modulePath,
    importerUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/public-surface-loader-CHXRvo6d.js",
    preferBuiltDist: true,
    loaderFilename: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/public-surface-loader-CHXRvo6d.js"
  });
}
function loadPublicSurfaceModule(modulePath) {
  if (canUseSourceArtifactRequire({
    modulePath,
    tryNative: (0, _sdkAliasBOEr.d)(modulePath, { preferBuiltDist: true })
