...
var _sqliteWalBSuin8fl = require("./sqlite-wal-BSuin8fl.js");
...
function openPluginStateDatabase(operation = "open") {
  ...
  try {
    ...
    const walMaintenance = (0, _sqliteWalBSuin8fl.t)(db);
