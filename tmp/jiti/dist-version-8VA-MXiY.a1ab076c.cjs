"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = normalizeOpenClawVersionBase;exports.r = shouldWarnOnTouchedVersion;exports.t = compareOpenClawVersions;var _semverCompareD6ch1VrL = require("./semver-compare-D6ch1VrL.js");
//#region src/config/version.ts
const VERSION_RE = /^v?(\d+)\.(\d+)\.(\d+)(?:-([0-9A-Za-z.-]+))?$/;
function parseOpenClawVersion(raw) {
  if (!raw) return null;
  const match = (0, _semverCompareD6ch1VrL.r)(raw.trim()).match(VERSION_RE);
...
function compareOpenClawVersions(a, b) {
  ...
  if (parsedA.prerelease || parsedB.prerelease) return (0, _semverCompareD6ch1VrL.n)(parsedA.prerelease, parsedB.prerelease);
  return 0;
}
