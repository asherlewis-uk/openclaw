"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isSandboxHostPathAbsolute;exports.c = splitSandboxBindSpec;exports.i = getSandboxHostPathPolicyKey;exports.n = isDangerousNetworkMode;exports.o = normalizeSandboxHostPath;exports.r = normalizeNetworkMode;exports.s = resolveSandboxHostPathViaExistingAncestor;exports.t = getBlockedNetworkModeReason;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function normalizeSandboxHostPath(raw) {
  ...
  const withoutTrailingSlash = _nodePath.posix.normalize(normalTrimmed).replace(/\/+$/, "") || "/";
...
function resolveSandboxHostPathViaExistingAncestor(sourcePath) {
  ...
  return normalizeSandboxHostPath((0, _rootPathDTHDXh_.n)(sourcePath));
}
//#endregion
//#region src/agents/sandbox/network-mode.ts
function normalizeNetworkMode(network) {
  return (0, _stringCoerceLndEvhRk.s)(network) || void 0;
}
