"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.EMPTY_PROXY_ENV = void 0;exports.createAmbientProxyResolver = createAmbientProxyResolver;exports.proxyUrlWithDefaultScheme = proxyUrlWithDefaultScheme;exports.readProxyEnv = readProxyEnv;exports.readProxyEnvValue = readProxyEnvValue;exports.resolveAmbientProxyForUrl = resolveAmbientProxyForUrl;var _shared = require("./shared.js");
const EMPTY_PROXY_ENV = exports.EMPTY_PROXY_ENV = {
...
function createAmbientProxyResolver(env) {
  ...
  return {
    ...
    (0, _shared.redactProxyUrl)(proxyUrlWithDefaultScheme(configuredProxy)) :
    undefined,
    explain: (url, surface) => {
      ...
      if (proxyUrl !== undefined) {
        return {
          ...
          surface,
          url: formattedUrl,
          proxyUrl: (0, _shared.redactProxyUrl)(proxyUrl)
        };
      }
      return {
        kind: "direct",
