"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = forceResetGlobalDispatcher;exports.i = ensureGlobalUndiciStreamTimeouts;exports.n = ensureGlobalUndiciDispatcherStreamTimeouts;exports.o = void 0;exports.r = ensureGlobalUndiciEnvProxyDispatcher;exports.s = resetGlobalUndiciStreamTimeoutsForTests;exports.t = void 0;var _proxyEnvDPHGz7yn = require("./proxy-env-DPHGz7yn.js");
...
var _dispatcherBrand = require("@openclaw/proxyline/dispatcher-brand");
...
*/
let globalUndiciStreamTimeoutMs = exports.o = void 0;
...
function createTimedProxylineManagedDispatcher(dispatcher, timeoutMs, autoSelectFamily) {
  ...
  const state = {
    ...
    dispatch(options, handler) {
      return (0, _undiciRuntime8SDq9eZh.c)(state.autoSelectFamily, () => dispatcher.dispatch({
        ...options,
...
function resolveDispatcherKind(dispatcher) {
  ...
  if (isTimedProxylineManagedDispatcher(dispatcher) || (0, _dispatcherBrand.isProxylineDispatcher)(dispatcher)) return "proxyline-managed";
...
function resolveEnvProxyDispatcherOptions() {
  return {
    ...(0, _managedProxyUndiciD1ROMSCC.t)((0, _proxyEnvDPHGz7yn.o)()),
    ...HTTP1_ONLY_DISPATCHER_OPTIONS
  };
}
...
function ensureGlobalUndiciEnvProxyDispatcher() {
  if (!(0, _proxyEnvDPHGz7yn.n)()) return;
  const runtime = (0, _undiciRuntime8SDq9eZh.i)();
  ...
  try {
    setGlobalDispatcher((0, _undiciRuntime8SDq9eZh.n)(proxyOptions));
    lastAppliedProxyBootstrapKey = nextBootstrapKey;
  } catch {}
}
function applyGlobalDispatcherStreamTimeouts(params) {
  const { runtime, dispatcher, kind, timeoutMs } = params;
  const autoSelectFamily = (0, _undiciRuntime8SDq9eZh.s)();
  ...
  const connect = (0, _undiciRuntime8SDq9eZh.o)(autoSelectFamily);
  try {
    if (kind === "proxyline-managed") runtime.setGlobalDispatcher(createTimedProxylineManagedDispatcher(dispatcher, timeoutMs, autoSelectFamily));else
    if (kind === "env-proxy") {
      const proxyOptions = {
        ...(0, _managedProxyUndiciD1ROMSCC.t)((0, _proxyEnvDPHGz7yn.o)()),
      ...
      runtime.setGlobalDispatcher((0, _undiciRuntime8SDq9eZh.n)(proxyOptions, timeoutMs));
    } else runtime.setGlobalDispatcher((0, _undiciRuntime8SDq9eZh.t)(connect ? { connect } : void 0, timeoutMs));
...
function ensureGlobalUndiciStreamTimeouts(opts) {
  ...
  exports.o = globalUndiciStreamTimeoutMs = timeoutMs;
  if (!(0, _proxyEnvDPHGz7yn.n)()) {
...
function resetGlobalUndiciStreamTimeoutsForTests() {
  ...
  exports.o = globalUndiciStreamTimeoutMs = void 0;
}
/**
...
function forceResetGlobalDispatcher(opts) {
  ...
  if (!(0, _proxyEnvDPHGz7yn.n)()) {
    ...
    lastAppliedProxyBootstrapKey = null;
    try {
      const { setGlobalDispatcher } = (0, _undiciRuntime8SDq9eZh.i)();
      setGlobalDispatcher((0, _undiciRuntime8SDq9eZh.t)());
    } catch {}
    return;
  }
  try {
