"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = redactSensitiveText;exports.c = resolveRedactOptions;exports.d = compileConfigRegexes;exports.f = compileSafeRegex;exports.h = testRegexWithBoundedInput;exports.i = redactSensitiveLines;exports.l = readLoggingConfig;exports.m = hasNestedRepetition;exports.n = redactSecrets;exports.o = redactToolDetail;exports.p = compileSafeRegexDetailed;exports.r = redactSensitiveFieldValue;exports.s = redactToolPayloadText;exports.t = getDefaultRedactPatterns;exports.u = shouldSkipMutatingLoggingConfigRead;var _argvBHL8kwwH = require("./argv-BHL8kwwH.js");
...
function shouldSkipMutatingLoggingConfigRead(argv = process.argv) {
  const [primary, secondary] = (0, _argvBHL8kwwH.n)(argv, 2);
...
function readLoggingConfig() {
  ...
  try {
    const configPath = (0, _pathsCnwfh6dH.o)();
...
const STRUCTURED_SECRET_FIELD_RE = new RegExp(String.raw`^(?:api[-_]?key|apiKey|token|secret|password|passwd|access[-_]?token|accessToken|refresh[-_]?token|refreshToken|id[-_]?token|idToken|client[-_]?secret|clientSecret|${PAYMENT_CREDENTIAL_QUERY_KEYS}|${PAYMENT_CREDENTIAL_JSON_KEYS})$`, "i");
...
function redactSensitiveFieldValueWithOptions(key, value, options) {
  ...
  } else if (redacted !== value) return redacted;
