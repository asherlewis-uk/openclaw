"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolvePluginSourceRoots;exports.c = buildBundledPluginLoadPathAliases;exports.i = resolvePluginCacheInputs;exports.l = normalizeBundledLookupPath;exports.n = buildPluginDependencyStatus;exports.o = tracePluginLifecyclePhase;exports.r = normalizePluginDependencySpecs;exports.s = tracePluginLifecyclePhaseAsync;exports.t = discoverOpenClawPlugins;exports.u = shouldRejectHardlinkedPluginFiles;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _packageEntryResolutionG1dAmNUZ = require("./package-entry-resolution-g1dAmNUZ.js");
...
function resolvePluginSourceRoots(params) {
  ...
  return {
    stock: (0, _bundledDirLBl9nCAz.n)(env),
...
function readTrustedPackageManifest(dir) {
  return (0, _jsonFilesCahFuwKs.u)(_nodePath.default.join(dir, "package.json"));
}
...
function resolveIdHintManifestId(rootDir, rejectHardlinks, rootRealPath) {
  const manifest = (0, _manifestKLnLMS7v.i)(rootDir, rejectHardlinks, rootRealPath);
...
function addCandidate(params) {
  ...
  params.candidates.push({
    ...
    packageManifest: (0, _manifestKLnLMS7v.r)(manifest ?? void 0),
...
function discoverBundleInRoot(params) {
  const bundleFormat = (0, _bundleManifestBL4DoREl.i)(params.rootDir);
  ...
  const bundleManifest = (0, _bundleManifestBL4DoREl.a)({
    rootDir: params.rootDir,
    ...(rootRealPath !== void 0 ? { rootRealPath } : {}),
    bundleFormat,
    rejectHardlinks
...
function discoverInDirectory(params) {
  ...
  for (const entry of entries) {
    ...
    const extensionResolution = (0, _manifestKLnLMS7v.a)(manifest ?? void 0);
    const extensions = extensionResolution.status === "ok" ? extensionResolution.entries : [];
    const manifestId = resolveIdHintManifestId(fullPath, rejectHardlinks, fullPathRealPath);
    const setupSource = (0, _packageEntryResolutionG1dAmNUZ.n)({
      packageDir: fullPath,
    ...
    if (extensions.length > 0) {
      const resolvedRuntimeSources = (0, _packageEntryResolutionG1dAmNUZ.t)({
        packageDir: fullPath,
        ...(fullPathRealPath !== void 0 ? { packageRootRealPath: fullPathRealPath } : {}),
        manifest,
        extensions,
    ...
    const indexFile = [..._manifestKLnLMS7v.t].map((candidate) => _nodePath.default.join(fullPath, candidate)).find((candidate) => _nodeFs.default.existsSync(candidate));
...
function discoverFromPath(params) {
  ...
  if (stat.isDirectory()) {
    ...
    const indexFile = [..._manifestKLnLMS7v.t].map((candidate) => _nodePath.default.join(resolved, candidate)).find((candidate) => _nodeFs.default.existsSync(candidate));
    if (indexFile && isExtensionFile(indexFile)) {
      addCandidate({
        candidates: params.candidates,
        diagnostics: params.diagnostics,
...
function discoverOpenClawPlugins(params) {
  ...
  const sharedResult = tracePluginLifecyclePhase("discovery scan", () => {
    ...
    const sourceCheckoutDependencyDiagnostic = (0, _bundledDirLBl9nCAz.r)(env);
