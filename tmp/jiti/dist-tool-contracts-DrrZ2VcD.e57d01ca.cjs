"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = normalizeAgentToolResultMiddlewareRuntimeIds;exports.i = listAgentToolResultMiddlewares;exports.n = normalizePluginToolContractNames;exports.o = normalizeAgentToolResultMiddlewareRuntimes;exports.r = normalizePluginToolNames;exports.t = findUndeclaredPluginToolNames;var _runtimeCFKT2mp_ = require("./runtime-CFKT2mp_.js");
...
function listAgentToolResultMiddlewares(runtime) {
  return (0, _runtimeCFKT2mp_.a)()?.agentToolResultMiddlewares?.filter((entry) => entry.runtimes.includes(runtime)).map((entry) => entry.handler) ?? [];
}
//#endregion
