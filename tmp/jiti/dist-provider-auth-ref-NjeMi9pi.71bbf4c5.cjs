"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = promptSecretRefForSetup;exports.r = resolveRefFallbackInput;exports.t = extractEnvVarFromSourceLabel;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _providerEnvVarsRuZeKVfu = require("./provider-env-vars-RuZeKVfu.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/plugins/provider-auth-ref.ts
const secretResolveLoader = (0, _lazyPromiseSFT4i6yI.t)(() => Promise.resolve().then(() => jitiImport("./resolve-KnyFy64N.js").then((m) => _interopRequireWildcard(m))));
...
function resolveDefaultProviderEnvVar(provider, config) {
  return (0, _providerEnvVarsRuZeKVfu.t)(provider, {
    ...(config ? { config } : {}),
    includeUntrustedWorkspacePlugins: false
  })?.find((candidate) => (0, _stringCoerceLndEvhRk.c)(candidate) !== void 0);
}
function resolveDefaultFilePointerId(provider) {
  return `/providers/${(0, _jsonPointerD3Muu4EB.t)(provider)}/apiKey`;
}
function resolveRefFallbackInput(params) {
  const fallbackEnvVar = params.preferredEnvVar ?? (0, _providerEnvVarsRuZeKVfu.t)(params.provider, {
  ...
  const value = (0, _stringCoerceLndEvhRk.c)((params.env ?? process.env)[fallbackEnvVar]);
  ...
  return {
    ref: {
      source: "env",
      provider: (0, _refContractBR8wwaMv.l)(params.config, "env", { preferFirstProviderForSource: true }),
      id: fallbackEnvVar
    },
    resolvedValue: value
  };
...
async function promptEnvSecretRefForSetup(params) {
  ...
  const envCandidate = (0, _stringCoerceLndEvhRk.d)(await params.prompter.text({
    ...
    validate: (value) => {
      ...
      if (!(0, _typesSecretsCJS3n8Im.l)(candidate)) return params.copy?.envVarFormatError ?? "Use an env var name like \"OPENAI_API_KEY\" (uppercase letters, numbers, underscores).";
      if (!(0, _stringCoerceLndEvhRk.c)(env[candidate])) return params.copy?.envVarMissingError?.(candidate) ?? `Environment variable "${candidate}" is missing or empty in this session.`;
    }
  })) ?? "";
  const envVar = envCandidate && (0, _typesSecretsCJS3n8Im.l)(envCandidate) ? envCandidate : params.defaultEnvVar;
  if (!envVar) throw new Error(`No valid environment variable name provided for provider "${params.provider}".`);
  const resolvedValue = (0, _stringCoerceLndEvhRk.c)(env[envVar]);
...
async function promptProviderSecretRefForSetup(params) {
  ...
  const defaultProvider = (0, _refContractBR8wwaMv.l)(params.config, "file", { preferFirstProviderForSource: true });
  ...
  const id = (0, _stringCoerceLndEvhRk.d)(await params.prompter.text({
    message: idPrompt,
    ...
    validate: (value) => {
      ...
      if (providerEntry.source === "file" && providerEntry.mode !== "singleValue" && !(0, _refContractBR8wwaMv.s)(candidate)) return "Use an absolute JSON pointer like \"/providers/openai/apiKey\".";
      if (providerEntry.source === "file" && providerEntry.mode === "singleValue" && candidate !== "value") return "singleValue mode expects id \"value\".";
      if (providerEntry.source === "exec" && !(0, _refContractBR8wwaMv.o)(candidate)) return (0, _refContractBR8wwaMv.a)();
    }
  })) || idDefault;
  const ref = {
