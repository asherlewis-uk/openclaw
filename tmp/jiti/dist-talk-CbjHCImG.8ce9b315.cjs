...
function normalizeTalkSecretInput(value) {
  ...
  return (0, _typesSecretsBxqheYvy.o)(value) ?? void 0;
}
...
function normalizeTalkSection(value) {
  ...
  const consultThinkingLevel = (0, _thinkingIx_990qw.p)((0, _stringCoerceLndEvhRk.c)(source.consultThinkingLevel));
