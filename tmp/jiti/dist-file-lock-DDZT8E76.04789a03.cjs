"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resetFileLockStateForTest;exports.i = drainFileLockStateForTest;exports.n = void 0;exports.o = withFileLock;exports.r = acquireFileLock;exports.t = void 0;require("./fs-safe-defaults-azXCfv92.js");
...
function shouldRemoveDeadOwnerOrExpiredLock(params) {
  ...
  if (payload?.pid) return (params.isPidDefinitelyDead ?? _pidAliveDHduzhBu.r)(payload.pid);
...
const FILE_LOCK_TIMEOUT_ERROR_CODE = exports.n = "file_lock_timeout";
const FILE_LOCK_STALE_ERROR_CODE = exports.t = "file_lock_stale";
...
function resetFileLockStateForTest() {
  (0, _fileLockD6tjMR7o.i)(FILE_LOCK_MANAGER_KEY, FILE_LOCK_MANAGER_KEY);
}
async function drainFileLockStateForTest() {
  await (0, _fileLockD6tjMR7o.r)(FILE_LOCK_MANAGER_KEY, FILE_LOCK_MANAGER_KEY);
}
/** Acquire a re-entrant process-local file lock backed by a `.lock` sidecar file. */
async function acquireFileLock(filePath, options) {
  try {
    const lock = await (0, _fileLockD6tjMR7o.t)(filePath, {
