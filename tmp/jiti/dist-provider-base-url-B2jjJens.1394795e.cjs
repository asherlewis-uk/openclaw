"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = enrichOllamaModelsWithContext;exports.c = queryOllamaContextWindow;exports.i = buildOllamaProvider;exports.l = queryOllamaModelShowInfo;exports.n = buildOllamaBaseUrlSsrFPolicy;exports.o = fetchOllamaModels;exports.r = buildOllamaModelDefinition;exports.s = isReasoningModelHeuristic;exports.t = readProviderBaseUrl;exports.u = resolveOllamaApiBase;var _fetchGuardB1ZleaYR = require("./fetch-guard-B1ZleaYR.js");
require("./ssrf-runtime-CQb3ctCK.js");
...
function resolveOllamaApiBase(configuredBaseUrl) {
  if (!configuredBaseUrl) return _defaultsC1YFsVkx.n;
...
async function queryOllamaModelShowInfo(apiBase, modelName) {
  ...
  try {
    const { response, release } = await (0, _fetchGuardB1ZleaYR.n)({
...
function buildOllamaModelDefinition(modelId, contextWindow, capabilities) {
  ...
  return {
    ...
    reasoning,
    input,
    cost: _defaultsC1YFsVkx.i,
    contextWindow: contextWindow ?? 128e3,
    maxTokens: _defaultsC1YFsVkx.a,
    compat
  };
}
