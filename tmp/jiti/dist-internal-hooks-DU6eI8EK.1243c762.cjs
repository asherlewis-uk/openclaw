"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isAgentBootstrapEvent;exports.c = isMessageReceivedEvent;exports.d = isSessionPatchEvent;exports.f = registerInternalHook;exports.h = unregisterInternalHook;exports.i = hasInternalHookListeners;exports.l = isMessageSentEvent;exports.m = triggerInternalHook;exports.n = createInternalHookEvent;exports.o = isGatewayStartupEvent;exports.p = setInternalHooksEnabled;exports.r = getRegisteredEventKeys;exports.s = isMessagePreprocessedEvent;exports.t = clearInternalHooks;exports.u = isMessageTranscribedEvent;var _errorsIxwfrboQ = require("./errors-ixwfrboQ.js");
...
const handlers = (0, _globalSingletonB2nbp4Tq.n)(Symbol.for("openclaw.internalHookHandlers"), () => /* @__PURE__ */new Map());
const internalHooksEnabledState = (0, _globalSingletonB2nbp4Tq.n)(Symbol.for("openclaw.internalHooksEnabled"), () => ({ enabled: true }));
const log = (0, _subsystemCH8Q21Y.t)("internal-hooks");
/**
...
async function triggerInternalHook(event) {
  ...
  for (const handler of allHandlers) try {
    ...
    const message = (0, _errorsIxwfrboQ.i)(err);
