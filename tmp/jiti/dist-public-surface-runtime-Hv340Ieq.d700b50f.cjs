"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBundledPluginSourcePublicSurfacePath;exports.i = resolveBundledPluginPublicSurfacePath;exports.n = normalizeBundledPluginArtifactSubpath;exports.r = normalizeBundledPluginDirName;exports.t = void 0;var _bundledDirBocaljIz = require("./bundled-dir-BocaljIz.js");
...
function resolveBundledPluginPublicSurfacePath(params) {
  const artifactBasename = normalizeBundledPluginArtifactSubpath(params.artifactBasename);
  const dirName = normalizeBundledPluginDirName(params.dirName);
  const explicitBundledPluginsDir = params.bundledPluginsDir ?? (0, _bundledDirBocaljIz.n)(params.env ?? process.env);
