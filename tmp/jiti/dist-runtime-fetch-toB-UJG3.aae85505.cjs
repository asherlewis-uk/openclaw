"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = fetchWithRuntimeDispatcherOrMockedGlobal;exports.r = isMockedFetch;exports.t = fetchWithRuntimeDispatcher;var _undiciRuntime8SDq9eZh = require("./undici-runtime-8SDq9eZh.js");
...
function normalizeRuntimeRequestInit(init, RuntimeFormData) {
  if (!init) return init;
  const normalizedHeaders = (0, _fetchHeadersD02VVhDi.t)(init.headers);
...
async function fetchWithRuntimeDispatcher(input, init) {
  const runtimeDeps = (0, _undiciRuntime8SDq9eZh.a)();
