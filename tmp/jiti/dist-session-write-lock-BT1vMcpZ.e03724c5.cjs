"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = drainSessionWriteLockStateForTest;exports.c = resolveSessionWriteLockAcquireTimeoutMs;exports.i = cleanStaleLockFiles;exports.n = void 0;exports.o = resetSessionWriteLockStateForTest;exports.r = acquireSessionWriteLock;exports.s = resolveSessionLockMaxHoldFromTimeout;exports.t = void 0;require("./fs-safe-defaults-azXCfv92.js");
var _gatewayProcessesBCBqxtZ_ = require("./gateway-processes-BCBqxtZ_.js");
var _fileLockD6tjMR7o = require("./file-lock-D6tjMR7o.js");
var _pidAliveDHduzhBu = require("./pid-alive-DHduzhBu.js");
var _sessionWriteLockErrorBwBL0Pgr = require("./session-write-lock-error-BwBL0Pgr.js");
...
const SESSION_LOCKS = (0, _fileLockD6tjMR7o.n)("openclaw.session-write-lock");
let resolveProcessStartTimeForLock = _pidAliveDHduzhBu.t;
...
function inspectLockPayload(payload, staleMs, nowMs) {
  ...
  const pidAlive = pid !== null ? (0, _pidAliveDHduzhBu.n)(pid) : false;
...
async function removeReportedStaleLockIfStillStale(params) {
  ...
  const inspected = inspectLockPayloadForSession({
    ...
    readOwnerProcessArgs: params.readOwnerProcessArgs ?? _gatewayProcessesBCBqxtZ_.r
  });
...
async function cleanStaleLockFiles(params) {
  ...
  const ownerProcessArgsReader = params.readOwnerProcessArgs ?? _gatewayProcessesBCBqxtZ_.r;
  let entries = [];
  try {
...
async function acquireSessionWriteLock(params) {
  ...
  while (true) try {
    return { release: (await SESSION_LOCKS.acquire(sessionFile, {
        ...
        shouldReclaim: async ({ payload, nowMs, heldByThisProcess }) => {
          return await shouldReclaimContendedLockFile(lockPath, inspectLockPayloadForSession({
            ...
            heldByThisProcess,
            reclaimLockWithoutStarttime: true,
            readOwnerProcessArgs: _gatewayProcessesBCBqxtZ_.r
          }), staleMs, nowMs);
        }
      })).release };
  } catch (err) {
    ...
    throw new _sessionWriteLockErrorBwBL0Pgr.t({
      timeoutMs,
...
const __testing = exports.n = {
  ...
  setProcessStartTimeResolverForTest(resolver) {
    resolveProcessStartTimeForLock = resolver ?? _pidAliveDHduzhBu.t;
  }
};
...
function resetSessionWriteLockStateForTest() {
  ...
  stopWatchdogTimer();
  unregisterCleanupHandlers();
  resolveProcessStartTimeForLock = _pidAliveDHduzhBu.t;
}
//#endregion /* v9-91885d8459e8b835 */
