"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = getBundledChannelSetupSecrets;exports.c = listBundledChannelLegacyStateMigrationDetectors;exports.d = listBundledChannelSetupPlugins;exports.f = setBundledChannelRuntime;exports.g = resolveExistingPluginModulePath;exports.h = loadChannelPluginModule;exports.i = getBundledChannelSetupPlugin;exports.l = listBundledChannelPluginIds;exports.m = resolveBundledChannelRootScope;exports.n = getBundledChannelPlugin;exports.o = hasBundledChannelPackageSetupFeature;exports.p = normalizeChannelMeta;exports.r = getBundledChannelSecrets;exports.s = listBundledChannelLegacySessionSurfaces;exports.t = getBundledChannelAccountInspector;exports.u = listBundledChannelPlugins;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _bundledPluginMetadataBAyqhztz = require("./bundled-plugin-metadata-BAyqhztz.js");
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js");
...
function loadModuleWithJiti(modulePath) {
  return (0, _pluginModuleLoaderCacheCXUDv7JF.n)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js",
    loaderFilename: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js",
    tryNative: false,
    cacheScopeKey: "channel-plugin-module-loader"
  })(modulePath);
}
function loadModule(modulePath) {
  if (!(0, _pluginModuleLoaderCacheCXUDv7JF.a)(modulePath) && !hasNativeSourceRequireHook(modulePath)) {
...
const OPENCLAW_PACKAGE_ROOT = (0, _openclawRootDDaGBMF_.n)({
  ...
  cwd: process.cwd(),
  moduleUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js".startsWith("file:") ? "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js" : void 0
}) ?? ("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js".startsWith("file:") ? _nodePath.default.resolve((0, _nodeUrl.fileURLToPath)(new URL("../../..", "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/bundled-CGlg0Y2W.js"))) : process.cwd());
...
function listBundledChannelPluginMetadata(params) {
  ...
  return (0, _pluginRegistryBZohWtpt.n)({
...
function resolveBundledChannelGeneratedPath(rootDir, entry, pluginDirName, scanDir) {
  return (0, _bundledPluginMetadataBAyqhztz.t)(rootDir, entry, pluginDirName, scanDir);
}
//#endregion
...
function resolveChannelPluginModuleEntry(moduleExport) {
  const resolved = (0, _moduleExport1nkAarDA.t)(moduleExport);
...
function resolveBundledChannelBoundaryRoot(params) {
  const isModuleUnderRoot = (root) => (0, _pathB5B_oAT.i)(_nodePath.default.resolve(root), params.modulePath);
  const overrideRoot = params.pluginsDir ? _nodePath.default.resolve(params.pluginsDir, params.metadata.dirName) : null;
  if (overrideRoot && isModuleUnderRoot(overrideRoot)) return overrideRoot;
  const distRoot = _nodePath.default.resolve(params.packageRoot, "dist", "extensions", params.metadata.dirName);
  if (isModuleUnderRoot(distRoot)) return distRoot;
  const distRuntimeRoot = _nodePath.default.resolve(params.packageRoot, "dist-runtime", "extensions", params.metadata.dirName);
  if (isModuleUnderRoot(distRuntimeRoot)) return distRuntimeRoot;
...
function loadGeneratedBundledChannelEntry(params) {
  try {
    ...
    const detail = (0, _errorsIxwfrboQ.i)(error);
...
function shouldIncludeBundledChannelSetupFeatureForConfig(params) {
  ...
  if (!(0, _manifestOwnerPolicyCNc1CXKa.i)({
    plugin: { id: pluginId },
    normalizedConfig: (0, _configStateCOhlckC.s)(params.config.plugins),
