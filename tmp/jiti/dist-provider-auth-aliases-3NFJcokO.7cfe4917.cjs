"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = normalizePluginConfigId;exports.i = isWorkspacePluginAllowedByConfig;exports.n = resolveProviderAuthAliasMap;exports.r = resolveProviderIdForAuth;exports.t = resetProviderAuthAliasMapCacheForTest;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function normalizePluginConfigId(id) {
  return (0, _stringCoerceLndEvhRk.s)(id) ?? "";
}
...
function setPreferredAlias(params) {
  const normalizedAlias = (0, _providerIdCz7K6wgK.r)(params.alias);
  const normalizedTarget = (0, _providerIdCz7K6wgK.r)(params.target);
...
function resolveProviderAuthAliasMap(params) {
  ...
  const snapshot = (0, _currentPluginMetadataSnapshotDHmOxzz.n)({
    ...
    if ((0, _configStateBgyjpLHd.s)(config.plugins).loadPaths.length !== 0) return;
  ...
  })() ?? (0, _pluginMetadataSnapshotDlaHO4z.r)({
    config,
    ...(params?.workspaceDir !== void 0 ? { workspaceDir: params.workspaceDir } : {}),
    env
  });
