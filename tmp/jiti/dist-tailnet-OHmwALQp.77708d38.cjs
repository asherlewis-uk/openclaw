...
function isTailnetIPv4(address) {
  return (0, _ipCh1Tjj_.s)(address, TAILNET_IPV4_CIDR);
}
function isTailnetIPv6(address) {
  return (0, _ipCh1Tjj_.s)(address, TAILNET_IPV6_CIDR);
}
