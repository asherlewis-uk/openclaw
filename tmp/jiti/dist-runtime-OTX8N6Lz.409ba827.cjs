"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = registerPluginSessionSchedulerJob;exports.C = isPluginRegistryRetired;exports.D = getPluginRunContext;exports.E = deletePluginSessionSchedulerJob;exports.F = createEmptyPluginRegistry;exports.M = withPluginHostCleanupTimeout;exports.N = buildPluginAgentTurnPrepareContext;exports.O = getPluginSessionSchedulerJobGeneration;exports.P = normalizePluginHostHookId;exports.S = isPluginRegistryActivated;exports.T = clearPluginRunContext;exports._ = requireActivePluginHttpRouteRegistry;exports.a = getActivePluginRegistry;exports.b = resolveActivePluginHttpRouteRegistry;exports.c = getActivePluginRegistryWorkspaceDir;exports.d = pinActivePluginChannelRegistry;exports.f = pinActivePluginHttpRouteRegistry;exports.g = requireActivePluginChannelRegistry;exports.h = releasePinnedPluginHttpRouteRegistry;exports.i = getActivePluginHttpRouteRegistryVersion;exports.j = setPluginRunContext;exports.k = makePluginSessionSchedulerJobKey;exports.l = getActivePluginRuntimeSubagentMode;exports.m = releasePinnedPluginChannelRegistry;exports.n = getActivePluginChannelRegistryVersion;exports.o = getActivePluginRegistryKey;exports.p = recordImportedPluginId;exports.r = getActivePluginHttpRouteRegistry;exports.s = getActivePluginRegistryVersion;exports.t = getActivePluginChannelRegistry;exports.u = listImportedRuntimePluginIds;exports.v = requireActivePluginRegistry;exports.w = cleanupPluginSessionSchedulerJobs;exports.x = setActivePluginRegistry;exports.y = resetPluginRuntimeStateForTest;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _hostHookJsonCgIPvDoo = require("./host-hook-json-CgIPvDoo.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
const log$1 = (0, _subsystemCH8Q21Y.t)("plugins/host-hooks");
function getPluginHostRuntimeState() {
  return (0, _globalSingletonB2nbp4Tq.n)(PLUGIN_HOST_RUNTIME_STATE_KEY, () => ({
...
function setPluginRunContext(params) {
  const runId = (0, _stringCoerceLndEvhRk.c)(params.patch.runId);
  ...
  if (!(0, _hostHookJsonCgIPvDoo.t)(params.patch.value)) return false;
...
function getPluginRunContext(params) {
  const runId = (0, _stringCoerceLndEvhRk.c)(params.get.runId);
...
function registerPluginSessionSchedulerJob(params) {
  const id = (0, _stringCoerceLndEvhRk.c)(params.job.id);
  const sessionKey = (0, _stringCoerceLndEvhRk.c)(params.job.sessionKey);
  const kind = (0, _stringCoerceLndEvhRk.c)(params.job.kind);
...
async function cleanupPluginSessionSchedulerJobs(params) {
  ...
  if (params.records) for (const record of params.records) {
    ...
    const jobId = (0, _stringCoerceLndEvhRk.c)(record.job.id);
    const sessionKey = (0, _stringCoerceLndEvhRk.c)(record.job.sessionKey);
...
const log = (0, _subsystemCH8Q21Y.t)("plugins/runtime");
function asPluginRegistry(registry) {
  return registry;
}
const state = (() => {
  const globalState = globalThis;
  let registryState = globalState[_runtimeStateD14rXNRL.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateD14rXNRL.t] = registryState;
  }
...
async function cleanupPreviousPluginHostRegistry(params) {
  const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([Promise.resolve().then(() => jitiImport("./config/config.js").then((m) => _interopRequireWildcard(m))), Promise.resolve().then(() => jitiImport("./host-hook-cleanup-CMdhkHw6.js").then((m) => _interopRequireWildcard(m)))]);
...
function syncPluginAgentEventBridge() {
  ...
  state.agentEventBridgeUnsubscribe = (0, _agentEventsDVSiKwui.l)((event) => {
...
function getActivePluginChannelRegistry() {
  return (0, _runtimeChannelStateCKHHRUUh.n)().registry;
}
function getActivePluginChannelRegistryVersion() {
  return (0, _runtimeChannelStateCKHHRUUh.n)().version;
}
