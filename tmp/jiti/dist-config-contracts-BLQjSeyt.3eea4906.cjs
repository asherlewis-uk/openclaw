"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolvePluginConfigContractsById;exports.t = collectPluginConfigContractMatches;var _discoveryBNk7kgJV = require("./discovery-BNk7kgJV.js");
  ...
  for (const segment of pattern) {
    ...
    for (const state of states) {
      if (segment === "*") {
        ...
        if ((0, _utilsCKsuXgDI.c)(state.value)) for (const [key, value] of Object.entries(state.value)) nextStates.push({
      ...
      if (!(0, _utilsCKsuXgDI.c)(state.value) || !Object.prototype.hasOwnProperty.call(state.value, segment)) continue;
      nextStates.push({
        segments: [...state.segments, segment],
...
function resolvePluginConfigContractsById(params) {
  ...
  const findBundledConfigContracts = (pluginId) => {
    ...
    const registry = (0, _manifestRegistryDbnX5kdP.t)({
