"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = buildMoonshotProvider;exports.i = applyMoonshotNativeStreamingUsageCompat;exports.n = void 0;exports.o = isNativeMoonshotBaseUrl;exports.t = exports.r = void 0;var _providerCatalogSharedCbrkvEq = require("./provider-catalog-shared-CbrkvEq2.js");
...
function isNativeMoonshotBaseUrl(baseUrl) {
  return (0, _providerCatalogSharedCbrkvEq.o)({
    providerId: "moonshot",
    baseUrl
  });
}
function applyMoonshotNativeStreamingUsageCompat(provider) {
  return (0, _providerCatalogSharedCbrkvEq.t)({
    providerId: "moonshot",
