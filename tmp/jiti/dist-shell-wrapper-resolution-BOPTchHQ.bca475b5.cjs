"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = void 0;exports.D = resolveCarrierCommandArgv;exports.E = parseEnvInvocationPrelude;exports.O = normalizeExecutableToken;exports.S = unwrapKnownDispatchWrapperInvocation;exports.T = isEnvAssignmentToken;exports._ = resolvePowerShellInlineCommandMatch;exports.a = extractShellWrapperInlineCommand;exports.b = resolveDispatchWrapperTrustPlan;exports.c = isShellWrapperExecutable;exports.d = unwrapKnownShellMultiplexerInvocation;exports.f = void 0;exports.g = resolveInlineCommandMatch;exports.h = isPowerShellInlineRestCommandFlag;exports.i = extractShellWrapperCommand;exports.k = splitShellArgs;exports.l = isShellWrapperInvocation;exports.m = isPowerShellInlineFileCommandFlag;exports.n = void 0;exports.o = hasEnvManipulationBeforeShellWrapper;exports.p = advancePosixInlineOptionScan;exports.r = extractBindableShellWrapperInlineCommand;exports.s = isBlockedShellWrapperCommand;exports.t = void 0;exports.u = resolveShellWrapperTransportArgv;exports.v = extractEnvAssignmentKeysFromDispatchWrappers;exports.w = void 0;exports.x = unwrapDispatchWrappersForResolution;exports.y = isDispatchWrapperExecutable;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function basenameLower(token) {
  const win = _nodePath.default.win32.basename(token);
  const posix = _nodePath.default.posix.basename(token);
  return (0, _stringCoerceLndEvhRk.a)(win.length < posix.length ? win : posix);
}
...
const COMMAND_CARRIER_EXECUTABLES = exports.C = new Set([
"sudo",
"doas",
"env",
"command",
...
const SOURCE_EXECUTABLES = exports.w = new Set([".", "source"]);
...
function scanWrapperInvocation(argv, params) {
  ...
  while (idx < argv.length) {
    ...
    const directive = params.onToken(token, (0, _stringCoerceLndEvhRk.a)(token));
...
const POSIX_INLINE_COMMAND_FLAGS = exports.f = new Set([
"-lc",
"-c",
"--command"]
);
...
function expandPowerShellSwitchForms(names) {
  return names.flatMap((name) => {
    const normalized = (0, _stringCoerceLndEvhRk.a)(name);
    return [
    `-${normalized}`,
    `--${normalized}`,
    `/${normalized}`];
...
function resolveInlineCommandMatch(argv, flags, options = {}) {
  for (let i = 1; i < argv.length;) {
    ...
    const lower = (0, _stringCoerceLndEvhRk.a)(token);
    if (lower === "--") break;
...
function isPowerShellInlineRestCommandFlag(token) {
  return POWERSHELL_INLINE_REST_COMMAND_FLAGS.has((0, _stringCoerceLndEvhRk.a)(token));
}
function isPowerShellInlineFileCommandFlag(token) {
  return POWERSHELL_INLINE_FILE_FLAGS.has((0, _stringCoerceLndEvhRk.a)(token));
}
...
const POSIX_SHELL_WRAPPERS = exports.t = new Set(POSIX_SHELL_WRAPPER_NAMES);
const POWERSHELL_WRAPPERS = exports.n = new Set(withWindowsExeAliases(POWERSHELL_WRAPPER_NAMES));
...
function extractCmdInlineCommand(argv) {
  const idx = argv.findIndex((item) => {
    const token = (0, _stringCoerceLndEvhRk.a)(item);
