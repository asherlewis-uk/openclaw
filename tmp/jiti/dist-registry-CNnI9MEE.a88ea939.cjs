...
function registerContextEngineForOwner(id, factory, owner, opts) {
  ...
  if (id === (0, _slotsDLJ2h3Qv.n)("contextEngine") && normalizedOwner !== CORE_CONTEXT_ENGINE_OWNER) return {
    ok: false,
...
async function resolveContextEngine(config, options) {
  ...
  const engineId = typeof slotValue === "string" && slotValue.trim() ? slotValue.trim() : (0, _slotsDLJ2h3Qv.n)("contextEngine");
  const defaultEngineId = (0, _slotsDLJ2h3Qv.n)("contextEngine");
