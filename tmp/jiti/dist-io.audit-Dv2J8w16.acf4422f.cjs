"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = formatConfigOverwriteLogMessage;exports.i = finalizeConfigWriteAuditRecord;exports.n = appendConfigAuditRecordSync;exports.o = scrubConfigAuditLog;exports.r = createConfigWriteAuditRecordBase;exports.s = snapshotConfigAuditProcessInfo;exports.t = appendConfigAuditRecord;var _redactCxqQQvmK = require("./redact-CxqQQvmK.js");
...
function redactConfigAuditArgv(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    result.push((0, _redactCxqQQvmK.l)(current));
  }
  return result;
}
...
function resolveConfigAuditAppendRecord(params) {
  if ("record" in params) return (0, _redactCxqQQvmK.r)(params.record);
  const { fs: _fs, env: _env, homedir: _homedir, ...record } = params;
  return (0, _redactCxqQQvmK.r)(record);
}
