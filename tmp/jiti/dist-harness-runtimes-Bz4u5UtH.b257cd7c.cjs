...
var _policyAKMwD9k = require("./policy-AKMwD9k5.js");
//#region src/agents/harness-runtimes.ts
function normalizeRuntimeId(value) {
  if (typeof value !== "string") return;
  const lower = (0, _stringCoerceLndEvhRk.s)(value);
  if (!lower) return;
  return (0, _stringCoerceLndEvhRk.s)((0, _runtimeD2Px3Q1Z.t)(lower));
}
...
function resolveConfiguredModelHarnessRuntime(params) {
  ...
  if (!parsed) return;
  const runtime = normalizeRuntimeId((0, _policyAKMwD9k.t)({
