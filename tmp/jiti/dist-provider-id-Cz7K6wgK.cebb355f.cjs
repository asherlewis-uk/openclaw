"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = normalizeProviderIdForAuth;exports.n = findNormalizedProviderValue;exports.r = normalizeProviderId;exports.t = findNormalizedProviderKey;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
//#region src/agents/provider-id.ts
function normalizeProviderId(provider) {
  const normalized = (0, _stringCoerceLndEvhRk.a)(provider);
