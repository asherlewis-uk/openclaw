...
async function getLog() {
  if (!log) {
    logPromise ??= Promise.resolve().then(() => jitiImport("./subsystem-Cb901ds8.js").then((m) => _interopRequireWildcard(m))).then(({ createSubsystemLogger }) => createSubsystemLogger("env"));
