"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolvePluginConfigContractsById;exports.t = collectPluginConfigContractMatches;var _discoveryBEbYTYvv = require("./discovery-BEbYTYvv.js");
...
function resolvePluginConfigContractsById(params) {
  ...
  const findBundledConfigContracts = (pluginId) => {
    ...
    const registry = (0, _manifestRegistryDgt5vVG.t)({
