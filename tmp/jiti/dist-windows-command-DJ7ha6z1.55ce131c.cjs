"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = decodeWindowsOutputBuffer;exports.i = createWindowsOutputDecoder;exports.n = resolveCommandStdio;exports.o = resolveWindowsConsoleEncoding;exports.r = spawnWithFallback;exports.t = resolveWindowsCommandShim;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function resolveWindowsConsoleEncoding() {
  ...
  try {
    const result = (0, _nodeChild_process.spawnSync)("cmd.exe", [
    "/d",
    "/s",
    "/c",
    "chcp"],
...
function decodeWindowsOutputBuffer(params) {
  ...
  if (!encoding || (0, _stringCoerceLndEvhRk.a)(encoding) === "utf-8") return params.buffer.toString("utf8");
  try {
...
function createWindowsOutputDecoder(params) {
  ...
  const normalizedEncoding = (0, _stringCoerceLndEvhRk.a)(encoding);
...
function resolveWindowsCommandShim(params) {
  ...
  const basename = (0, _stringCoerceLndEvhRk.a)(_nodePath.default.basename(params.command));
