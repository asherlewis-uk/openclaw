"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = assertNoOAuthSecretRefPolicyViolations;var _typesSecretsCJS3n8Im = require("./types.secrets-CJS3n8Im.js");
...
function hasSecretRefInput(params) {
  return (0, _typesSecretsCJS3n8Im.m)({
    value: params.value,
...
function collectTypeOAuthSecretRefViolations(params) {
  ...
  "keyRef"])
  {
    if ((0, _typesSecretsCJS3n8Im.o)(record[field], params.defaults) === null) continue;
