"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = hasNestedRepetition;exports.a = redactSensitiveFieldValueWithConfig;exports.c = redactToolDetail;exports.d = resolveRedactOptions;exports.f = readLoggingConfig;exports.g = compileSafeRegexDetailed;exports.h = compileSafeRegex;exports.i = redactSensitiveFieldValue;exports.l = redactToolPayloadText;exports.m = compileConfigRegexes;exports.n = isSensitiveFieldKey;exports.o = redactSensitiveLines;exports.p = shouldSkipMutatingLoggingConfigRead;exports.r = redactSecrets;exports.s = redactSensitiveText;exports.t = getDefaultRedactPatterns;exports.u = redactToolPayloadTextWithConfig;exports.v = testRegexWithBoundedInput;var _argvDEHjUPTf = require("./argv-DEHjUPTf.js");
...
function shouldSkipMutatingLoggingConfigRead(argv = process.argv) {
  const [primary, secondary] = (0, _argvDEHjUPTf.n)(argv, 2);
...
function redactSensitiveFieldValueWithOptions(key, value, options) {
  ...
  if (isSensitiveFieldKey(key)) return maskToken(value);
  return value;
}
