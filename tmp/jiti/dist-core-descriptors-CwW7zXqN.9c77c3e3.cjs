"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isDynamicOperatorGatewayMethod;exports.c = resolveCoreOperatorGatewayMethodScope;exports.i = isCoreNodeGatewayMethod;exports.l = void 0;exports.n = createCoreGatewayMethodDescriptors;exports.o = listCoreAdvertisedGatewayMethodNames;exports.r = isCoreGatewayMethodClassified;exports.s = listCoreGatewayMethodNames;exports.u = exports.t = void 0; //#region src/gateway/methods/descriptor.ts
const NODE_GATEWAY_METHOD_SCOPE = exports.u = "node";
const DYNAMIC_GATEWAY_METHOD_SCOPE = exports.l = "dynamic";
//#endregion
...
const STARTUP_UNAVAILABLE_GATEWAY_METHODS = exports.t = CORE_GATEWAY_METHOD_SPECS.filter((spec) => spec.startup === true).map((spec) => spec.name);
