"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = setVerbose;exports.S = isYes;exports._ = void 0;exports.a = getLogger;exports.b = tryParseLogLevel;exports.c = resetLogger;exports.d = toPinoLikeLogger;exports.f = formatLocalIsoWithOffset;exports.g = void 0;exports.h = resolveEnvLogLevelOverride;exports.i = getChildLogger;exports.l = setLoggerConfigLoaderForTests;exports.m = isValidTimeZone;exports.n = void 0;exports.o = getResolvedLoggerSettings;exports.p = formatTimestamp;exports.r = void 0;exports.s = isFileLogLevelEnabled;exports.t = void 0;exports.u = setLoggerOverride;exports.v = levelToMinLevel;exports.w = setYes;exports.x = isVerbose;exports.y = normalizeLogLevel;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _diagnosticEventsBkhOFI0h = require("./diagnostic-events-BkhOFI0h.js");
var _tmpOpenclawDirC5ctwRKD = require("./tmp-openclaw-dir-C5ctwRKD.js");
...
const ALLOWED_LOG_LEVELS = exports._ = [
"silent",
"fatal",
"error",
"warn",
...
function resolveDefaultLogDir() {
  return canUseNodeFs() ? (0, _tmpOpenclawDirC5ctwRKD.n)() : _tmpOpenclawDirC5ctwRKD.t;
}
function resolveDefaultLogFile(defaultLogDir) {
  return canUseNodeFs() ? _nodePath.default.join(defaultLogDir, "openclaw.log") : `${_tmpOpenclawDirC5ctwRKD.t}/openclaw.log`;
}
...
const loadLoggerConfigDefault = () => (0, _redactR2EdHUS.l)();
...
function sanitizeDiagnosticLogText(value, maxChars) {
  return clampDiagnosticLogText((0, _redactR2EdHUS.a)(clampDiagnosticLogText(value, maxChars)), maxChars);
}
...
function assignDiagnosticLogAttribute(attributes, state, key, value) {
  ...
  if ((0, _prototypeKeysDna4GplE.t)(normalizedKey)) return;
  if ((0, _redactR2EdHUS.a)(normalizedKey) !== normalizedKey) return;
...
function normalizeTraceContext(value) {
  ...
  if (!(0, _diagnosticEventsBkhOFI0h.v)(candidate.traceId)) return;
  if (candidate.spanId !== void 0 && !(0, _diagnosticEventsBkhOFI0h.g)(candidate.spanId)) return;
  if (candidate.parentSpanId !== void 0 && !(0, _diagnosticEventsBkhOFI0h.g)(candidate.parentSpanId)) return;
  if (candidate.traceFlags !== void 0 && !(0, _diagnosticEventsBkhOFI0h._)(candidate.traceFlags)) return;
  return {
...
function buildTraceFileLogFields(logObj) {
  ...
  const trace = findLogTraceContext(bindings, args) ?? (0, _diagnosticEventsBkhOFI0h.h)();
  if (!trace) return;
  return {
...
function buildDiagnosticLogRecord(logObj) {
  ...
  const trace = findLogTraceContext(bindings, numericArgs) ?? (0, _diagnosticEventsBkhOFI0h.h)();
...
function isLogRedactionDisabled() {
  return (0, _redactR2EdHUS.l)()?.redactSensitive === "off";
}
function redactLogRecordForTransport(record) {
  return isLogRedactionDisabled() ? record : (0, _redactR2EdHUS.n)(record);
}
function attachDiagnosticEventTransport(logger) {
  logger.attachTransport((logObj) => {
    try {
      (0, _diagnosticEventsBkhOFI0h.n)(buildDiagnosticLogRecord(redactLogRecordForTransport(logObj)));
    } catch {}
  });
}
...
function buildLogger(settings) {
  ...
  logger.attachTransport((logObj) => {
    try {
      ...
      const payload = `${(0, _redactR2EdHUS.a)(JSON.stringify(redactLogRecordForTransport(record)))}\n`;
...
const __test__ = exports.r = {
  ...
  shouldSkipMutatingLoggingConfigRead: _redactR2EdHUS.u
};
