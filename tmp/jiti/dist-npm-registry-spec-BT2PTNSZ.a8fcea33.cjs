"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isPrereleaseResolutionAllowed;exports.c = validateRegistryNpmSpec;exports.i = isOpenClawOrgNpmSpec;exports.n = formatPrereleaseResolutionError;exports.o = isPrereleaseSemverVersion;exports.r = isExactSemverVersion;exports.s = parseRegistryNpmSpec;exports.t = compareOpenClawReleaseVersions;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function isPrereleaseResolutionAllowed(params) {
  ...
  return (0, _stringCoerceLndEvhRk.a)(params.spec.selector) !== "latest";
}
function formatPrereleaseResolutionError(params) {
  const selectorHint = params.spec.selectorKind === "none" || (0, _stringCoerceLndEvhRk.a)(params.spec.selector) === "latest" ? `Use "${params.spec.name}@beta" (or another prerelease tag) or an exact prerelease version to opt in explicitly.` : `Use an explicit prerelease tag or exact prerelease version if you want prerelease installs.`;
