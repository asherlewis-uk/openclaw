"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = formatUncaughtError;exports.c = readErrorName;exports.i = formatErrorMessage;exports.l = stringifyNonErrorCause;exports.n = detectErrorKind;exports.o = hasErrnoCode;exports.r = extractErrorCode;exports.s = isErrno;exports.t = collectErrorGraphCandidates;var _redactR2EdHUS = require("./redact-R2-EdHUS.js");
...
function formatErrorMessage(err) {
  ...
  return (0, _redactR2EdHUS.a)(formatted);
}
/**
...
function formatUncaughtError(err) {
  ...
  if (err instanceof Error) return (0, _redactR2EdHUS.a)(err.stack ?? err.message ?? err.name);
