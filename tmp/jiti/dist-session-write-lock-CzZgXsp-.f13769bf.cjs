"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = cleanStaleLockFiles;exports.c = resolveSessionLockMaxHoldFromTimeout;exports.d = resolveSessionWriteLockOptions;exports.f = resolveSessionWriteLockStaleMs;exports.i = acquireSessionWriteLock;exports.l = resolveSessionWriteLockAcquireTimeoutMs;exports.n = void 0;exports.o = drainSessionWriteLockStateForTest;exports.r = exports.p = void 0;exports.s = resetSessionWriteLockStateForTest;exports.t = void 0;exports.u = resolveSessionWriteLockMaxHoldMs;require("./fs-safe-defaults-azXCfv92.js");
var _fileLockBmUfoFn = require("./file-lock-BmUfoFn1.js");
var _pidAliveB3tYqreQ = require("./pid-alive-B3tYqreQ.js");
var _gatewayProcessesCrpnPrWr = require("./gateway-processes-CrpnPrWr.js");
var _sessionWriteLockErrorDFMzbbAw = require("./session-write-lock-error-DFMzbbAw.js");
...
const DEFAULT_SESSION_WRITE_LOCK_STALE_MS = exports.r = 1800 * 1e3;
const DEFAULT_SESSION_WRITE_LOCK_MAX_HOLD_MS = exports.n = 300 * 1e3;
...
const SESSION_LOCKS = (0, _fileLockBmUfoFn.n)("openclaw.session-write-lock");
let resolveProcessStartTimeForLock = _pidAliveB3tYqreQ.t;
...
function inspectLockPayload(payload, staleMs, nowMs) {
  ...
  const pidAlive = pid !== null ? (0, _pidAliveB3tYqreQ.n)(pid) : false;
...
async function removeReportedStaleLockIfStillStale(params) {
  ...
  const inspected = inspectLockPayloadForSession({
    ...
    readOwnerProcessArgs: params.readOwnerProcessArgs ?? _gatewayProcessesCrpnPrWr.r
  });
...
async function cleanStaleLockFiles(params) {
  ...
  const ownerProcessArgsReader = params.readOwnerProcessArgs ?? _gatewayProcessesCrpnPrWr.r;
  let entries = [];
  try {
...
async function acquireSessionWriteLock(params) {
  ...
  while (true) try {
    return { release: (await SESSION_LOCKS.acquire(sessionFile, {
        ...
        shouldReclaim: async ({ payload, nowMs, heldByThisProcess }) => {
          return await shouldReclaimContendedLockFile(lockPath, inspectLockPayloadForSession({
            ...
            heldByThisProcess,
            reclaimLockWithoutStarttime: true,
            readOwnerProcessArgs: _gatewayProcessesCrpnPrWr.r
          }), staleMs, nowMs);
        }
      })).release };
  } catch (err) {
    ...
    throw new _sessionWriteLockErrorDFMzbbAw.t({
      timeoutMs,
...
const testing = exports.p = {
  cleanupSignals: [...CLEANUP_SIGNALS],
  handleTerminationSignal,
  releaseAllLocksSync,
  runLockWatchdogCheck,
  setProcessStartTimeResolverForTest(resolver) {
    resolveProcessStartTimeForLock = resolver ?? _pidAliveB3tYqreQ.t;
  }
};
...
function resetSessionWriteLockStateForTest() {
  ...
  stopWatchdogTimer();
  unregisterCleanupHandlers();
  resolveProcessStartTimeForLock = _pidAliveB3tYqreQ.t;
}
//#endregion /* v9-c7c587b956b14c5c */
