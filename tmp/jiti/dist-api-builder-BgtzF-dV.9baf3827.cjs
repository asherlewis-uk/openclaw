"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = buildPluginApi;var _apiFacadesB7aKRySD = require("./api-facades-B7aKRySD.js");
...
function buildPluginApi(params) {
  ...
  return (0, _apiFacadesB7aKRySD.t)({
    id: params.id,
    name: params.name,
