...
var _toolImagesBfwv9zjs = require("./tool-images-Bfwv9zjs.js");
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesBfwv9zjs.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  ...
  const mimeType = (await (0, _mimeBg_OIUJn.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
