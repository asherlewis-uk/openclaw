"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = appendAllowedValuesHint;exports.r = summarizeAllowedValues;exports.t = validateJsonSchemaValue;var _stringCoerceDyL154ka = require("./string-coerce-DyL154ka.js");
var _pluginCachePrimitivesDcK62VYf = require("./plugin-cache-primitives-DcK62VYf.js");
var _safeTextJ_0sTthZ = require("./safe-text-J_0sTthZ.js");
...
function messageAlreadyIncludesAllowedValues(message) {
  const lower = (0, _stringCoerceDyL154ka.a)(message);
...
const _require = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/schema-validator-CoHaB3Uu.js");
...
const schemaCache = new _pluginCachePrimitivesDcK62VYf.t(512);
...
function formatAjvErrors(errors) {
  ...
  return errors.map((error) => {
    ...
    return {
      path,
      message,
      text: `${(0, _safeTextJ_0sTthZ.t)(path)}: ${(0, _safeTextJ_0sTthZ.t)(message)}`,
