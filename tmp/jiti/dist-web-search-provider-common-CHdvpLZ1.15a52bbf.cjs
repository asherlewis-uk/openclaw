...
var _webSharedBY2uCeO = require("./web-shared-B-Y2uCeO.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/agents/tools/web-search-provider-common.ts
const webGuardedFetchLoader = (0, _lazyPromiseSFT4i6yI.t)(() => Promise.resolve().then(() => jitiImport("./web-guarded-fetch-DIqzacR8.js").then((m) => _interopRequireWildcard(m))));
...
function resolveSearchTimeoutSeconds(searchConfig) {
  return (0, _webSharedBY2uCeO.s)(searchConfig?.timeoutSeconds, 30);
}
function resolveSearchCacheTtlMs(searchConfig) {
  return (0, _webSharedBY2uCeO.o)(searchConfig?.cacheTtlMinutes, 15);
}
...
function readConfiguredSecretString(value, path) {
  return (0, _normalizeSecretInputCrCOUFln.n)((0, _typesSecretsBxqheYvy.u)({
    value,
    path
  })) || void 0;
}
function readProviderEnvValue(envVars) {
  for (const envVar of envVars) {
    const value = (0, _normalizeSecretInputCrCOUFln.n)(process.env[envVar]);
...
async function postTrustedWebToolsJson(params, parseResponse) {
  return (await loadTrustedWebToolsEndpoint())({
    ...
    if (!response.ok) {
      const detail = await (0, _webSharedBY2uCeO.a)(response, { maxBytes: params.maxErrorBytes ?? 64e3 });
...
async function throwWebSearchApiError(res, providerLabel) {
  const detail = (await (0, _webSharedBY2uCeO.a)(res, { maxBytes: 64e3 })).text;
...
function readCachedSearchPayload(cacheKey) {
  const cached = (0, _webSharedBY2uCeO.i)(SEARCH_CACHE, cacheKey);
  return cached ? {
    ...cached.value,
    cached: true
  } : void 0;
...
function buildSearchCacheKey(parts) {
  return (0, _webSharedBY2uCeO.r)(parts.map((part) => part === void 0 ? "default" : String(part)).join(":"));
}
function writeCachedSearchPayload(cacheKey, payload, ttlMs) {
  (0, _webSharedBY2uCeO.l)(SEARCH_CACHE, cacheKey, payload, ttlMs);
}
