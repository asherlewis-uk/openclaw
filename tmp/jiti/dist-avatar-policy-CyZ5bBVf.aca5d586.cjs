...
function resolveAvatarMime(filePath) {
  return AVATAR_MIME_BY_EXT[(0, _stringCoerceLndEvhRk.a)(_nodePath.default.extname(filePath))] ?? "application/octet-stream";
}
...
function isPathWithinRoot(rootDir, targetPath) {
  return (0, _pathB5B_oAT.i)(rootDir, targetPath);
}
