...
function resolveProviderAuthAliasMap(params) {
  ...
  const snapshot = params?.metadataSnapshot ?? (0, _pluginRegistryBZohWtpt.v)({
    config,
    ...(params?.workspaceDir !== void 0 ? { workspaceDir: params.workspaceDir } : {}),
    env,
    allowWorkspaceScopedSnapshot: true
  }) ?? (() => {
    if ((0, _configStateCOhlckC.s)(config.plugins).loadPaths.length !== 0) return;
