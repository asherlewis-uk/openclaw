"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveConfigIncludes;exports.i = readConfigIncludeFileWithGuards;exports.t = exports.r = exports.n = void 0;var _pathB5B_oAT = require("./path-B5B-_oAT.js");
...
function deepMerge(target, source) {
  ...
  if ((0, _utilsCKsuXgDI.x)(target) && (0, _utilsCKsuXgDI.x)(source)) {
    const result = { ...target };
...
var IncludeProcessor = class IncludeProcessor {
  ...
  process(obj) {
    ...
    if (!(0, _utilsCKsuXgDI.x)(obj)) return obj;
  ...
  processInclude(obj) {
    ...
    if (!(0, _utilsCKsuXgDI.x)(included)) throw new ConfigIncludeError("Sibling keys require included content to be an object", typeof includeValue === "string" ? includeValue : INCLUDE_KEY);
    const rest = {};
  ...
  findContainingRoot(candidate, field) {
    if ((0, _pathB5B_oAT.i)(this.configRoot[field], candidate)) return this.configRoot;
    for (const root of this.allowedRoots) if ((0, _pathB5B_oAT.i)(root[field], candidate)) return root;
    return null;
  }
...
function readConfigIncludeFileWithGuards(params) {
  ...
  if (!(0, _rootFileCqMcFM3J.t)(ioFs)) return ioFs.readFileSync(params.resolvedPath, "utf-8");
