"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = sanitizeGoogleAssistantFirstOrdering;exports.t = isGemma4ModelId;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function isGemma4ModelId(modelId) {
  const normalized = (0, _stringCoerceLndEvhRk.a)(modelId);
  return /(?:^|[/_:-])gemma[-_]?4(?:$|[/_.:-])/.test(normalized);
}
//#endregion /* v9-347d9f735888d503 */
