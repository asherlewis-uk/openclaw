...
var _providerEnvVarsBdegz5z = require("./provider-env-vars-Bdegz5z9.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/plugins/provider-auth-ref.ts
const secretResolveLoader = (0, _lazyPromiseSFT4i6yI.t)(() => Promise.resolve().then(() => jitiImport("./resolve-DEft5TaT.js").then((m) => _interopRequireWildcard(m))));
...
function resolveDefaultProviderEnvVar(provider, config) {
  return (0, _providerEnvVarsBdegz5z.t)(provider, {
    ...(config ? { config } : {}),
    includeUntrustedWorkspacePlugins: false
  })?.find((candidate) => (0, _stringCoerceLndEvhRk.c)(candidate) !== void 0);
}
function resolveDefaultFilePointerId(provider) {
  return `/providers/${(0, _jsonPointerCmLFufbV.t)(provider)}/apiKey`;
}
function resolveRefFallbackInput(params) {
  const fallbackEnvVar = params.preferredEnvVar ?? (0, _providerEnvVarsBdegz5z.t)(params.provider, {
  ...
  return {
    ref: {
      source: "env",
      provider: (0, _refContractBLk8mcqQ.l)(params.config, "env", { preferFirstProviderForSource: true }),
      id: fallbackEnvVar
    },
    resolvedValue: value
  };
...
async function promptEnvSecretRefForSetup(params) {
  ...
  const envCandidate = (0, _stringCoerceLndEvhRk.d)(await params.prompter.text({
    ...
    validate: (value) => {
      ...
      if (!(0, _typesSecretsBxqheYvy.l)(candidate)) return params.copy?.envVarFormatError ?? "Use an env var name like \"OPENAI_API_KEY\" (uppercase letters, numbers, underscores).";
  ...
  const envVar = envCandidate && (0, _typesSecretsBxqheYvy.l)(envCandidate) ? envCandidate : params.defaultEnvVar;
...
async function promptProviderSecretRefForSetup(params) {
  ...
  const defaultProvider = (0, _refContractBLk8mcqQ.l)(params.config, "file", { preferFirstProviderForSource: true });
  ...
  const id = (0, _stringCoerceLndEvhRk.d)(await params.prompter.text({
    ...
    validate: (value) => {
      ...
      if (providerEntry.source === "file" && providerEntry.mode !== "singleValue" && !(0, _refContractBLk8mcqQ.s)(candidate)) return "Use an absolute JSON pointer like \"/providers/openai/apiKey\".";
      if (providerEntry.source === "file" && providerEntry.mode === "singleValue" && candidate !== "value") return "singleValue mode expects id \"value\".";
      if (providerEntry.source === "exec" && !(0, _refContractBLk8mcqQ.o)(candidate)) return (0, _refContractBLk8mcqQ.a)();
    }
  })) || idDefault;
  const ref = {
