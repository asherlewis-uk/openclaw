"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveRegularFileAppendFlags;exports.c = assertNoSymlinkParents;exports.i = readRegularFileSync;exports.l = assertNoSymlinkParentsSync;exports.n = appendRegularFileSync;exports.o = statRegularFile;exports.r = readRegularFile;exports.s = statRegularFileSync;exports.t = appendRegularFile;var _pathBlG8lhgR = require("./path-BlG8lhgR.js");
...
async function assertNoSymlinkParents(params) {
  ...
  for (const segment of walk.segments) {
    ...
    try {
      ...
      if ((0, _pathBlG8lhgR.r)(err) && params.allowMissing !== false) return;
      throw err;
    }
  }
}
...
async function statRegularFile(filePath) {
  ...
  try {
    ...
    if ((0, _pathBlG8lhgR.r)(err)) return { missing: true };
    throw err;
  }
...
function verifyStableReadTarget(params) {
  ...
  if (!(0, _fileIdentityBKNyWMFA.t)(params.preOpenStat, params.postOpenStat) || !(0, _fileIdentityBKNyWMFA.t)(params.pathStat, params.postOpenStat)) throw new Error(`File changed during read: ${params.filePath}`);
}
