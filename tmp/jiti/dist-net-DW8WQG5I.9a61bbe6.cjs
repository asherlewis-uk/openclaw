"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = resolveRequestClientIp;exports.a = isPrivateOrLoopbackAddress;exports.c = isTrustedProxyAddress;exports.d = pickPrimaryLanIPv4;exports.f = resolveClientIp;exports.g = resolveLocalInterfaceAddressMatch;exports.h = resolveHostName;exports.i = isLoopbackHost;exports.l = isValidIPv4;exports.m = resolveGatewayListenHosts;exports.n = isLocalishHost;exports.o = isPrivateOrLoopbackHost;exports.p = resolveGatewayBindHost;exports.r = isLoopbackAddress;exports.s = isSecureWebSocketUrl;exports.t = defaultGatewayBindMode;exports.u = normalizeHostHeader;exports.v = isContainerEnvironment;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _tailnetOHmwALQp = require("./tailnet-OHmwALQp.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetOHmwALQp.i)((0, _tailnetOHmwALQp.a)(), {
    family: "IPv4",
...
function isLoopbackAddress(ip) {
  return (0, _ipCh1Tjj_.f)(ip);
}
function resolveLocalInterfaceAddressMatch(ip, snapshot) {
  const normalized = normalizeIp(ip);
  if (!normalized) return false;
  const effectiveSnapshot = arguments.length >= 2 ? snapshot : (0, _tailnetOHmwALQp.o)();
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipCh1Tjj_.p)(ip);
}
function normalizeIp(ip) {
  return (0, _ipCh1Tjj_.h)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipCh1Tjj_.s)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetOHmwALQp.n)();
