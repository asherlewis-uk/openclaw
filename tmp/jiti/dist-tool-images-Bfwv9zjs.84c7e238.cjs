"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemDLRoKDlF = require("./subsystem-DLRoKDlF.js");
var _base646r8Q508J = require("./base64-6r8Q508J.js");
var _imageOpsCL9ZQP7k = require("./image-ops-CL9ZQP7k.js");
...
const log = (0, _subsystemDLRoKDlF.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsCL9ZQP7k.a)(buf);
  ...
  const sideGrid = (0, _imageOpsCL9ZQP7k.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsCL9ZQP7k.t) {
    const out = await (0, _imageOpsCL9ZQP7k.l)({
      buffer: buf,
      maxSide: side,
      quality,
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base646r8Q508J.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
