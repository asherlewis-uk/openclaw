"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = renderCmdSetAssignment;exports.i = parseCmdSetAssignment;exports.n = quoteCmdScriptArg;exports.r = assertNoCmdLineBreak;exports.t = parseCmdScriptCommandLine;var _argSplitCpKjfjXj = require("./arg-split-CpKjfjXj.js");
...
function parseCmdScriptCommandLine(value) {
  return (0, _argSplitCpKjfjXj.t)(value, { escapeMode: "backslash-quote-only" }).map(unescapeCmdScriptArg);
}
//#endregion /* v9-b5f13b0dd74c4401 */
