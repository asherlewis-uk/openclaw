"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.S = resolveSnakeCaseParamKey;exports._ = readStringParam;exports.a = createActionGate;exports.b = wrapOwnerOnlyToolExecution;exports.c = imageResultFromFile;exports.d = parseAvailableTags;exports.f = payloadTextResult;exports.g = readStringOrNumberParam;exports.h = readStringArrayParam;exports.i = asToolParamsRecord;exports.l = jsonResult;exports.m = readReactionParams;exports.n = void 0;exports.o = failedTextResult;exports.p = readNumberParam;exports.r = void 0;exports.s = imageResult;exports.t = void 0;exports.u = normalizeToolModelOverride;exports.v = stringifyToolPayload;exports.x = readSnakeCaseParamRaw;exports.y = textResult;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
require("./fs-safe-DpJlqO1z.js");
var _secureTempDirGC3bO7Qi = require("./secure-temp-dir-GC3bO7Qi.js");
var _mimeDWfYSjGf = require("./mime-DWfYSjGf.js");
var _toolImagesBpolh_OZ = require("./tool-images-Bpolh_OZ.js");
//#region src/param-key.ts
function toSnakeCaseKey(key) {
  return (0, _stringCoerceLndEvhRk.r)(key.replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z0-9])([A-Z])/g, "$1_$2"));
}
...
async function imageResult(params) {
  ...
  return await (0, _toolImagesBpolh_OZ.r)({
    content,
    details: {
      path: params.path,
      ...params.details,
...
async function imageResultFromFile(params) {
  const buf = (await (0, _secureTempDirGC3bO7Qi.i)({ filePath: params.path })).buffer;
  const mimeType = (await (0, _mimeDWfYSjGf.n)({ buffer: buf.slice(0, 256) })) ?? "image/png";
