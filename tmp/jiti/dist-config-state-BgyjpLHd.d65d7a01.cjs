...
const normalizePluginsConfig = (config) => {
  return (0, _configNormalizationSharedDlCktopk.i)(config, createScopedPluginIdNormalizer());
...
const hasExplicitMemoryEntry = (plugins) => Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, (0, _slotsDLJ2h3Qv.n)("memory")));
const hasExplicitPluginConfig = (plugins) => (0, _configNormalizationSharedDlCktopk.t)(plugins);exports.r = hasExplicitPluginConfig;
...
const resolveEnableState = exports.u = (0, _configNormalizationSharedDlCktopk.o)(resolvePluginActivationState);
const isBundledChannelEnabledByChannelConfig = exports.i = _configNormalizationSharedDlCktopk.r;
const resolveEffectiveEnableState = exports.c = (0, _configNormalizationSharedDlCktopk.a)(resolveEffectivePluginActivationState);
