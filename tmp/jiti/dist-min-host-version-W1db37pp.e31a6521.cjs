...
var _runtimeGuardBuMdLq1N = require("./runtime-guard-BuMdLq1N.js");
...
function parseMinHostVersionRequirement(raw, options = {}) {
  ...
  if (!(0, _runtimeGuardBuMdLq1N.a)(minimumLabel)) return null;
  return {
    raw: trimmed,
    minimumLabel
  };
...
function checkMinHostVersion(params) {
  ...
  const currentSemver = (0, _runtimeGuardBuMdLq1N.a)(currentVersion);
  if (!currentSemver) return {
    ok: false,
    kind: "unknown_host_version",
    requirement
  };
  if (!(0, _runtimeGuardBuMdLq1N.n)(currentSemver, (0, _runtimeGuardBuMdLq1N.a)(requirement.minimumLabel))) return {
    ok: false,
    kind: "incompatible",
    requirement,
    currentVersion
