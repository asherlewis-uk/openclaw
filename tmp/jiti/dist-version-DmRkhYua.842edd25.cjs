"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveBinaryVersion;exports.c = resolveUsableRuntimeVersion;exports.i = readVersionFromPackageJsonForModuleUrl;exports.l = resolveVersionFromModuleUrl;exports.n = void 0;exports.o = resolveCompatibilityHostVersion;exports.r = readVersionFromBuildInfoForModuleUrl;exports.s = resolveRuntimeServiceVersion;exports.t = void 0;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function readVersionFromJsonCandidates(moduleUrl, candidates, opts = {}) {
  try {
    ...
    for (const candidate of candidates) try {
      ...
      const version = (0, _stringCoerceLndEvhRk.c)(parsed.version);
      if (!version) continue;
...
function resolveUsableRuntimeVersion(version) {
  const trimmed = (0, _stringCoerceLndEvhRk.c)(version);
...
const VERSION = exports.n = resolveBinaryVersion({
  moduleUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/version-DmRkhYua.js",
  injectedVersion: readInjectedVersion(),
  bundledVersion: process.env.OPENCLAW_BUNDLED_VERSION
});
//#endregion /* v9-48e8a244728d47d5 */
