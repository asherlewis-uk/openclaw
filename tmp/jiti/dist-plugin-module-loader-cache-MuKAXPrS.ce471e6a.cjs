...
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/plugin-module-loader-cache-MuKAXPrS.js");
...
const requireForJiti = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/plugin-module-loader-cache-MuKAXPrS.js");
...
function resolvePluginModuleLoaderCacheEntry(params) {
  ...
  const cacheKey = resolved.cacheKey ?? (0, _sdkAliasNpL7bYup.r)({
    tryNative,
    aliasMap
  });
  return {
...
function createLazySourceTransformLoader(params) {
  ...
  return () => {
    ...
    const jitiLoader = (params.createLoader ?? loadCreateJitiLoaderFactory())(params.loaderFilename, {
      ...(0, _sdkAliasNpL7bYup.n)(params.aliasMap),
