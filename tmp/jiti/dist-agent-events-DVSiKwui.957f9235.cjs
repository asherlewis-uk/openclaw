...
var _listenersBdesWG = require("./listeners-Bdes-wG9.js");
...
function emitAgentEvent(event) {
  ...
  (0, _listenersBdesWG.t)(state.listeners, enriched);
}
...
function onAgentEvent(listener) {
  return (0, _listenersBdesWG.n)(getAgentEventState().listeners, listener);
}
