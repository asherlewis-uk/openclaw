"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveNpmSpecMetadata;exports.i = resolveNpmPackArchiveMetadata;exports.n = packNpmSpecToArchive;exports.o = withTempDir;exports.r = resolveArchiveSourcePath;exports.t = buildNpmResolutionFields;var _fsSafeDpJlqO1z = require("./fs-safe-DpJlqO1z.js");
...
require("./archive-CvTrYfE4.js");
var _privateTempWorkspaceCS7i2diZ = require("./private-temp-workspace-CS7i2diZ.js");
...
async function resolveNpmSpecMetadata(params) {
  const res = await (0, _execDusmGtXL.r)([
  "npm",
  "view",
  params.spec,
  "name",
...
async function resolveArchiveSourcePath(archivePath) {
  ...
  if (!(0, _archive76p2JA6C.s)(resolved)) return {
    ok: false,
