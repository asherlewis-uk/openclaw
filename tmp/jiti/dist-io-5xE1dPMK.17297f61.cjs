"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = applyConfigOverrides;exports.B = resolveManagedUnsetPathsForWrite;exports.C = validateConfigObjectRaw;exports.D = collectPluginSchemaMetadata;exports.E = collectChannelSchemaMetadata;exports.F = asResolvedSourceConfig;exports.G = createPreUpdateConfigSnapshot;exports.H = shouldAttemptLastKnownGoodRecovery;exports.I = asRuntimeConfig;exports.J = getShellPathFromLoginShell;exports.K = maintainConfigBackups;exports.L = resolveNormalizedProviderModelMaxTokens;exports.M = resetConfigOverrides;exports.N = setConfigOverride;exports.O = void 0;exports.P = unsetConfigOverride;exports.Q = resolveOwnerDisplaySetting;exports.R = normalizeProviderConfigForConfigDefaults;exports.S = validateConfigObject;exports.T = validateConfigObjectWithPlugins;exports.U = createInvalidConfigError;exports.V = isPluginLocalInvalidConfigSnapshot;exports.W = formatInvalidConfigDetails;exports.X = resolveShellEnvFallbackTimeoutMs;exports.Y = loadShellEnvFallback;exports.Z = shouldEnableShellEnvFallback;exports._ = recoverConfigFromLastKnownGood;exports.a = loadConfig;exports.b = writeConfigFile;exports.c = promoteConfigSnapshotToLastKnownGood;exports.d = readConfigFileSnapshotForWrite;exports.f = readConfigFileSnapshotWithPluginMetadata;exports.g = recoverConfigFromJsonRootSuffix;exports.h = readSourceConfigSnapshotForWrite;exports.i = getRuntimeConfig;exports.j = getConfigOverrides;exports.k = resolveShellEnvExpectedKeys;exports.l = readBestEffortConfig;exports.m = readSourceConfigSnapshot;exports.n = clearConfigCache;exports.o = parseConfigJson5;exports.p = readSourceConfigBestEffort;exports.q = getShellEnvAppliedKeys;exports.r = createConfigIO;exports.s = projectConfigOntoRuntimeSourceSnapshot;exports.t = void 0;exports.u = readConfigFileSnapshot;exports.v = registerConfigWriteListener;exports.w = validateConfigObjectRawWithPlugins;exports.x = collectUnsupportedSecretRefPolicyIssues;exports.y = resolveConfigSnapshotHash;exports.z = applyUnsetPathsForWrite;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _envDL0trrAI = require("./env-DL0trrAI.js");
...
var _stateDirDotenvCpqPih8R = require("./state-dir-dotenv-CpqPih8R.js");
...
var _ipDb8k2XjS = require("./ip-Db8k2XjS.js");
var _dotenvDpVSuK0u = require("./dotenv-DpVSuK0u.js");
var _installedPluginIndexRecordsCXoaBLTL = require("./installed-plugin-index-records-CXoaBLTL.js");
var _safeTextCdNixupx = require("./safe-text-CdNixupx.js");
var _includesCuflrSI = require("./includes-CuflrSI8.js");
var _issueFormatC1rffGs = require("./issue-format-C1rff-gs.js");
var _modelRefSharedRt54Iaru = require("./model-ref-shared-Rt54Iaru.js");
var _mergePatchDDivnvVJ = require("./merge-patch-DDivnvVJ.js");
var _defaultsBGwElg4C = require("./defaults-BGwElg4C.js");
var _thinkingIx_990qw = require("./thinking-ix_990qw.js");
var _talkCbjHCImG = require("./talk-CbjHCImG.js");
var _execSafeBinTrustC58pNRL_ = require("./exec-safe-bin-trust-C58pNRL_.js");
var _nixModeWriteGuardBqXH8Kti = require("./nix-mode-write-guard-BqXH8Kti.js");
var _pluginInstallConfigMigrationCm47ZQYp = require("./plugin-install-config-migration-Cm47ZQYp.js");
var _configPathsCGVJzJre = require("./config-paths-CGVJzJre.js");
...
var _providerEnvVarsBdegz5z = require("./provider-env-vars-Bdegz5z9.js");
var _bundledCompatDfs9mbab = require("./bundled-compat-Dfs9mbab.js");
var _schemaValidatorCf8K6s7f = require("./schema-validator-Cf8K6s7f.js");
var _webSearchInstallCatalogBQeH4Lj_ = require("./web-search-install-catalog-BQeH4Lj_.js");
var _avatarPolicyCyZ5bBVf = require("./avatar-policy-CyZ5bBVf.js");
var _modelRefsDXRPZZl = require("./model-refs-DXRP-zZl.js");
var _zodSchemaC6VV4etB = require("./zod-schema-C6VV4etB.js");
var _versionDu8fTz5t = require("./version-Du8fTz5t.js");
...
function resolveOwnerDisplaySetting(config) {
  ...
  return {
    ownerDisplay: "hash",
    ownerDisplaySecret: (0, _stringCoerceLndEvhRk.c)(config?.commands?.ownerDisplaySecret)
  };
}
/**
...
function resolveShellExecEnv(env) {
  const execEnv = (0, _hostEnvSecurityDRikErcl.o)({ baseEnv: env });
  const home = _nodeOs.default.homedir().trim();
  if (home) execEnv.HOME = home;else
  delete execEnv.HOME;
...
function readEtcShells() {
  ...
  try {
    const entries = _nodeFs.default.readFileSync("/etc/shells", "utf8").split(/\r?\n/).map((line) => line.trim()).filter((line) => line.length > 0 && !line.startsWith("#") && _nodePath.default.isAbsolute(line));
...
function isTrustedShellPath(shell) {
  if (!_nodePath.default.isAbsolute(shell)) return false;
  if (_nodePath.default.normalize(shell) !== shell) return false;
...
function probeLoginShellEnv(params) {
  const exec = params.exec ?? _nodeChild_process.execFileSync;
...
function shouldEnableShellEnvFallback(env) {
  return (0, _envDL0trrAI.t)(env.OPENCLAW_LOAD_SHELL_ENV);
}
function shouldDeferShellEnvFallback(env) {
  return (0, _envDL0trrAI.t)(env.OPENCLAW_DEFER_SHELL_ENV_FALLBACK);
}
...
function canonicalizeAgentDir(agentDir) {
  ...
  if (process.platform === "darwin" || process.platform === "win32") return (0, _stringCoerceLndEvhRk.a)(resolved);
  return resolved;
}
function collectReferencedAgentIds(cfg) {
  ...
  ids.add((0, _sessionKeyDFEyR49L.c)(defaultAgentId));
  for (const entry of agents) if (entry?.id) ids.add((0, _sessionKeyDFEyR49L.c)(entry.id));
  const bindings = cfg.bindings;
  if (Array.isArray(bindings)) for (const binding of bindings) {
    const id = binding?.agentId;
    if (typeof id === "string" && id.trim()) ids.add((0, _sessionKeyDFEyR49L.c)(id));
  }
  return [...ids];
}
function resolveEffectiveAgentDir(cfg, agentId, deps) {
  const id = (0, _sessionKeyDFEyR49L.c)(agentId);
  const trimmed = (Array.isArray(cfg.agents?.list) ? cfg.agents?.list.find((agent) => (0, _sessionKeyDFEyR49L.c)(agent.id) === id)?.agentDir : void 0)?.trim();
  if (trimmed) return (0, _utilsCKsuXgDI.p)(trimmed);
  const env = deps?.env ?? process.env;
  const root = (0, _pathsCnwfh6dH.v)(env, deps?.homedir ?? (() => (0, _homeDirIZwpu.o)(env, _nodeOs.default.homedir)));
...
async function cleanOrphanBackups(configPath, ioFs) {
  ...
  const bakPrefix = `${_nodePath.default.basename(configPath)}.bak.`;
  ...
  for (const entry of entries) {
    ...
    await ioFs.unlink(_nodePath.default.join(dir, entry)).catch(() => {});
  }
}
...
function restoreEnvVarRefs(incoming, parsed, env = process.env) {
  ...
  if ((0, _utilsCKsuXgDI.x)(incoming) && (0, _utilsCKsuXgDI.x)(parsed)) {
    const result = {};
...
function redactConfigAuditArgv(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    result.push((0, _redactR2EdHUS.s)(current));
  }
  return result;
}
...
function resolveConfigAuditLogPath(env, homedir) {
  return _nodePath.default.join((0, _pathsCnwfh6dH.v)(env, homedir), "logs", CONFIG_AUDIT_LOG_FILENAME);
}
...
function resolveConfigAuditAppendRecord(params) {
  if ("record" in params) return (0, _redactR2EdHUS.n)(params.record);
  const { fs: _fs, env: _env, homedir: _homedir, ...record } = params;
  return (0, _redactR2EdHUS.n)(record);
}
async function appendConfigAuditRecord(params) {
  try {
    ...
    await params.fs.promises.mkdir(_nodePath.default.dirname(auditPath), {
      recursive: true,
      mode: 448
    });
...
function appendConfigAuditRecordSync(params) {
  try {
    const auditPath = resolveConfigAuditLogPath(params.env, params.homedir);
    const record = resolveConfigAuditAppendRecord(params);
    params.fs.mkdirSync(_nodePath.default.dirname(auditPath), {
      recursive: true,
      mode: 448
    });
...
function resolveClobberPaths(configPath) {
  const dir = _nodePath.default.dirname(configPath);
  const basename = _nodePath.default.basename(configPath);
  return {
    dir,
    prefix: `${basename}.clobbered.`,
    lockPath: _nodePath.default.join(dir, `${basename}.clobber.lock`)
  };
}
...
function formatInvalidConfigDetails(issues) {
  return issues.map((issue) => `- ${(0, _safeTextCdNixupx.t)(issue.path || "<root>")}: ${(0, _safeTextCdNixupx.t)(issue.message)}`).join("\n");
}
...
function hasConfigMeta$1(value) {
  return (0, _utilsCKsuXgDI.c)(value) && (0, _utilsCKsuXgDI.c)(value.meta) && (typeof value.meta.lastTouchedVersion === "string" || typeof value.meta.lastTouchedAt === "string");
}
function resolveGatewayMode$1(value) {
  if (!(0, _utilsCKsuXgDI.c)(value) || !(0, _utilsCKsuXgDI.c)(value.gateway)) return null;
...
function resolveConfigHealthStatePath$1(env, homedir) {
  return _nodePath.default.join((0, _pathsCnwfh6dH.v)(env, homedir), "logs", "config-health.json");
}
...
async function readConfigHealthState$1(deps) {
  try {
    ...
    return (0, _utilsCKsuXgDI.c)(parsed) ? parsed : {};
  } catch {
    return {};
  }
}
async function writeConfigHealthState$1(deps, state) {
  ...
  try {
    await deps.fs.promises.mkdir(_nodePath.default.dirname(healthPath), {
      recursive: true,
      mode: 448
    });
...
function getConfigHealthEntry$1(state, configPath) {
  ...
  if (!entries || !(0, _utilsCKsuXgDI.c)(entries)) return {};
  const entry = entries[configPath];
  return entry && (0, _utilsCKsuXgDI.c)(entry) ? entry : {};
}
...
function collectPollutedSecretPlaceholders(value, pathLabel = "", output = []) {
  ...
  if ((0, _utilsCKsuXgDI.c)(value)) for (const [key, child] of Object.entries(value)) collectPollutedSecretPlaceholders(child, pathLabel ? `${pathLabel}.${key}` : key, output);
  return output;
}
...
async function recoverConfigFromLastKnownGood$1(params) {
  ...
  const issueSummary = (0, _issueFormatC1rffGs.r)([...snapshot.issues, ...snapshot.legacyIssues]);
...
function createMergePatch(base, target) {
  if (!(0, _utilsCKsuXgDI.c)(base) || !(0, _utilsCKsuXgDI.c)(target)) return cloneUnknown(target);
  const patch = {};
  ...
  for (const key of keys) {
    ...
    if ((0, _utilsCKsuXgDI.c)(baseValue) && (0, _utilsCKsuXgDI.c)(targetValue)) {
      const childPatch = createMergePatch(baseValue, targetValue);
      if ((0, _utilsCKsuXgDI.c)(childPatch) && Object.keys(childPatch).length === 0) continue;
...
function projectSourceOntoRuntimeShape(source, runtime) {
  if (!(0, _utilsCKsuXgDI.c)(source) || !(0, _utilsCKsuXgDI.c)(runtime)) return cloneUnknown(source);
  const next = {};
...
function hasOwnIncludeKey(value) {
  return (0, _utilsCKsuXgDI.c)(value) && Object.prototype.hasOwnProperty.call(value, "$include");
}
...
function patchTouchesPath(patch, path) {
  if (path.length === 0) return (0, _utilsCKsuXgDI.c)(patch) ? Object.keys(patch).length > 0 : true;
  if (!(0, _utilsCKsuXgDI.c)(patch)) return true;
...
function setPathValue(value, path, nextValue) {
  ...
  const [head, ...tail] = path;
  if (Array.isArray(value)) {
    if (!isNumericPathSegment(head)) return value;
  ...
  if (!(0, _utilsCKsuXgDI.c)(value)) return value;
  return {
    ...value,
...
function setPathValueCreatingParents(value, path, nextValue) {
  ...
  const record = (0, _utilsCKsuXgDI.c)(value) ? value : {};
  return {
    ...record,
...
function deletePathValue(value, path) {
  if (path.length === 0 || !(0, _utilsCKsuXgDI.c)(value)) return value;
  const [head, ...tail] = path;
...
function preserveAuthoredAgentParams(params) {
  ...
  if (!(0, _utilsCKsuXgDI.c)(defaults)) return params.persistedCandidate;
  ...
  if (!(0, _utilsCKsuXgDI.c)(models)) return next;
  for (const [modelId, modelEntry] of Object.entries(models)) {
    if (!(0, _utilsCKsuXgDI.c)(modelEntry) || !Object.prototype.hasOwnProperty.call(modelEntry, "params")) continue;
    const modelPath = [
    "agents",
    "defaults",
    "models",
    (0, _modelInputB9pBobB.n)(modelId) || modelId];
...
function normalizeAgentModelConfigForWrite(value) {
  if (typeof value === "string") {
    const normalized = (0, _modelInputB9pBobB.n)(value);
  ...
  if (typeof value.primary === "string") {
    const primary = (0, _modelInputB9pBobB.n)(value.primary);
  ...
  if (Array.isArray(value.fallbacks)) {
    const fallbacks = value.fallbacks.map((fallback) => typeof fallback === "string" ? (0, _modelInputB9pBobB.n)(fallback) : fallback);
    if (!(0, _nodeUtil.isDeepStrictEqual)(fallbacks, value.fallbacks)) {
...
function normalizeAgentModelRefsAtPathForWrite(config, path) {
  if (!(0, _utilsCKsuXgDI.c)(getPathValue(config, path))) return config;
  let next = config;
  ...
  if ((0, _utilsCKsuXgDI.c)(models)) {
    const normalizedModels = (0, _modelInputB9pBobB.t)(models);
...
function normalizeAgentListModelRefsForWrite(config) {
  ...
  const nextList = list.map((agent) => {
    if (!(0, _utilsCKsuXgDI.c)(agent)) return agent;
...
function normalizeModelProviderCatalogRefsForWrite(config) {
  const providers = getPathValue(config, ["models", "providers"]);
  if (!(0, _utilsCKsuXgDI.c)(providers)) return config;
  let mutated = false;
  const nextProviders = { ...providers };
  for (const [provider, providerConfig] of Object.entries(providers)) {
    if (!(0, _utilsCKsuXgDI.c)(providerConfig) || !Array.isArray(providerConfig.models)) continue;
    let providerMutated = false;
    const models = providerConfig.models.map((model) => {
      if (!(0, _utilsCKsuXgDI.c)(model) || typeof model.id !== "string") return model;
      const trimmed = model.id.trim();
      if (!trimmed) return model;
      const id = (0, _modelRefSharedRt54Iaru.r)(provider, trimmed);
...
function normalizeModelRefsForWrite(config) {
  return normalizeModelProviderCatalogRefsForWrite(normalizeToolsModelRefsForWrite(normalizeAgentListModelRefsForWrite(normalizeAgentModelRefsAtPathForWrite(config, ["agents", "defaults"]))));
}
...
function hasPathValue(value, path) {
  ...
  const [head, ...tail] = path;
  if (Array.isArray(value)) {
    if (!isNumericPathSegment(head)) return false;
    const index = Number.parseInt(head, 10);
  ...
  if ((0, _prototypeKeysDna4GplE.t)(head) || !Object.prototype.hasOwnProperty.call(value, head)) return false;
  return tail.length === 0 || hasPathValue(value[head], tail);
}
function mergeMissingExplicitValues(currentValue, explicitValue) {
  if (!(0, _utilsCKsuXgDI.c)(currentValue) || !(0, _utilsCKsuXgDI.c)(explicitValue)) {
  ...
  const next = { ...currentValue };
  for (const [key, childExplicitValue] of Object.entries(explicitValue)) {
    if ((0, _prototypeKeysDna4GplE.t)(key)) continue;
...
function injectExplicitlySetPaths(params) {
  ...
  for (const path of params.explicitSetPaths) {
    if (path.length === 0 || path.some(_prototypeKeysDna4GplE.t)) continue;
...
function resolvePersistCandidateForWrite(params) {
  ...
  const persistedBase = preserveUntouchedIncludes({
    patch,
    rootAuthoredConfig,
    persistedCandidate: (0, _mergePatchDDivnvVJ.t)(projectedSource, patch)
  });
...
function readRootSchemaUri(value) {
  if (!(0, _utilsCKsuXgDI.c)(value) || typeof value.$schema !== "string") return;
  return value.$schema;
}
function hasOwnRootSchemaKey(value) {
  return (0, _utilsCKsuXgDI.c)(value) && Object.prototype.hasOwnProperty.call(value, "$schema");
}
function preserveRootSchemaUri(params) {
  ...
  if (sourceSchema === void 0 || !(0, _utilsCKsuXgDI.c)(params.persistedCandidate)) return params.persistedCandidate;
  return {
...
function unsetPathForWriteAt(value, pathSegments, depth) {
  ...
  if (Array.isArray(value)) {
    ...
    const next = value.slice();
    if (child.value === WRITE_PRUNED_OBJECT) next.splice(index, 1);else
  ...
  if ((0, _prototypeKeysDna4GplE.t)(segment) || !isWritePlainObject(value) || !hasOwnObjectKey(value, segment)) return {
    changed: false,
    value
  };
  if (isLeaf) {
  ...
  const next = { ...value };
  if (child.value === WRITE_PRUNED_OBJECT) delete next[segment];else
...
function resolveManagedUnsetPathsForWrite(unsetPaths) {
  ...
  for (const unsetPath of unsetPaths ?? []) {
    if (!Array.isArray(unsetPath) || unsetPath.length === 0) continue;
    if (next.some((existing) => (0, _nodeUtil.isDeepStrictEqual)(existing, unsetPath))) continue;
    next.push([...unsetPath]);
  }
  return next;
}
function collectChangedPaths(base, target, path, output) {
  ...
  if ((0, _utilsCKsuXgDI.c)(base) && (0, _utilsCKsuXgDI.c)(target)) {
    const keys = new Set([...Object.keys(base), ...Object.keys(target)]);
    for (const key of keys) {
...
function normalizeProviderConfigForConfigDefaults(params) {
  const normalized = (0, _thinkingIx_990qw.v)(params.provider, { manifestRegistry: params.manifestRegistry })?.normalizeConfig?.({
...
function applyProviderConfigDefaultsForConfig(params) {
  return (0, _thinkingIx_990qw.v)(params.provider, { manifestRegistry: params.manifestRegistry })?.applyConfigDefaults?.({
    provider: params.provider,
...
function resolveNormalizedProviderModelMaxTokens(params) {
  ...
  if ((0, _providerIdCz7K6wgK.r)(params.providerId) !== "mistral" || clamped < params.contextWindow) return clamped;
...
function applyTalkConfigNormalization(config) {
  return (0, _talkCbjHCImG.n)(config);
}
function applyModelDefaults(cfg, options = {}) {
  ...
  if (providerConfig) {
    ...
    for (const [providerId, provider] of Object.entries(providerConfig)) {
      ...
      const nextModels = models.map((model) => {
        ...
        const id = (0, _modelRefSharedRt54Iaru.r)(providerId, raw.id);
        ...
        const contextWindow = isPositiveNumber(raw.contextWindow) ? raw.contextWindow : _defaultsBGwElg4C.t;
  ...
  if (Array.isArray(rawAgentList)) {
    ...
    const agentList = rawAgentList.map((agent) => {
      ...
      if (isRecord(agent.models)) {
        const normalizedModels = (0, _modelInputB9pBobB.t)(agent.models);
  ...
  const existingModels = (0, _modelInputB9pBobB.t)(rawExistingModels);
...
function normalizeAgentModelConfigForDefaults(value) {
  ...
  if (typeof raw.primary === "string") {
    const primary = (0, _modelInputB9pBobB.n)(raw.primary);
  ...
  if (Array.isArray(raw.fallbacks)) {
    ...
    const fallbacks = rawFallbacks.map((fallback) => typeof fallback === "string" ? (0, _modelInputB9pBobB.n)(fallback) : fallback);
...
function hasAnthropicDefaultSignal(cfg, env) {
  ...
  if (profiles) for (const profile of Object.values(profiles)) {
    const provider = (0, _providerIdCz7K6wgK.r)(profile?.provider);
...
function normalizeExecSafeBinProfilesInConfig(cfg) {
  const normalizeExec = (exec) => {
    ...
    const normalizedProfiles = (0, _execSafeBinTrustC58pNRL_.T)(typedExec.safeBinProfiles);
    typedExec.safeBinProfiles = Object.keys(normalizedProfiles).length > 0 ? normalizedProfiles : void 0;
    const normalizedTrustedDirs = (0, _execSafeBinTrustC58pNRL_.i)(typedExec.safeBinTrustedDirs);
...
function normalizeStringValue(key, value) {
  ...
  if (!key) return value;
  if (PATH_KEY_RE.test(key) || PATH_LIST_KEYS.has(key)) return (0, _utilsCKsuXgDI.p)(value);
  return value;
}
function normalizeAny(key, value) {
  ...
  if (Array.isArray(value)) {
    ...
    return value.map((entry) => {
      ...
      if ((0, _utilsCKsuXgDI.x)(entry)) return normalizeAny(void 0, entry);
      return entry;
    });
  }
  if (!(0, _utilsCKsuXgDI.x)(value)) return value;
...
function sanitizeOverrideValue(value, seen = /* @__PURE__ */new WeakSet()) {
  ...
  for (const [key, entry] of Object.entries(value)) {
    if (entry === void 0 || (0, _prototypeKeysDna4GplE.t)(key)) continue;
...
function mergeOverrides(base, override) {
  if (!(0, _utilsCKsuXgDI.x)(base) || !(0, _utilsCKsuXgDI.x)(override)) return override;
  const next = { ...base };
  for (const [key, value] of Object.entries(override)) {
    if (value === void 0 || (0, _prototypeKeysDna4GplE.t)(key)) continue;
...
function setConfigOverride(pathRaw, value) {
  const parsed = (0, _configPathsCGVJzJre.n)(pathRaw);
  if (!parsed.ok || !parsed.path) return {
    ok: false,
    error: parsed.error ?? "Invalid path."
  };
  (0, _configPathsCGVJzJre.r)(overrides, parsed.path, sanitizeOverrideValue(value));
  return { ok: true };
}
function unsetConfigOverride(pathRaw) {
  ...
  return {
    ok: true,
    removed: (0, _configPathsCGVJzJre.i)(overrides, parsed.path)
  };
}
...
function resolveShellEnvExpectedKeys(env) {
  return [...new Set([
  ...(0, _providerEnvVarsBdegz5z.n)({ env }),
  ...(0, _channelEnvVarsCdW2Wcru.n)({ env }),
...
function collectPatternCandidates(params) {
  ...
  if (token.kind === "wildcard") {
    ...
    if (!(0, _utilsCKsuXgDI.c)(params.current)) return;
...
function stripDeprecatedValidationKeys(raw) {
  if (!(0, _utilsCKsuXgDI.c)(raw) || !(0, _utilsCKsuXgDI.c)(raw.commands) || !Object.hasOwn(raw.commands, "modelsWrite")) return raw;
...
function formatMissingOfficialExternalPluginWarning(pluginId) {
  const catalogEntry = (0, _officialExternalPluginCatalog2ZDJDP4z.t)(pluginId);
  if (!catalogEntry) return null;
  const install = (0, _officialExternalPluginCatalog2ZDJDP4z.c)(catalogEntry);
...
function collectRawBundledChannelConfigIssues(config) {
  if (!config.channels || !(0, _utilsCKsuXgDI.c)(config.channels)) return [];
  const issues = [];
...
function mapZodIssueToConfigIssue(issue) {
  ...
  const allowedValuesSummary = (0, _schemaValidatorCf8K6s7f.r)(collectAllowedValuesFromUnknownIssue(issue));
  ...
  return {
    path,
    message: (0, _schemaValidatorCf8K6s7f.n)(message, allowedValuesSummary),
...
function isWorkspaceAvatarPath(value, workspaceDir) {
  ...
  return (0, _avatarPolicyCyZ5bBVf.o)(workspaceRoot, _nodePath.default.resolve(workspaceRoot, value));
}
function validateIdentityAvatar(config) {
  ...
  for (const [index, entry] of agents.entries()) {
    ...
    if (!avatar) continue;
    if ((0, _avatarPolicyCyZ5bBVf.r)(avatar) || (0, _avatarPolicyCyZ5bBVf.i)(avatar)) continue;
    ...
    if ((0, _avatarPolicyCyZ5bBVf.n)(avatar) && !(0, _avatarPolicyCyZ5bBVf.c)(avatar)) {
      issues.push({
        path: `agents.list.${index}.identity.avatar`,
        message: "identity.avatar must be a workspace-relative path, http(s) URL, or data URI."
      });
    ...
    if (!isWorkspaceAvatarPath(avatar, (0, _agentScopeConfig26EcJVc.o)(config, entry.id ?? (0, _agentScopeConfig26EcJVc.c)(config)))) issues.push({
      path: `agents.list.${index}.identity.avatar`,
...
function validateGatewayTailscaleBind(config) {
  ...
  if (bindMode === "custom" && (0, _ipDb8k2XjS.i)(customBindHost) && (0, _ipDb8k2XjS.u)(customBindHost)) return [];
  return [{
    path: "gateway.bind",
...
function validateConfigObjectRaw(raw, opts) {
  ...
  const validated = _zodSchemaC6VV4etB.t.safeParse(normalizedRaw);
...
function validateConfigObjectWithPluginsBase(raw, opts) {
  ...
  const issues = [];
  const warnings = [];
  const hasExplicitPluginsConfig = (0, _utilsCKsuXgDI.c)(raw) && Object.prototype.hasOwnProperty.call(raw, "plugins");
  ...
  const loadValidationRegistry = () => {
    ...
    registryInfo = { registry: (0, _pluginMetadataSnapshotDlaHO4z.r)({
        config,
        workspaceDir: (0, _agentScopeConfig26EcJVc.o)(config, (0, _agentScopeConfig26EcJVc.c)(config)) ?? void 0,
  ...
  const ensureCompatConfig = () => {
    ...
    compatConfig = (0, _bundledCompatDfs9mbab.t)({
      config,
  ...
  const ensureNormalizedPlugins = () => {
    const info = ensureRegistry();
    if (!info.normalizedPlugins) info.normalizedPlugins = (0, _configStateBgyjpLHd.s)(ensureCompatConfig().plugins);
  ...
  const ensureInstalledPluginRecordIds = () => {
    ...
    try {
      installedPluginRecordIds = new Set(Object.keys((0, _installedPluginIndexRecordReaderBieSpyRG.n)({ env: opts.env })).map(_configStateBgyjpLHd.o));
    } catch {
  ...
  const hasStalePluginEvidenceForUnknownChannel = (channelId) => {
    const normalizedChannelId = (0, _configStateBgyjpLHd.o)(channelId);
    if (!normalizedChannelId || ensureKnownIds().has(normalizedChannelId)) return false;
    const pluginConfig = config.plugins;
    if (Array.isArray(pluginConfig?.allow) && pluginConfig.allow.some((pluginId) => (0, _configStateBgyjpLHd.o)(pluginId) === normalizedChannelId)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.entries) && Object.keys(pluginConfig.entries).some((pluginId) => (0, _configStateBgyjpLHd.o)(pluginId) === normalizedChannelId)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.installs) && Object.keys(pluginConfig.installs).some((pluginId) => (0, _configStateBgyjpLHd.o)(pluginId) === normalizedChannelId)) return true;
  ...
  const collectKnownWebSearchProviderIds = () => {
    return [...new Set([...collectActiveWebSearchProviderIds(), ...(0, _webSearchInstallCatalogBQeH4Lj_.t)().map((entry) => entry.provider.id.trim()).filter((providerId) => providerId.length > 0)])].toSorted((left, right) => left.localeCompare(right));
  };
  const hasStalePluginEvidenceForUnknownWebSearchProvider = (providerId) => {
    const normalizedProviderId = (0, _configStateBgyjpLHd.o)(providerId);
    if (!normalizedProviderId || ensureKnownIds().has(normalizedProviderId)) return false;
    const pluginConfig = config.plugins;
    if (Array.isArray(pluginConfig?.allow) && pluginConfig.allow.some((pluginId) => (0, _configStateBgyjpLHd.o)(pluginId) === normalizedProviderId)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.entries) && Object.keys(pluginConfig.entries).some((pluginId) => (0, _configStateBgyjpLHd.o)(pluginId) === normalizedProviderId)) return true;
    if ((0, _utilsCKsuXgDI.c)(pluginConfig?.installs) && Object.keys(pluginConfig.installs).some((pluginId) => (0, _configStateBgyjpLHd.o)(pluginId) === normalizedProviderId)) return true;
  ...
  const validateWebSearchProvider = () => {
    ...
    const installCatalogEntry = (0, _webSearchInstallCatalogBQeH4Lj_.t)().find((entry) => entry.provider.id === trimmed);
  ...
  const parseProviderModelRef = (value) => {
    ...
    const provider = (0, _stringCoerceLndEvhRk.a)(value.slice(0, slashIndex));
    const model = (0, _stringCoerceLndEvhRk.a)(value.slice(slashIndex + 1));
  ...
  const validateConfiguredModelRefs = () => {
    const configuredRefs = (0, _modelRefsDXRPZZl.n)(config);
    if (configuredRefs.length === 0) return;
    const { registry } = ensureRegistry();
    const suppressedModels = /* @__PURE__ */new Map();
    for (const suppression of (0, _modelCatalog_Ht45yA.r)({ registry }).suppressions) {
  ...
  if (config.channels && (0, _utilsCKsuXgDI.c)(config.channels)) for (const key of Object.keys(config.channels)) {
  ...
  for (const channelId of _idsDFu3Ho6n.t) heartbeatChannelIds.add((0, _stringCoerceLndEvhRk.a)(channelId));
  const validateHeartbeatTarget = (target, path) => {
    ...
    if ((0, _idsDFu3Ho6n.r)(trimmed)) return;
    if (!heartbeatChannelIds.has(normalized)) {
      const { registry } = ensureRegistry();
      for (const record of registry.plugins) for (const channelId of record.channels) {
        const pluginChannel = channelId.trim();
        if (pluginChannel) heartbeatChannelIds.add((0, _stringCoerceLndEvhRk.a)(pluginChannel));
      }
    }
  ...
  const normalizeBlockedDiagnosticPath = (value) => {
    ...
    if (!trimmed) return "";
    try {
      return _nodePath.default.resolve((0, _utilsCKsuXgDI.p)(trimmed, opts.env ?? process.env));
    } catch {
  ...
  for (const diag of registry.diagnostics) {
    ...
    if (diag.pluginId) {
      const normalizedPluginId = (0, _configStateBgyjpLHd.o)(diag.pluginId);
  ...
  const blockedDiagnosticSourceMatchesPluginId = (diagnostic, pluginId) => {
    const normalizedPluginId = (0, _configStateBgyjpLHd.o)(pluginId);
    if (!normalizedPluginId) return false;
    const sourcePath = normalizeBlockedDiagnosticPath(diagnostic.source);
    if (!sourcePath) return false;
    if ((0, _configStateBgyjpLHd.o)(_nodePath.default.basename(sourcePath)) === normalizedPluginId || (0, _configStateBgyjpLHd.o)(_nodePath.default.basename(_nodePath.default.dirname(sourcePath))) === normalizedPluginId) return true;
    ...
    for (const loadPath of loadPaths) {
      ...
      if ((0, _configStateBgyjpLHd.o)(_nodePath.default.basename(resolvedLoadPath)) !== normalizedPluginId) continue;
      if (sourcePath === resolvedLoadPath || (0, _pathB5B_oAT.i)(resolvedLoadPath, sourcePath) || (0, _pathB5B_oAT.i)(sourcePath, resolvedLoadPath)) return true;
    }
    return false;
  };
  const findBlockedPluginDiagnostic = (pluginId) => {
    const direct = blockedPluginDiagnostics.get(pluginId) ?? blockedPluginDiagnostics.get((0, _configStateBgyjpLHd.o)(pluginId));
  ...
  if (entries && (0, _utilsCKsuXgDI.c)(entries)) {
  ...
  for (const pluginId of allow) {
    ...
    if (!knownIds.has(pluginId)) {
      const commandAlias = (0, _manifestCommandAliasesBFWl4mXS.n)({
        command: pluginId,
        registry
      });
  ...
  for (const record of registry.plugins) {
    ...
    if (enabled) {
      ...
      if (memoryDecision.selected && (0, _slotsDLJ2h3Qv.r)(record.kind, "memory")) selectedMemoryPluginId = pluginId;
    }
    ...
    if (enabled || entryHasConfig) if (record.configSchema) {
      const res = (0, _schemaValidatorCf8K6s7f.t)({
      ...
      if (shouldReplacePluginConfig) replacePluginEntryConfig(pluginId, res.value);
...
};exports.t = ConfigRuntimeRefreshError;
function hashConfigRaw(raw) {
  return _nodeCrypto.default.createHash("sha256").update(raw ?? "").digest("hex");
}
async function tightenStateDirPermissionsIfNeeded(params) {
  if (process.platform === "win32") return;
  const stateDir = (0, _pathsCnwfh6dH.v)(params.env, params.homedir);
  const configDir = _nodePath.default.dirname(params.configPath);
  if (_nodePath.default.resolve(configDir) !== _nodePath.default.resolve(stateDir)) return;
  try {
...
function hasConfigMeta(value) {
  ...
  return (0, _utilsCKsuXgDI.c)(meta);
}
function resolveGatewayMode(value) {
  if (!(0, _utilsCKsuXgDI.c)(value)) return null;
  const gateway = value.gateway;
  if (!(0, _utilsCKsuXgDI.c)(gateway) || typeof gateway.mode !== "string") return null;
  const trimmed = gateway.mode.trim();
  return trimmed.length > 0 ? trimmed : null;
}
function collectEnvRefPaths(value, path, output) {
  if (typeof value === "string") {
    if ((0, _envSubstitution9nsc3cTc.n)(value)) output.set(path, value);
    return;
  }
  if (Array.isArray(value)) {
  ...
  if ((0, _utilsCKsuXgDI.c)(value)) for (const [key, child] of Object.entries(value)) collectEnvRefPaths(child, path ? `${path}.${key}` : key, output);
}
function resolveConfigHealthStatePath(env, homedir) {
  return _nodePath.default.join((0, _pathsCnwfh6dH.v)(env, homedir), "logs", CONFIG_HEALTH_STATE_FILENAME);
}
...
async function writeConfigHealthState(deps, state) {
  ...
  try {
    ...
    deps.logger.warn(`Config health-state write failed: ${healthPath}: ${(0, _errorsVfATXfah.i)(err)}`);
  }
}
function writeConfigHealthStateSync(deps, state) {
  const healthPath = resolveConfigHealthStatePath(deps.env, deps.homedir);
  try {
    deps.fs.mkdirSync(_nodePath.default.dirname(healthPath), {
      recursive: true,
      mode: 448
    });
...
function isUpdateChannelOnlyRoot(value) {
  ...
  if (!(0, _utilsCKsuXgDI.c)(update)) return false;
...
function stampConfigVersion(cfg) {
  ...
  return {
    ...
    meta: {
      ...cfg.meta,
      lastTouchedVersion: _versionB2G3zXnp.n,
      lastTouchedAt: now
    }
  };
}
function warnIfConfigFromFuture(cfg, logger) {
  ...
  if (!touched) return;
  if ((0, _versionDu8fTz5t.r)(_versionB2G3zXnp.n, touched)) {
    if (warnedFutureTouchedVersions.has(touched)) return;
    warnedFutureTouchedVersions.add(touched);
    logger.warn([
    `Your OpenClaw config was written by version ${touched}, but this command is running ${_versionB2G3zXnp.n}.`,
...
function resolveConfigPathForDeps(deps) {
  ...
  return (0, _pathsCnwfh6dH.o)(deps.env, (0, _pathsCnwfh6dH.v)(deps.env, deps.homedir));
}
function normalizeDeps(overrides = {}) {
  return {
    ...
    homedir: overrides.homedir ?? (() => (0, _homeDirIZwpu.o)(overrides.env ?? process.env, _nodeOs.default.homedir)),
...
function maybeLoadDotEnvForConfig(env) {
  ...
  (0, _dotenvDpVSuK0u.t)({ quiet: true });
}
...
function findJsonRootSuffix(raw, json5 = _json.default) {
...
async function recoverConfigFromJsonRootSuffixWithDeps(params) {
  ...
  if (!validateConfigObjectWithPlugins((0, _pluginInstallConfigMigrationCm47ZQYp.n)(resolveConfigForRead(resolved, params.deps.env).resolvedConfigRaw), {
    env: params.deps.env,
...
function expandAuthoredTildePath(value, home) {
  ...
  if (suffix.startsWith("/") || suffix.startsWith("\\")) return _nodePath.default.join(home, suffix.slice(1));
  return value;
}
function restoreAuthoredTildePathsForWrite(next, authored, key, home) {
  if (typeof next === "string" && typeof authored === "string" && isPathLikeConfigKey(key) && TILDE_PATH_VALUE_RE.test(authored.trim()) && _nodePath.default.normalize(next) === _nodePath.default.normalize(expandAuthoredTildePath(authored.trim(), home))) return authored;
  ...
  if (!(0, _utilsCKsuXgDI.c)(next) || !(0, _utilsCKsuXgDI.c)(authored)) return next;
  const out = { ...next };
...
function resolveConfigIncludesForRead(parsed, configPath, deps) {
  return (0, _includesCuflrSI.a)(parsed, configPath, {
    readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
    readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesCuflrSI.i)({
      includePath,
      resolvedPath,
      rootRealDir,
      ioFs: deps.fs
  ...
  }, { allowedRoots: (0, _pathsCnwfh6dH.d)(deps.env, deps.homedir) });
}
function resolveConfigForRead(resolvedIncludes, env) {
  if (resolvedIncludes && typeof resolvedIncludes === "object" && "env" in resolvedIncludes) (0, _stateDirDotenvCpqPih8R.i)(resolvedIncludes, env);
  const envWarnings = [];
  return {
    resolvedConfigRaw: (0, _envSubstitution9nsc3cTc.r)(resolvedIncludes, env, { onMissing: (w) => envWarnings.push(w) }),
...
async function collectInvalidConfigLegacyIssues(raw, sourceRaw) {
  if (!raw || typeof raw !== "object") return [];
  const { findDoctorLegacyConfigIssues } = await Promise.resolve().then(() => jitiImport("./legacy-config-issues-Ch60B3hg.js").then((m) => _interopRequireWildcard(m)));
...
function createConfigIO(overrides = {}) {
  ...
  function finalizeLoadedRuntimeConfig(cfg) {
    ...
    (0, _stateDirDotenvCpqPih8R.i)(cfg, deps.env);
    ...
    const ownerDisplaySecretResolution = ensureOwnerDisplaySecret(cfg, () => pendingSecret ?? _nodeCrypto.default.randomBytes(32).toString("hex"));
  ...
  function replaceConfigFileSync(raw) {
    (0, _replaceFileVPhXrtU.i)({
      ...
      dirMode: 448,
      mode: 384,
      tempPrefix: _nodePath.default.basename(configPath),
      copyFallbackOnPermissionError: true,
      fileSystem: deps.fs
    });
  }
  function migrateAndStripShippedPluginInstallConfigRecords(configRaw, options = {}) {
    const installRecords = (0, _pluginInstallConfigMigrationCm47ZQYp.t)(configRaw);
    const stripped = (0, _pluginInstallConfigMigrationCm47ZQYp.n)(configRaw);
    ...
    try {
      const stateDir = (0, _pathsCnwfh6dH.v)(deps.env, deps.homedir);
      const filePath = (0, _installedPluginIndexRecordsCXoaBLTL.i)({
        env: deps.env,
        stateDir
      });
      const previousFile = captureFileSnapshotSync(filePath);
      const existingRecords = (0, _installedPluginIndexRecordReaderBieSpyRG.n)({
        env: deps.env,
        stateDir
      });
      const nextRecords = {
      ...
      if (Object.keys(installRecords).some((pluginId) => !(pluginId in existingRecords))) (0, _installedPluginIndexRecordsCXoaBLTL.c)(nextRecords, {
        config: coerceConfig(stripped),
        env: deps.env,
        stateDir
      });
      const rootConfigRaw = options.rootConfigRaw;
      if (rootConfigRaw !== void 0 && Object.keys((0, _pluginInstallConfigMigrationCm47ZQYp.t)(rootConfigRaw)).length > 0) {
        const persistedRootParsed = (0, _pluginInstallConfigMigrationCm47ZQYp.n)(rootConfigRaw);
      ...
      deps.logger.warn(`Config (${configPath}): could not migrate shipped plugins.installs records into the plugin index: ${(0, _errorsVfATXfah.i)(err)}`);
  ...
  function retainRuntimeOnlyShippedPluginInstallConfigRecords(config, sourceRaw) {
    const installRecords = (0, _pluginInstallConfigMigrationCm47ZQYp.t)(sourceRaw);
  ...
  function ensureShippedPluginInstallConfigRecordsMigratedForWrite(snapshot) {
    const installRecords = {
      ...(0, _pluginInstallConfigMigrationCm47ZQYp.t)(snapshot.sourceConfig),
      ...(0, _pluginInstallConfigMigrationCm47ZQYp.t)(snapshot.parsed)
    };
    ...
    try {
      (0, _installedPluginIndexRecordsCXoaBLTL.c)({
        ...installRecords,
        ...existingRecords
      }, {
        config: coerceConfig((0, _pluginInstallConfigMigrationCm47ZQYp.n)(snapshot.sourceConfig)),
        env: deps.env,
        stateDir
      });
      return {
      ...
      throw new Error(`Config write blocked: shipped plugins.installs records in ${configPath} could not be migrated into the plugin index. Fix state directory permissions or run openclaw plugins registry --refresh, then retry. ${(0, _errorsVfATXfah.i)(err)}`, { cause: err });
    }
  }
  ...
  function loadConfig() {
    try {
      ...
      const loadValidationPluginMetadataSnapshot = (config) => {
        ...
        pluginMetadataSnapshot = (0, _pluginMetadataSnapshotDlaHO4z.r)({
          config: metadataConfig,
          workspaceDir: (0, _agentScopeConfig26EcJVc.o)(metadataConfig, (0, _agentScopeConfig26EcJVc.c)(metadataConfig)),
          env: deps.env
        });
      ...
      if (validated.warnings.length > 0) {
        const details = validated.warnings.map((iss) => `- ${(0, _safeTextCdNixupx.t)(iss.path || "<root>")}: ${(0, _safeTextCdNixupx.t)(iss.message)}`).join("\n");
  ...
  async function readConfigFileSnapshotInternal() {
    ...
    try {
      ...
      try {
        ...
        const message = err instanceof _includesCuflrSI.n ? err.message : `Include resolution failed: ${String(err)}`;
  ...
  async function readSourceConfigBestEffort() {
    ...
    try {
      ...
      return coerceConfig((0, _pluginInstallConfigMigrationCm47ZQYp.n)(resolveConfigForRead(resolved, deps.env).resolvedConfigRaw));
    } catch {
      return {};
    }
  }
  async function writeConfigFile(cfg, options = {}) {
    (0, _nixModeWriteGuardBqXH8Kti.n)({
      configPath,
      env: deps.env
    });
    ...
    if (snapshot.valid && snapshot.exists) {
      ...
      try {
        const resolvedIncludes = (0, _includesCuflrSI.a)(snapshot.parsed, configPath, {
          readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
          readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesCuflrSI.i)({
            includePath,
            resolvedPath,
    ...
    try {
      const result = await (0, _replaceFileVPhXrtU.n)({
        filePath: configPath,
        content: json,
        dirMode: 448,
        mode: 384,
...
function registerConfigWriteListener(listener) {
  return (0, _runtimeSnapshotTLK3Mx7y.d)(listener);
}
...
function projectConfigOntoRuntimeSourceSnapshot(config) {
  ...
  return coerceConfig((0, _mergePatchDDivnvVJ.t)(coerceConfig(projectSourceOntoRuntimeShape(runtimeConfigSourceSnapshot, runtimeConfigSnapshot)), createMergePatch(runtimeConfigSnapshot, config)));
}
function loadConfig() {
  return (0, _runtimeSnapshotTLK3Mx7y.l)(() => createConfigIO().loadConfig());
}
...
async function writeConfigFile(cfg, options = {}) {
  ...
  (0, _nixModeWriteGuardBqXH8Kti.n)({ configPath: io.configPath });
  let nextCfg = cfg;
  const runtimeConfigSnapshot = (0, _runtimeSnapshotTLK3Mx7y.i)();
  const runtimeConfigSourceSnapshot = (0, _runtimeSnapshotTLK3Mx7y.s)();
  const hadRuntimeSnapshot = Boolean(runtimeConfigSnapshot);
  const hadBothSnapshots = Boolean(runtimeConfigSnapshot && runtimeConfigSourceSnapshot);
  if (hadBothSnapshots) nextCfg = coerceConfig((0, _mergePatchDDivnvVJ.t)(runtimeConfigSourceSnapshot, createMergePatch(runtimeConfigSnapshot, cfg)));
  ...
  if (options.skipRuntimeSnapshotRefresh && !hadRuntimeSnapshot && !(0, _runtimeSnapshotTLK3Mx7y.o)()) return;
