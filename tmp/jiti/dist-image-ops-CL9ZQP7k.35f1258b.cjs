"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = getImageMetadata;exports.c = optimizeImageToPng;exports.i = convertHeicToJpeg;exports.l = resizeToJpeg;exports.n = void 0;exports.o = hasAlphaChannel;exports.r = buildImageResizeSideGrid;exports.s = normalizeExifOrientation;exports.t = void 0;exports.u = resizeToPng;var _lazyPromiseSFT4i6yI = require("./lazy-promise-SFT4i6yI.js");
var _tmpOpenclawDirC5ctwRKD = require("./tmp-openclaw-dir-C5ctwRKD.js");
var _execDusmGtXL = require("./exec-DusmGtXL.js");
var _privateTempWorkspaceCS7i2diZ = require("./private-temp-workspace-CS7i2diZ.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/media/image-ops.ts
const IMAGE_REDUCE_QUALITY_STEPS = exports.t = [
85,
75,
65,
55,
...
const MAX_IMAGE_INPUT_PIXELS = exports.n = 25e6;
...
const mediaAttachmentImageOpsLoader = (0, _lazyPromiseSFT4i6yI.n)(async () => {
  const { loadBundledPluginPublicArtifactModuleSync } = await Promise.resolve().then(() => jitiImport("./public-surface-loader-BS29dNdK.js").then((m) => _interopRequireWildcard(m)));
...
async function withImageTemp(fn) {
  return await (0, _privateTempWorkspaceCS7i2diZ.r)({
    rootDir: (0, _tmpOpenclawDirC5ctwRKD.n)(),
    prefix: "openclaw-img-"
  }, fn);
}
async function sipsMetadataFromBuffer(buffer) {
  return await withImageTemp(async (workspace) => {
    const { stdout } = await (0, _execDusmGtXL.i)("/usr/bin/sips", [
    "-g",
    "pixelWidth",
    "-g",
    "pixelHeight",
    await workspace.write("in.img", buffer)],
    {
      timeoutMs: 1e4,
      maxBuffer: 512 * 1024
    });
...
async function sipsResizeToJpeg(params) {
  return await withImageTemp(async (workspace) => {
    ...
    await (0, _execDusmGtXL.i)("/usr/bin/sips", [
    "-Z",
