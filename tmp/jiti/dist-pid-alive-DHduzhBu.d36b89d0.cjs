"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = isPidAlive;exports.r = isPidDefinitelyDead;exports.t = getProcessStartTime;var _nodeFs = _interopRequireDefault(require("node:fs"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function isZombieProcess(pid) {
  ...
  try {
    return _nodeFs.default.readFileSync(`/proc/${pid}/status`, "utf8").match(/^State:\s+(\S)/m)?.[1] === "Z";
  } catch {
    return false;
  }
}
...
function getProcessStartTime(pid) {
  ...
  try {
    const stat = _nodeFs.default.readFileSync(`/proc/${pid}/stat`, "utf8");
