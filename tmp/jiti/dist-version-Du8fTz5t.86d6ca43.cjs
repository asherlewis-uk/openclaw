"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = normalizeOpenClawVersionBase;exports.r = shouldWarnOnTouchedVersion;exports.t = compareOpenClawVersions;var _semverCompareDHhdxikS = require("./semver-compare-DHhdxikS.js");
//#region src/config/version.ts
const VERSION_RE = /^v?(\d+)\.(\d+)\.(\d+)(?:-([0-9A-Za-z.-]+))?$/;
function parseOpenClawVersion(raw) {
  if (!raw) return null;
  const match = (0, _semverCompareDHhdxikS.r)(raw.trim()).match(VERSION_RE);
...
function compareOpenClawVersions(a, b) {
  ...
  if (parsedA.prerelease || parsedB.prerelease) return (0, _semverCompareDHhdxikS.n)(parsedA.prerelease, parsedB.prerelease);
  return 0;
}
