...
function loadBundleManifestFile(params) {
  ...
  const result = (0, _jsonFilesCahFuwKs.c)({
...
function detectBundleManifestFormat(rootDir) {
  ...
  if (_manifestKLnLMS7v.t.some((candidate) => _nodeFs.default.existsSync(_nodePath.default.join(rootDir, candidate)))) return null;
  if ([
