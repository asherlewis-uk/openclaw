"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isJavaScriptModulePath;exports.i = getPluginModuleLoaderStats;exports.n = getCachedPluginModuleLoader;exports.o = tryNativeRequireJavaScriptModule;exports.r = getCachedPluginSourceModuleLoader;exports.s = toSafeImportPath;exports.t = createPluginModuleLoaderCache;var _pluginCachePrimitivesDcK62VYf = require("./plugin-cache-primitives-DcK62VYf.js");
...
const nodeRequire = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/plugin-module-loader-cache-CWzNCn04.js");
...
const requireForJiti = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/plugin-module-loader-cache-CWzNCn04.js");
...
function createPluginModuleLoaderCache(maxEntries = DEFAULT_PLUGIN_MODULE_LOADER_CACHE_ENTRIES) {
  return new _pluginCachePrimitivesDcK62VYf.t(maxEntries);
}
...
function resolvePluginModuleLoaderCacheEntry(params) {
  ...
  const cacheKey = resolved.cacheKey ?? (0, _sdkAliasDMSovejl.r)({
    tryNative,
    aliasMap
  });
  return {
...
function createLazySourceTransformLoader(params) {
  ...
  return () => {
    ...
    const jitiLoader = (params.createLoader ?? loadCreateJitiLoaderFactory())(params.loaderFilename, {
      ...(0, _sdkAliasDMSovejl.n)(params.aliasMap),
