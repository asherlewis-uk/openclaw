...
var _configContractsDNcGOQR = require("./config-contracts-DNcGOQR9.js");
...
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/setup-registry-C32GYnQD.js");
...
function getModuleLoader(modulePath) {
  return (0, _pluginModuleLoaderCacheMuKAXPrS.n)({
    cache: moduleLoaders,
    modulePath,
    importerUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/setup-registry-C32GYnQD.js",
...
function resolveRelevantSetupMigrationPluginIds(params) {
  ...
  for (const plugin of registry.plugins) {
    ...
    if (paths.some((pathPattern) => (0, _configContractsDNcGOQR.t)({
      root: params.config,
      pathPattern
