"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = parseLooseIpAddress;exports.a = isCarrierGradeNatIpv4Address;exports.c = isIpv4Address;exports.d = isLinkLocalIpAddress;exports.f = isLoopbackIpAddress;exports.g = parseCanonicalIpAddress;exports.h = normalizeIpAddress;exports.i = isCanonicalDottedDecimalIPv4;exports.l = isIpv6Address;exports.m = isRfc1918Ipv4Address;exports.n = isBlockedSpecialUseIpv4Address;exports.o = isCloudMetadataIpAddress;exports.p = isPrivateOrLoopbackIpAddress;exports.r = isBlockedSpecialUseIpv6Address;exports.s = isIpInCidr;exports.t = extractEmbeddedIpv4FromIpv6;exports.u = isLegacyIpv4Literal;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function normalizeIpParseInput(raw) {
  const trimmed = (0, _stringCoerceLndEvhRk.c)(raw);
  if (!trimmed) return;
...
function normalizeIpAddress(raw) {
  ...
  if (!parsed) return;
  return (0, _stringCoerceLndEvhRk.a)(normalizeIpv4MappedAddress(parsed).toString());
}
