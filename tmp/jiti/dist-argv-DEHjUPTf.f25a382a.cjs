"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = collectUniqueCommandDescriptors;exports.D = isValueToken;exports.E = consumeRootOptionToken;exports.O = isBunRuntime;exports.S = addCommandDescriptorsToProgram;exports.T = sanitizeCommandDescriptorDescription;exports._ = loadPrivateQaCliModule;exports.a = getPositiveIntFlagValue;exports.b = getCoreCliCommandsWithSubcommands;exports.c = hasFlag;exports.d = isRootHelpInvocation;exports.f = isRootVersionInvocation;exports.g = getSubCliParentDefaultHelpCommands;exports.h = getSubCliEntries;exports.i = getFlagValue;exports.k = isNodeRuntime;exports.l = hasRootVersionAlias;exports.m = getSubCliCommandsWithSubcommands;exports.n = getCommandPathWithRootOptions;exports.o = getPrimaryCommand;exports.p = shouldMigrateStateFromPath;exports.r = getCommandPositionalsWithRootOptions;exports.s = getVerboseFlag;exports.t = buildParseArgv;exports.u = isHelpOrVersionInvocation;exports.v = getCoreCliCommandDescriptors;exports.w = normalizeCommandDescriptorName;exports.x = getCoreCliParentDefaultHelpCommands;exports.y = getCoreCliCommandNames;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function normalizeRuntimeBasename(execPath) {
  ...
  return (0, _stringCoerceLndEvhRk.a)(lastSlash === -1 ? trimmed : trimmed.slice(lastSlash + 1));
}
...
function sanitizeCommandDescriptorDescription(description) {
  return (0, _ansiBk0Jp_0O.t)(description).trim();
}
...
const PRIVATE_QA_DIST_RELATIVE_PATH = _nodePath.default.join("dist", "plugin-sdk", "qa-lab.js");
...
function resolvePrivateQaSourceModuleSpecifier(params) {
  ...
  const packageRoot = (params?.resolvePackageRootSync ?? _openclawRootDDaGBMF_.n)({
    argv1: params?.argv1 ?? process.argv[1],
    cwd: params?.cwd ?? process.cwd(),
    moduleUrl: params?.moduleUrl ?? "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/argv-DEHjUPTf.js"
  });
  if (!packageRoot) return null;
  const existsSync = params?.existsSync ?? _nodeFs.default.existsSync;
  const sourceModulePath = _nodePath.default.join(packageRoot, PRIVATE_QA_DIST_RELATIVE_PATH);
  if (!existsSync(_nodePath.default.join(packageRoot, ".git")) || !existsSync(_nodePath.default.join(packageRoot, "src")) || !existsSync(sourceModulePath)) return null;
  return (0, _nodeUrl.pathToFileURL)(sourceModulePath).href;
}
async function dynamicImportPrivateQaCliModule(specifier) {
  return await ((specifier) => new Promise((r) => r(`${specifier}`)).then((s) => jitiImport(s).then((m) => _interopRequireWildcard(m))))(specifier);
}
