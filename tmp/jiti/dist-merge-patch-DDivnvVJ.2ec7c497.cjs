"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = applyMergePatch;var _utilsCKsuXgDI = require("./utils-CKsuXgDI.js");
...
function isObjectWithStringId(value) {
  if (!(0, _utilsCKsuXgDI.x)(value)) return false;
...
function applyMergePatch(base, patch, options = {}) {
  if (!(0, _utilsCKsuXgDI.x)(patch)) return patch;
  const result = (0, _utilsCKsuXgDI.x)(base) ? { ...base } : {};
  for (const [key, value] of Object.entries(patch)) {
    ...
    if ((0, _utilsCKsuXgDI.x)(value)) {
      const baseValue = result[key];
      result[key] = applyMergePatch((0, _utilsCKsuXgDI.x)(baseValue) ? baseValue : {}, value, options);
      continue;
    }
    result[key] = value;
  }
