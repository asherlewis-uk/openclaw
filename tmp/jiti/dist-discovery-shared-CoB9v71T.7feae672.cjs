"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = shouldUseSyntheticOllamaAuth;exports.n = void 0;exports.r = resolveOllamaDiscoveryResult;exports.t = void 0;var _providerCatalogSharedCbrkvEq = require("./provider-catalog-shared-CbrkvEq2.js");
var _defaultsC1YFsVkx = require("./defaults-C1YFsVkx.js");
var _providerBaseUrlB2jjJens = require("./provider-base-url-B2jjJens.js");
...
function hasExplicitRemoteOllamaApiProvider(providers) {
  ...
  for (const [providerId, provider] of Object.entries(providers)) {
    ...
    const baseUrl = (0, _providerBaseUrlB2jjJens.t)(provider);
...
function shouldUseSyntheticOllamaAuth(providerConfig) {
  ...
  return isLocalOllamaBaseUrl((0, _providerBaseUrlB2jjJens.t)(providerConfig));
}
function hasMeaningfulExplicitOllamaConfig(providerConfig) {
  ...
  const baseUrl = (0, _providerBaseUrlB2jjJens.t)(providerConfig);
  if (baseUrl) return (0, _providerBaseUrlB2jjJens.u)(baseUrl) !== _defaultsC1YFsVkx.n;
...
async function resolveOllamaDiscoveryResult(params) {
  ...
  if (hasExplicitModels && explicit) {
    const baseUrl = (0, _providerBaseUrlB2jjJens.u)((0, _providerBaseUrlB2jjJens.t)(explicit) ?? "http://127.0.0.1:11434");
  ...
  const configuredBaseUrl = (0, _providerBaseUrlB2jjJens.t)(explicit);
  const quiet = !hasRealOllamaKey && !hasMeaningfulExplicitConfig;
  const provider = await (0, _providerCatalogSharedCbrkvEq.i)({
    keyParts: [
    OLLAMA_PROVIDER_ID,
    "models",
