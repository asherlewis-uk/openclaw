"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isGpt5ModelId;exports.c = resolveGpt5PromptOverlayMode;exports.i = void 0;exports.l = resolveGpt5SystemPromptContribution;exports.n = void 0;exports.o = normalizeGpt5PromptOverlayMode;exports.r = void 0;exports.s = renderGpt5PromptOverlay;exports.t = void 0;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
const GPT5_FRIENDLY_CHAT_PROMPT_OVERLAY = exports.n = `## Interaction Style
...
/** @deprecated OpenAI/Codex provider-owned prompt overlay helper; do not use from third-party plugins. */
const GPT5_HEARTBEAT_PROMPT_OVERLAY = exports.i = `### Heartbeats
...
/** @deprecated OpenAI/Codex provider-owned prompt overlay helper; do not use from third-party plugins. */
const GPT5_FRIENDLY_PROMPT_OVERLAY = exports.r = `${GPT5_FRIENDLY_CHAT_PROMPT_OVERLAY}\n\n${GPT5_HEARTBEAT_PROMPT_OVERLAY}`;
/** @deprecated OpenAI/Codex provider-owned prompt overlay helper; do not use from third-party plugins. */
const GPT5_BEHAVIOR_CONTRACT = exports.t = `<persona_latch>
...
function resolveGpt5PromptOverlayMode(config, legacyPluginConfig, params) {
  const providerId = (0, _stringCoerceLndEvhRk.s)(params?.providerId);
...
function isGpt5ModelId(modelId) {
  const normalized = (0, _stringCoerceLndEvhRk.s)(modelId);
