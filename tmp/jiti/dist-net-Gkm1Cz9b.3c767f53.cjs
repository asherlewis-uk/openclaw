"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isPrivateOrLoopbackAddress;exports.c = isTrustedProxyAddress;exports.d = pickPrimaryLanIPv4;exports.f = resolveClientIp;exports.g = resolveRequestClientIp;exports.h = resolveHostName;exports.i = isLoopbackHost;exports.l = isValidIPv4;exports.m = resolveGatewayListenHosts;exports.n = isLocalishHost;exports.o = isPrivateOrLoopbackHost;exports.p = resolveGatewayBindHost;exports.r = isLoopbackAddress;exports.s = isSecureWebSocketUrl;exports.t = defaultGatewayBindMode;exports.u = normalizeHostHeader;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _containerEnvironmentDQOYng0C = require("./container-environment-DQOYng0C.js");
var _tailnetBQRX5pZ = require("./tailnet-B-qRX5pZ.js");
var _ipDb8k2XjS = require("./ip-Db8k2XjS.js");
var _nodeNet = _interopRequireDefault(require("node:net"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetBQRX5pZ.i)((0, _tailnetBQRX5pZ.a)(), {
    family: "IPv4",
    preferredNames: ["en0", "eth0"]
  });
}
function normalizeHostHeader(hostHeader) {
  return (0, _stringCoerceLndEvhRk.a)(hostHeader);
}
function resolveHostName(hostHeader) {
  ...
  if (_nodeNet.default.isIP(host) === 6) return host;
  const [name] = host.split(":");
  return name ?? "";
}
function isLoopbackAddress(ip) {
  return (0, _ipDb8k2XjS.u)(ip);
}
/**
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipDb8k2XjS.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipDb8k2XjS.p)(ip);
}
function stripOptionalPort(ip) {
  ...
  if (_nodeNet.default.isIP(ip)) return ip;
  const lastColon = ip.lastIndexOf(":");
  if (lastColon > -1 && ip.includes(".") && ip.indexOf(":") === lastColon) {
    const candidate = ip.slice(0, lastColon);
    if (_nodeNet.default.isIP(candidate) === 4) return candidate;
  }
  return ip;
}
function parseIpLiteral(raw) {
  ...
  if (!normalized || _nodeNet.default.isIP(normalized) === 0) return;
  return normalized;
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipDb8k2XjS.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetBQRX5pZ.n)();
  ...
  if (mode === "auto") {
    if ((0, _containerEnvironmentDQOYng0C.t)()) return "0.0.0.0";
    if (await canBindToHost("127.0.0.1")) return "127.0.0.1";
    return "0.0.0.0";
  }
  return "0.0.0.0";
...
function defaultGatewayBindMode(tailscaleMode) {
  ...
  return (0, _containerEnvironmentDQOYng0C.t)() ? "auto" : "loopback";
}
/**
...
async function canBindToHost(host) {
  return new Promise((resolve) => {
    const testServer = _nodeNet.default.createServer();
...
function isPrivateOrLoopbackHost(host) {
  ...
  if (_nodeNet.default.isIP(normalized) === 6) {
...
function parseHostForAddressChecks(host) {
  if (!host) return null;
  const normalizedHost = (0, _stringCoerceLndEvhRk.a)(host);
...
function isSecureWebSocketUrl(url, opts) {
  ...
  if (opts?.allowPrivateWs) {
    ...
    return _nodeNet.default.isIP(hostForIpCheck) === 0;
  }
  return false;
}
//#endregion /* v9-0a6448d8ffe8394b */
