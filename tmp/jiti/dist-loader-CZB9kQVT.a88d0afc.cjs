"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = createPluginGatewayMethodDescriptors;exports.E = resolvePluginActivationSourceConfig;exports.S = createGatewayMethodRegistry;exports.T = getCompactionProvider;exports._ = getPluginSessionExtensionStateSync;exports.a = getRuntimePluginRegistryForLoadOptions;exports.b = listCodexAppServerExtensionFactories;exports.c = loadOpenClawPlugins;exports.d = resolveRuntimePluginRegistry;exports.f = void 0;exports.g = drainPluginNextTurnInjectionContext;exports.h = synthesizeMediaGenerationCatalogEntries;exports.i = clearPluginRegistryLoadCache;exports.l = resolveCompatibleRuntimePluginRegistry;exports.m = listMediaGenerationProviderModels;exports.n = clearActivatedPluginRuntimeState;exports.o = isPluginRegistryLoadInFlight;exports.p = createPluginRegistry;exports.r = clearPluginLoaderCache;exports.s = loadOpenClawPluginCliRegistry;exports.t = void 0;exports.u = resolvePluginRegistryLoadCacheKey;exports.v = patchPluginSessionExtension;exports.w = void 0;exports.x = createGatewayMethodDescriptorsFromHandlers;exports.y = projectPluginSessionExtensionsSync;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _argvDEHjUPTf = require("./argv-DEHjUPTf.js");
...
require("./installed-plugin-index-records-DPYBTNTT.js");
...
var _gatewayMethodPolicy5bXBow0N = require("./gateway-method-policy-5bXBow0N.js");
require("./core-descriptors-CwW7zXqN.js");
var _operatorScopesChm67yFb = require("./operator-scopes-Chm67yFb.js");
var _pluginScopeCEsy4RJw = require("./plugin-scope-CEsy4RJw.js");
var _bundledCGlg0Y2W = require("./bundled-CGlg0Y2W.js");
var _moduleExport1nkAarDA = require("./module-export-1nkAarDA.js");
var _apiFacadesB5cP4eTt = require("./api-facades-B5cP4eTt.js");
var _apiBuilderCnCCk5go = require("./api-builder-CnCCk5go.js");
var _registryQ5NCB5C = require("./registry-q5NCB5C0.js");
var _dreamingCph2ILg = require("./dreaming-Cph2ILg5.js");
var _detachedTaskRuntimeStateBfGUlR6z = require("./detached-task-runtime-state-BfGUlR6z.js");
var _bundleMcpI_5nC9w = require("./bundle-mcp-I_-5nC9w.js");
var _commandRegistrationBKWr0JMS = require("./command-registration-BKWr0JMS.js");
var _hookRunnerGlobalD1vhzHUy = require("./hook-runner-global-D1vhzHUy.js");
var _loaderChannelSetupPWf4aSrk = require("./loader-channel-setup-PWf4aSrk.js");
var _memoryEmbeddingProvidersCB8LiTKl = require("./memory-embedding-providers-CB8LiTKl.js");
var _memoryStateCaQrdVVm = require("./memory-state-CaQrdVVm.js");
var _pluginLoadProfileC9eMiU = require("./plugin-load-profile-C9eMiU--.js");
var _runtimeOTX8N6Lz = require("./runtime-OTX8N6Lz.js");
var _registryCY4dANbm = require("./registry-CY4dANbm.js");
var _internalHooksDU6eI8EK = require("./internal-hooks-DU6eI8EK.js");
var _nodeCommandsC62XIrWm = require("./node-commands-C62XIrWm.js");
var _pluginStateStoreD1zneIDF = require("./plugin-state-store-D1zneIDF.js");
var _agentEventsDVSiKwui = require("./agent-events-DVSiKwui.js");
var _hostHookJsonCgIPvDoo = require("./host-hook-json-CgIPvDoo.js");
var _toolContractsCRs6WRWy = require("./tool-contracts-CRs6WRWy.js");
var _workspaceDirDF9GO5GC = require("./workspace-dir-DF9GO5GC.js");
...
var _sessionsDyRU6Npc = require("./sessions-DyRU6Npc.js");
var _mimeDWfYSjGf = require("./mime-DWfYSjGf.js");
require("./host-hook-cleanup-TaXM_2ns.js");
var _httpRouteOverlapCFegpfPU = require("./http-route-overlap-CFegpfPU.js");
var _gatewayRequestScopeDaFjr7Mb = require("./gateway-request-scope-DaFjr7Mb.js");
var _startupTraceSegmentJEdgsslc = require("./startup-trace-segment-jEdgsslc.js");
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));
var _promises = _interopRequireWildcard(require("node:fs/promises"));var fsPromises = _promises;
...
function resolvePluginActivationSourceConfig(params) {
  ...
  const sourceSnapshot = (0, _runtimeSnapshotCXpARQsx.s)();
  if (sourceSnapshot && params.config === (0, _runtimeSnapshotCXpARQsx.i)()) return sourceSnapshot;
...
};exports.w = PluginLoadReentryError;
...
function buildProvenanceIndex(params) {
  ...
  const installs = {
    ...(0, _installedPluginIndexRecordReaderDR3h__QQ.n)({ env: params.env }),
...
function writeRuntimeJsonFile(targetPath, value) {
  (0, _jsonFiles1SmAauRO.f)(targetPath, value);
}
...
function normalizeDescriptor(input) {
  ...
  const normalizedScope = input.scope === "node" || input.scope === "dynamic" ? input.scope : input.owner.kind === "plugin" ? (0, _gatewayMethodPolicy5bXBow0N.t)(name, input.scope).scope : input.scope;
...
function createPluginGatewayMethodDescriptor(params) {
  const normalizedScope = (0, _gatewayMethodPolicy5bXBow0N.t)(params.name, params.scope).scope;
  return {
    name: params.name,
...
function createPluginGatewayMethodDescriptors(registry) {
  ...
  return createGatewayMethodDescriptorsFromHandlers({
    ...
    defaultScope: _operatorScopesChm67yFb.t
  });
}
//#endregion
...
function emitPluginAgentEvent(params) {
  ...
  if (!(0, _hostHookJsonCgIPvDoo.t)(params.event.data)) return {
    emitted: false,
...
function resolveBundledChannelMeta(id) {
  return (0, _chatMetaBtJ8Pxrm.n)().find((meta) => meta?.id === id);
}
...
function listCodexAppServerExtensionFactories() {
  return (0, _runtimeOTX8N6Lz.a)()?.codexAppServerExtensionFactories?.map((entry) => entry.factory) ?? [];
}
//#endregion
...
async function loadSendMessage() {
  sendMessagePromise ??= Promise.resolve().then(() => jitiImport("./message-B30b2Gnh.js").then((m) => _interopRequireWildcard(m))).then((module) => module.sendMessage);
  return sendMessagePromise;
}
let getChannelPluginPromise;
async function loadGetChannelPlugin() {
  getChannelPluginPromise ??= Promise.resolve().then(() => jitiImport("./plugins-DIaNJb21.js").then((m) => _interopRequireWildcard(m))).then((module) => module.getChannelPlugin);
...
async function readMimeSniffBuffer(filePath, size) {
  ...
  try {
    ...
    const length = Math.min(Math.max(0, size), _mimeDWfYSjGf.t);
    const buffer = Buffer.alloc(length);
    const { bytesRead } = await handle.read(buffer, 0, length, 0);
    return buffer.subarray(0, bytesRead);
  } catch (error) {
    return { error: `attachment file MIME read failed for ${filePath}: ${(0, _errorsIxwfrboQ.i)(error)}` };
  } finally {
...
function resolveAttachmentDelivery(params) {
  ...
  if (channel === "telegram") {
    ...
    const forceDocumentMime = (0, _mimeDWfYSjGf.u)(hint?.forceDocumentMime);
    return {
      ...(parseMode ? { parseMode } : {}),
...
async function validateAttachmentFiles(files, maxBytes, options) {
  ...
  for (const file of files) {
    ...
    if (options?.forceDocumentMime) {
      ...
      let detectedMime;
      try {
        detectedMime = (0, _mimeDWfYSjGf.u)(await (0, _mimeDWfYSjGf.n)({ buffer: fileBuffer }));
      } catch (error) {
        return { error: `attachment file MIME detection failed for ${filePath}: ` + (0, _errorsIxwfrboQ.i)(error) };
      }
...
function resolveAttachmentFilePath(params) {
  const workspaceDir = params.sessionKey && params.config ? (0, _agentScopeConfigDCRwWQZy.o)(params.config, (0, _sessionKeyCQewiu8n.u)(params.sessionKey)) : void 0;
  return (0, _workspaceDirDF9GO5GC.r)(params.filePath, (0, _workspaceDirDF9GO5GC.n)(workspaceDir));
}
...
async function sendPluginSessionAttachment(params) {
  ...
  const { deliveryContext, threadId } = (0, _sessionsDyRU6Npc.u)(sessionKey, { cfg: params.config });
  if (!deliveryContext?.channel || !deliveryContext.to) return {
    ok: false,
    error: `session has no active delivery route: ${sessionKey}`
  };
  const normalizedChannel = (0, _messageChannelJqYBZqnL.u)(deliveryContext.channel);
  try {
    if ((normalizedChannel && (0, _messageChannelJqYBZqnL.s)(normalizedChannel) ? (await loadGetChannelPlugin())(normalizedChannel) : void 0)?.outbound?.deliveryMode === "gateway") return {
      ok: false,
    ...
    return {
      ok: false,
      error: `attachment delivery setup failed: ${(0, _errorsIxwfrboQ.i)(error)}`
    };
  }
  ...
  try {
    ...
    return {
      ok: false,
      error: `attachment delivery failed: ${(0, _errorsIxwfrboQ.i)(error)}`
    };
  }
...
const log$1 = (0, _subsystemCH8Q21Y.t)("plugins/host-scheduled-turns");
...
async function removeScheduledSessionTurn(params) {
  try {
    ...
    log$1.warn(`plugin session turn cleanup failed (${formatScheduleLogContext(params)}): ${(0, _errorsIxwfrboQ.i)(error)}`);
    return false;
  }
}
...
async function unschedulePluginSessionTurnsByTag(params) {
  ...
  try {
    ...
    log$1.warn(`plugin session turn untag-list failed: ${(0, _errorsIxwfrboQ.i)(error)}`);
    return {
      removed: 0,
      failed: 1
    };
  ...
  for (const job of candidates) {
    ...
    try {
      ...
      log$1.warn(`plugin session turn untag-remove failed: id=${id} error=${(0, _errorsIxwfrboQ.i)(error)}`);
      failed += 1;
    }
  }
  return {
...
const log = (0, _subsystemCH8Q21Y.t)("plugins/host-hook-state");
...
function resolveSessionStoreCandidates(params) {
  ...
  const defaultTarget = {
    ...
    storePath: (0, _pathsRbVDOqFp.u)(storeConfig, { agentId: params.agentId })
  };
  if (!isStorePathTemplate(storeConfig)) return [defaultTarget];
  const targets = /* @__PURE__ */new Map();
  targets.set(defaultTarget.storePath, defaultTarget);
  for (const target of (0, _targetsB3qI57M.i)(params.cfg)) if (target.agentId === params.agentId) targets.set(target.storePath, target);
...
function buildSessionStoreScanTargets(params) {
  ...
  const agentMainKey = (0, _mainSessionBIlePcj.n)({
    cfg: params.cfg,
    agentId: params.agentId
  });
...
function loadPluginHostHookSessionEntry(params) {
  ...
  const agentId = (0, _combinedStoreGatewayDHN_Y2YM.i)(cfg, canonicalKey);
  ...
  const fallback = candidates[0] ?? {
    agentId,
    storePath: (0, _pathsRbVDOqFp.u)(cfg.session?.store, { agentId })
  };
  let selectedStorePath = fallback.storePath;
  let selectedMatch = findFreshestStoreMatch((0, _storeLoadBzczsLeI.t)(fallback.storePath), ...scanTargets);
  for (let index = 1; index < candidates.length; index += 1) {
    const candidate = candidates[index];
    if (!candidate) continue;
    const match = findFreshestStoreMatch((0, _storeLoadBzczsLeI.t)(candidate.storePath), ...scanTargets);
...
async function enqueuePluginNextTurnInjection(params) {
  ...
  if (params.injection.metadata !== void 0 && !(0, _hostHookJsonCgIPvDoo.t)(params.injection.metadata)) return {
    enqueued: false,
    id: "",
    sessionKey
  };
  ...
  await (0, _storeC86lM9dg.s)(loaded.storePath, (store) => {
...
async function drainPluginNextTurnInjections(params) {
  ...
  const now = params.now ?? Date.now();
  return await (0, _storeC86lM9dg.s)(loaded.storePath, (store) => {
    const entry = store[loaded.storeKey];
    if (!entry?.pluginNextTurnInjections) return [];
    const activePluginIds = new Set(((0, _runtimeOTX8N6Lz.a)()?.plugins ?? []).filter((plugin) => plugin.status === "loaded").map((plugin) => plugin.id));
    const drained = [];
...
async function drainPluginNextTurnInjectionContext(params) {
  ...
  return {
    queuedInjections,
    ...(0, _runtimeOTX8N6Lz.N)({ queuedInjections })
  };
}
...
async function patchPluginSessionExtension(params) {
  ...
  if (params.value !== void 0 && !(0, _hostHookJsonCgIPvDoo.t)(params.value)) return {
    ok: false,
  ...
  const registration = ((0, _runtimeOTX8N6Lz.a)()?.sessionExtensions ?? []).find((entry) => entry.pluginId === pluginId && entry.extension.namespace === namespace);
  ...
  const normalizedSlotKey = rawSlotKey ? (0, _storeLoadBzczsLeI.o)(rawSlotKey) : void 0;
  ...
  return {
    ok: true,
    key: canonicalKey,
    value: await (0, _storeC86lM9dg.s)(loaded.storePath, (store) => {
      const entry = store[loaded.storeKey];
      if (!entry) return;
      ...
      const previousSlotKey = (0, _storeLoadBzczsLeI.o)(pluginSlotKeys[namespace]);
...
function projectSessionExtensionValueForSlot(params) {
  ...
  if (projected === void 0 || !(0, _hostHookJsonCgIPvDoo.t)(projected)) return;
...
function projectPluginSessionExtensionsSync(params) {
  const extensions = (0, _runtimeOTX8N6Lz.a)()?.sessionExtensions ?? [];
  ...
  for (const registration of extensions) {
    ...
    if (projected === void 0 || !(0, _hostHookJsonCgIPvDoo.t)(projected)) continue;
    projections.push({
      pluginId: registration.pluginId,
      namespace: registration.extension.namespace,
...
function normalizeTextList(values) {
  const normalized = Array.from(new Set((0, _stringNormalizationDgUPESoD.l)(values)));
...
const LEGACY_DEACTIVATE_HOOK_ALIAS_COMPAT = (0, _installedPluginIndexStoreDEo2ZAhx.v)("legacy-deactivate-hook-alias");
...
const constrainLegacyPromptInjectionHook = (handler) => {
  return (event, ctx) => {
    ...
    if (result && typeof result === "object" && "then" in result) return Promise.resolve(result).then((resolved) => (0, _commandRegistrationBKWr0JMS.g)(resolved));
    return (0, _commandRegistrationBKWr0JMS.g)(result);
  };
};
...
function createPluginRegistry(registryParams) {
  const registry = (0, _runtimeOTX8N6Lz.F)();
  ...
  const registerAgentToolResultMiddleware = (record, handler, options) => {
    ...
    const runtimes = (0, _toolContractsCRs6WRWy.o)(options);
    ...
    const declared = (0, _toolContractsCRs6WRWy.a)(record.contracts?.agentToolResultMiddleware);
  ...
  const registerTool = (record, tool, opts) => {
    ...
    const declaredNames = (0, _toolContractsCRs6WRWy.n)(record.contracts);
    ...
    const normalized = (0, _toolContractsCRs6WRWy.r)(names);
    const undeclared = (0, _toolContractsCRs6WRWy.t)({
      declaredNames,
  ...
  const registerHook = (record, events, handler, opts, config, pluginConfig) => {
    ...
    for (const registration of previousRegistrations) (0, _internalHooksDU6eI8EK.h)(registration.event, registration.handler);
    ...
    for (const event of normalizedEvents) {
      ...
      (0, _internalHooksDU6eI8EK.f)(event, wrappedHandler);
  ...
  const registerGatewayMethod = (record, method, handler, opts) => {
    ...
    const normalizedScope = (0, _gatewayMethodPolicy5bXBow0N.t)(trimmed, opts?.scope);
  ...
  const registerHttpRoute = (record, params) => {
    const normalizedPath = (0, _httpRouteOverlapCFegpfPU.n)(params.path);
    if (!normalizedPath) {
      pushDiagnostic({
        level: "warn",
        pluginId: record.id,
    ...
    const overlappingRoute = (0, _httpRouteOverlapCFegpfPU.t)(registry.httpRoutes, {
      path: normalizedPath,
      match
    });
  ...
  const registerAgentHarness$1 = (record, harness) => {
    ...
    const existing = registryParams.activateGlobalSideEffects === false ? registry.agentHarnesses.find((entry) => entry.harness.id === id) : (0, _registryQ5NCB5C.r)(id);
    if (existing) {
    ...
    if (registryParams.activateGlobalSideEffects !== false) (0, _registryQ5NCB5C.o)(normalizedHarness, { ownerPluginId: record.id });
  ...
  const registerCli = (record, registrar, opts) => {
    const normalizeCommandRoot = (raw, source) => {
      const normalized = (0, _argvDEHjUPTf.w)(raw);
    ...
    const descriptors = (opts?.descriptors ?? []).map((descriptor) => {
      ...
      const description = (0, _argvDEHjUPTf.T)(descriptor.description);
  ...
  ..._nodeCommandsC62XIrWm.i,
  ..._nodeCommandsC62XIrWm.n,
  _nodeCommandsC62XIrWm.r]
  );
  ...
  const registerCommand = (record, command) => {
    ...
    if (allowReservedCommandNames && !(0, _commandRegistrationBKWr0JMS.t)(name)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
    ...
    if (!registryParams.activateGlobalSideEffects) {
      const validationError = (0, _commandRegistrationBKWr0JMS.o)(command, { allowReservedCommandNames });
      if (validationError) {
        pushDiagnostic({
          level: "error",
          pluginId: record.id,
      ...
      const result = (0, _commandRegistrationBKWr0JMS.i)(record.id, allowReservedCommandNames ? commandForRegistration : command, {
        pluginName: record.name,
      ...
      if (allowReservedCommandNames) {
        const registeredCommand = _commandRegistrationBKWr0JMS.j.get(`/${name.toLowerCase()}`);
  ...
  const normalizeHostHookString = (value) => typeof value === "string" ? (0, _runtimeOTX8N6Lz.P)(value) : "";
  ...
  const validateSessionActionSchema = (record, id, schema) => {
    ...
    if (!(0, _hostHookJsonCgIPvDoo.t)(schema)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
  ...
  const registerSessionExtension = (record, extension) => {
    ...
    if (extension.sessionEntrySlotKey !== void 0) {
      const slotKey = (0, _storeLoadBzczsLeI.o)(extension.sessionEntrySlotKey);
    ...
    if (normalizedSessionEntrySlotKey) {
      if ((registry.sessionExtensions ?? []).find((entry) => {
        ...
        const normalizedExistingSlotKey = (0, _storeLoadBzczsLeI.o)(existingSlotKey);
  ...
  const registerToolMetadata = (record, metadata) => {
    ...
    const undeclared = (0, _toolContractsCRs6WRWy.t)({
      declaredNames: (0, _toolContractsCRs6WRWy.n)(record.contracts),
      toolNames: [toolName]
    });
    if (undeclared.length > 0) {
      pushDiagnostic({
  ...
  const registerControlUiDescriptor = (record, descriptor) => {
    ...
    if (requiredScopes !== void 0) {
      const unknownScope = requiredScopes.find((scope) => !(0, _operatorScopesChm67yFb.s)(scope));
    ...
    if (descriptor.schema !== void 0 && !(0, _hostHookJsonCgIPvDoo.t)(descriptor.schema)) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
        source: record.source,
  ...
  const registerRuntimeLifecycle = (record, lifecycle) => {
    const id = (0, _runtimeOTX8N6Lz.P)(lifecycle.id);
    if (!id) {
      pushDiagnostic({
        level: "error",
        pluginId: record.id,
  ...
  const registerAgentEventSubscription = (record, subscription) => {
    const id = (0, _runtimeOTX8N6Lz.P)(subscription.id);
  ...
  const registerSessionSchedulerJob = (record, job) => {
    ...
    const handle = (0, _runtimeOTX8N6Lz.A)({
      pluginId: record.id,
      pluginName: record.name,
    ...
    (registry.sessionSchedulerJobs ??= []).push({
      ...
      generation: (0, _runtimeOTX8N6Lz.O)({
        pluginId: record.id,
        jobId: handle.id,
        sessionKey: handle.sessionKey
      }),
  ...
  const registerTypedHook = (record, hookName, handler, opts, policy) => {
    if (!(0, _commandRegistrationBKWr0JMS.p)(hookName)) {
      pushDiagnostic({
        level: "warn",
        pluginId: record.id,
        source: record.source,
    ...
    if (policy?.allowPromptInjection === false && (0, _commandRegistrationBKWr0JMS.m)(effectiveHookName)) {
    ...
    if ((0, _commandRegistrationBKWr0JMS.f)(effectiveHookName)) {
  ...
  const resolvePluginRuntime = (pluginId) => {
    ...
    const runtime = new Proxy(registryParams.runtime, { get(target, prop, receiver) {
        const runWithPluginScope = (run) => {
          ...
          return record?.source ? (0, _gatewayRequestScopeDaFjr7Mb.i)({
            pluginId,
            pluginSource: record.source
          }, run) : (0, _gatewayRequestScopeDaFjr7Mb.i)({ pluginId }, run);
        };
        if (prop === "state") return {
          ...
          openKeyedStore: (options) => {
            ...
            return (0, _pluginStateStoreD1zneIDF.t)(pluginId, options);
          }
        };
        if (prop === "config") {
        ...
        if (prop === "llm") {
          ...
          return { complete: (params) => (0, _gatewayRequestScopeDaFjr7Mb.r)(pluginId, () => llm.complete(params)) };
        }
        if (prop !== "subagent") return Reflect.get(target, prop, receiver);
        const subagent = Reflect.get(target, prop, receiver);
        return {
          run: (params) => (0, _gatewayRequestScopeDaFjr7Mb.r)(pluginId, () => subagent.run(params)),
          waitForRun: (params) => (0, _gatewayRequestScopeDaFjr7Mb.r)(pluginId, () => subagent.waitForRun(params)),
          getSessionMessages: (params) => (0, _gatewayRequestScopeDaFjr7Mb.r)(pluginId, () => subagent.getSessionMessages(params)),
          getSession: (params) => (0, _gatewayRequestScopeDaFjr7Mb.r)(pluginId, () => subagent.getSession(params)),
          deleteSession: (params) => (0, _gatewayRequestScopeDaFjr7Mb.r)(pluginId, () => subagent.deleteSession(params))
        };
      } });
  ...
  const createApi = (record, params) => {
    ...
    const isLoadedRecordInActiveRegistry = () => (0, _runtimeOTX8N6Lz.a)() === registry && isLoadedRecordInRegistry();
    ...
    const shouldCommitWorkflowSideEffect = () => sideEffectGuard.active && !(0, _runtimeOTX8N6Lz.C)(registry) && (isActivatingLoadedRecord() || (0, _runtimeOTX8N6Lz.S)(registry) && isLoadedRecordInRegistry());
    return (0, _apiBuilderCnCCk5go.t)({
      id: record.id,
      name: record.name,
      ...
      handlers: {
        ...(registrationCapabilities.capabilityHandlers ? {
          ...
          registerDetachedTaskRuntime: (runtime) => {
            const existing = (0, _detachedTaskRuntimeStateBfGUlR6z.n)();
            ...
            (0, _detachedTaskRuntimeStateBfGUlR6z.i)(record.id, runtime);
          },
          ...
          registerInteractiveHandler: (registration) => {
            const result = (0, _commandRegistrationBKWr0JMS.b)(record.id, registration, {
              pluginName: record.name,
              pluginRoot: record.rootDir
            });
          ...
          registerContextEngine: (id, factory) => {
            ...
            if (normalizedId === (0, _slotsMFUVcT3n.n)("contextEngine")) {
              pushDiagnostic({
                level: "error",
                pluginId: record.id,
                source: record.source,
            ...
            const result = (0, _registryCY4dANbm.r)(normalizedId, factory, `plugin:${record.id}`, { allowSameOwnerRefresh: true });
            if (!result.ok) {
              pushDiagnostic({
                level: "error",
                pluginId: record.id,
          ...
          setRunContext: (patch) => registryParams.activateGlobalSideEffects !== false && shouldCommitWorkflowSideEffect() ? (0, _runtimeOTX8N6Lz.j)({
            pluginId: record.id,
            patch
          }) : false,
          getRunContext: (get) => (0, _runtimeOTX8N6Lz.D)({
            pluginId: record.id,
            get
          }),
          clearRunContext: (params) => {
            if (registryParams.activateGlobalSideEffects === false || !shouldCommitWorkflowSideEffect()) return;
            (0, _runtimeOTX8N6Lz.T)({
              pluginId: record.id,
              runId: params.runId,
          ...
          registerMemoryCapability: (capability) => {
            if (!(0, _slotsMFUVcT3n.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory capability");
            ...
            (0, _memoryStateCaQrdVVm.d)(record.id, capability);
          },
          registerMemoryPromptSection: (builder) => {
            if (!(0, _slotsMFUVcT3n.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory prompt section");
            if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
              pushDiagnostic({
                level: "warn",
                pluginId: record.id,
            ...
            (0, _memoryStateCaQrdVVm.g)(record.id, builder);
          },
          registerMemoryPromptSupplement: (builder) => {
            ...
            (0, _memoryStateCaQrdVVm._)(record.id, builder);
          },
          registerMemoryCorpusSupplement: (supplement) => {
            (0, _memoryStateCaQrdVVm.f)(record.id, supplement);
          },
          registerMemoryFlushPlan: (resolver) => {
            if (!(0, _slotsMFUVcT3n.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory flush plan");
            if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
              pushDiagnostic({
                level: "warn",
                pluginId: record.id,
            ...
            (0, _memoryStateCaQrdVVm.m)(record.id, resolver);
          },
          registerMemoryRuntime: (runtime) => {
            if (!(0, _slotsMFUVcT3n.r)(record.kind, "memory")) throwRegistrationError("only memory plugins can register a memory runtime");
            if (Array.isArray(record.kind) && record.kind.length > 1 && !record.memorySlotSelected) {
              pushDiagnostic({
                level: "warn",
                pluginId: record.id,
            ...
            (0, _memoryStateCaQrdVVm.y)(record.id, runtime);
          },
          registerMemoryEmbeddingProvider: (adapter) => {
            ...
            const existing = (0, _memoryEmbeddingProvidersCB8LiTKl.r)(adapter.id);
            if (existing) {
              const ownerDetail = existing.ownerPluginId ? ` (owner: ${existing.ownerPluginId})` : "";
              pushDiagnostic({
                level: "error",
            ...
            (0, _memoryEmbeddingProvidersCB8LiTKl.o)(adapter, { ownerPluginId: record.id });
  ...
  const rollbackPluginGlobalSideEffects = (pluginId) => {
    ...
    if (registryParams.activateGlobalSideEffects === false) return;
    (0, _commandRegistrationBKWr0JMS.D)(pluginId);
    (0, _commandRegistrationBKWr0JMS.v)(pluginId);
    (0, _registryCY4dANbm.t)(`plugin:${pluginId}`);
    ...
    for (const entry of hookRollbackEntries.toReversed()) {
      ...
      for (const registration of activeRegistrations) (0, _internalHooksDU6eI8EK.h)(registration.event, registration.handler);
      if (entry.previousRegistrations.length === 0) {
        activePluginHookRegistrations.delete(entry.name);
        continue;
      }
      for (const registration of entry.previousRegistrations) (0, _internalHooksDU6eI8EK.f)(registration.event, registration.handler);
...
function detailPluginStartupTrace(startupTrace, pluginId, metrics) {
  startupTrace?.detail(`plugins.gateway-load.plugin.${(0, _startupTraceSegmentJEdgsslc.t)(pluginId)}`, metrics);
}
...
function resolveDreamingSidecarEngineId(params) {
  ...
  return (0, _dreamingCph2ILg.G)({
    pluginConfig: (0, _dreamingCph2ILg.K)(params.cfg),
    cfg: params.cfg
  }).enabled ? _dreamingCph2ILg._ : null;
}
...
function clearActivatedPluginRuntimeState() {
  (0, _registryQ5NCB5C.t)();
  (0, _commandRegistrationBKWr0JMS.E)();
  clearCompactionProviders();
  (0, _detachedTaskRuntimeStateBfGUlR6z.t)();
  (0, _commandRegistrationBKWr0JMS._)();
  (0, _memoryEmbeddingProvidersCB8LiTKl.t)();
  (0, _memoryStateCaQrdVVm.n)();
}
...
const defaultLogger = () => (0, _subsystemCH8Q21Y.t)("plugins");
...
function createGuardedPluginRegistrationApi(api) {
  let closed = false;
  return {
    api: (0, _apiFacadesB5cP4eTt.t)(new Proxy(api, { get(target, prop, receiver) {
...
function createPluginModuleLoader(options) {
  const moduleLoaders = (0, _pluginModuleLoaderCacheCXUDv7JF.t)();
  const createLoaderForModule = (modulePath) => {
    return (0, _pluginModuleLoaderCacheCXUDv7JF.n)({
      cache: moduleLoaders,
      modulePath,
      importerUrl: "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/loader-CZB9kQVT.js",
      loaderFilename: modulePath,
      aliasMap: (0, _sdkAliasBOEr.t)(modulePath, process.argv[1], "file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/loader-CZB9kQVT.js", options.pluginSdkResolution),
      pluginSdkResolution: options.pluginSdkResolution
    });
  };
  return (modulePath) => createLoaderForModule(modulePath)((0, _pluginModuleLoaderCacheCXUDv7JF.s)(modulePath));
}
...
const testing = exports.f = {
  buildPluginLoaderJitiOptions: _sdkAliasBOEr.n,
  buildPluginLoaderAliasMap: _sdkAliasBOEr.t,
  listPluginSdkAliasCandidates: _sdkAliasBOEr.a,
  listPluginSdkExportedSubpaths: _sdkAliasBOEr.o,
  resolveExtensionApiAlias: _sdkAliasBOEr.c,
  resolvePluginSdkScopedAliasMap: _sdkAliasBOEr.h,
  resolvePluginSdkAliasCandidateOrder: _sdkAliasBOEr.p,
  resolvePluginSdkAliasFile: _sdkAliasBOEr.m,
  resolvePluginRuntimeModulePath: _sdkAliasBOEr.f,
  ensureOpenClawPluginSdkAlias,
  shouldLoadChannelPluginInSetupRuntime: _loaderChannelSetupPWf4aSrk.o,
  shouldPreferNativeModuleLoad: _sdkAliasBOEr.g,
  toSafeImportPath: _pluginModuleLoaderCacheCXUDv7JF.s,
...
function readPackageVersionForCache(packageJsonPath) {
  const parsed = (0, _jsonFiles1SmAauRO.u)(packageJsonPath);
...
function buildCacheKey(params) {
  const discoveryContext = (0, _pluginRegistryBZohWtpt.w)({
    workspaceDir: params.workspaceDir,
  ...
  const scopeKey = (0, _pluginScopeCEsy4RJw.a)(params.onlyPluginIds);
  ...
  return `${roots.workspace ?? ""}::${roots.global ?? ""}::${roots.stock ?? ""}::${JSON.stringify({
    bundledPackage,
    discoveryFingerprint: (0, _pluginRegistryBZohWtpt.S)(discoveryContext),
    ...params.plugins,
    installs,
    loadPaths,
...
function resolvePluginRegistrationPlan(params) {
  ...
  if (params.shouldLoadModules && !params.validateOnly && (0, _loaderChannelSetupPWf4aSrk.o)({
...
function resolvePluginLoadCacheContext(options = {}) {
  ...
  const cfg = (0, _configStateCOhlckC.t)(options.config ?? {}, env);
  const activationSourceConfig = resolvePluginActivationSourceConfig({
    config: options.config,
    activationSourceConfig: options.activationSourceConfig
  });
  const normalized = (0, _configStateCOhlckC.s)(cfg.plugins);
  const activationSource = (0, _configStateCOhlckC.n)({ config: activationSourceConfig });
  const trustNormalized = mergeTrustPluginConfigFromActivationSource({
    normalized,
    activationSource
  });
  const onlyPluginIds = (0, _pluginScopeCEsy4RJw.i)(options.onlyPluginIds);
  ...
  const installRecords = {
    ...(0, _installedPluginIndexRecordReaderDR3h__QQ.n)({ env }),
...
function getCompatibleActivePluginRegistry(options = {}) {
  const activeRegistry = (0, _runtimeOTX8N6Lz.a)() ?? void 0;
  if (!activeRegistry) return;
  if (!hasExplicitCompatibilityInputs(options)) return activeRegistry;
  const activeCacheKey = (0, _runtimeOTX8N6Lz.o)();
  ...
  if (loadContext.runtimeSubagentMode === "default" && (0, _runtimeOTX8N6Lz.l)() === "gateway-bindable") {
...
function resolvePluginModuleExport(moduleExport) {
  const seen = /* @__PURE__ */new Set();
  const candidates = [(0, _moduleExport1nkAarDA.t)(moduleExport), moduleExport];
...
function activatePluginRegistry(registry, cacheKey, runtimeSubagentMode, workspaceDir) {
  const preserveGatewayHookRunner = runtimeSubagentMode === "default" && (0, _runtimeOTX8N6Lz.l)() === "gateway-bindable" && (0, _hookRunnerGlobalD1vhzHUy.t)() !== null;
  (0, _runtimeOTX8N6Lz.x)(registry, cacheKey, runtimeSubagentMode, workspaceDir);
  if (!preserveGatewayHookRunner) (0, _hookRunnerGlobalD1vhzHUy.i)(registry);
}
function loadOpenClawPlugins(options = {}) {
  const requestedOnlyPluginIdSet = (0, _pluginScopeCEsy4RJw.t)((0, _pluginScopeCEsy4RJw.i)(options.onlyPluginIds));
  if (requestedOnlyPluginIdSet && requestedOnlyPluginIdSet.size === 0) {
    const emptyRegistry = (0, _runtimeOTX8N6Lz.F)();
  ...
  const onlyPluginIdSet = (0, _pluginScopeCEsy4RJw.t)(onlyPluginIds);
  ...
  if (cacheEnabled) {
    ...
    if (cached) {
      if (shouldActivate) {
        (0, _registryQ5NCB5C.c)(cached.state.agentHarnesses);
        (0, _commandRegistrationBKWr0JMS.M)(cached.state.commands ?? []);
        restoreRegisteredCompactionProviders(cached.state.compactionProviders);
        (0, _detachedTaskRuntimeStateBfGUlR6z.a)(cached.state.detachedTaskRuntimeRegistration);
        (0, _commandRegistrationBKWr0JMS.S)(cached.state.interactiveHandlers ?? []);
        (0, _memoryEmbeddingProvidersCB8LiTKl.s)(cached.state.memoryEmbeddingProviders);
        (0, _memoryStateCaQrdVVm.S)({
  ...
  try {
    ...
    const resolveCreatePluginRuntime = () => {
      ...
      const runtimeModulePath = (0, _sdkAliasBOEr.f)({ pluginSdkResolution: options.pluginSdkResolution });
      if (!runtimeModulePath) throw new Error("Unable to resolve plugin runtime module");
      const runtimeModule = (0, _pluginLoadProfileC9eMiU.i)({ source: runtimeModulePath }, "runtime-module", () => loadPluginModule(runtimeModulePath));
    ...
    const discovery = suppliedManifestRegistry ? {
      ...
      diagnostics: []
    } : options.discovery ?? (0, _discoveryBNk7kgJV.t)({
      workspaceDir: options.workspaceDir,
      extraPaths: normalized.loadPaths,
      env,
      installRecords
    });
    const manifestRegistry = suppliedManifestRegistry ?? (0, _manifestRegistryDbnX5kdP.t)({
      config: cfg,
      workspaceDir: options.workspaceDir,
      env,
    ...
    for (const candidate of orderedCandidates) {
      ...
      const activationState = (0, _configStateCOhlckC.l)({
        ...
        config: normalized,
        rootConfig: cfg,
        enabledByDefault: (0, _installedPluginIndexStoreDEo2ZAhx.g)(manifestRecord),
        activationSource,
      ...
      if (existingOrigin) {
        const record = createPluginRecord({
          ...
          enabled: false,
          compat: (0, _installedPluginIndexStoreDEo2ZAhx.p)(manifestRecord),
          activationState,
      ...
      const enableState = (0, _configStateCOhlckC.c)({
        id: pluginId,
        origin: candidate.origin,
        config: normalized,
        rootConfig: cfg,
      ...
      if (record.format === "bundle") {
        ...
        if (enableState.enabled && record.rootDir && record.bundleFormat && (record.bundleCapabilities ?? []).includes("mcpServers")) {
          const runtimeSupport = (0, _bundleMcpI_5nC9w.n)({
            pluginId: record.id,
            rootDir: record.rootDir,
      ...
      if (registrationPlan.runRuntimeCapabilityPolicy && candidate.origin === "bundled" && (0, _slotsMFUVcT3n.r)(manifestRecord.kind, "memory")) {
        if (pluginId !== dreamingEngineId) {
          const earlyMemoryDecision = (0, _configStateCOhlckC.d)({
            id: record.id,
      ...
      if (registrationPlan.loadSetupEntry && manifestRecord.setupSource) {
        const setupRegistration = (0, _loaderChannelSetupPWf4aSrk.a)(mod);
        ...
        if (setupRegistration.plugin) {
          if (!(0, _loaderChannelSetupPWf4aSrk.t)({
          ...
          if (registrationPlan.loadSetupRuntimeEntry && setupRegistration.usesBundledSetupContract && resolveCanonicalDistRuntimeSource(runtimeCandidateEntry.source) !== safeSource) {
            ...
            let runtimeMod = null;
            try {
              runtimeMod = (0, _pluginLoadProfileC9eMiU.i)({
                pluginId: record.id,
            ...
            const runtimeRegistration = (0, _loaderChannelSetupPWf4aSrk.i)(runtimeMod);
            ...
            const runtimePluginRegistration = (0, _loaderChannelSetupPWf4aSrk.n)({ registration: runtimeRegistration });
            ...
            if (runtimePluginRegistration.plugin) {
              ...
              mergedSetupRegistration = {
                ...setupRegistration,
                plugin: (0, _loaderChannelSetupPWf4aSrk.r)(runtimePluginRegistration.plugin, setupRegistration.plugin),
      ...
      const previousAgentHarnesses = (0, _registryQ5NCB5C.a)();
      const previousCompactionProviders = listRegisteredCompactionProviders();
      const previousDetachedTaskRuntimeRegistration = (0, _detachedTaskRuntimeStateBfGUlR6z.n)();
      const previousMemoryCapability = (0, _memoryStateCaQrdVVm.r)();
      const previousMemoryEmbeddingProviders = (0, _memoryEmbeddingProvidersCB8LiTKl.a)();
      const previousMemoryCorpusSupplements = (0, _memoryStateCaQrdVVm.l)();
      const previousMemoryPromptSupplements = (0, _memoryStateCaQrdVVm.u)();
      const beforeRegister = performance.now();
      let registerFailed = false;
      try {
        (0, _pluginLoadProfileC9eMiU.i)({
          pluginId: record.id,
          source: record.source
        }, `${registrationMode}:register`, () => runPluginRegisterSync(register, api));
        if (!shouldActivate) {
          (0, _registryQ5NCB5C.c)(previousAgentHarnesses);
          restoreRegisteredCompactionProviders(previousCompactionProviders);
          (0, _detachedTaskRuntimeStateBfGUlR6z.a)(previousDetachedTaskRuntimeRegistration);
          (0, _memoryEmbeddingProvidersCB8LiTKl.s)(previousMemoryEmbeddingProviders);
          (0, _memoryStateCaQrdVVm.S)({
    ...
    if (cacheEnabled) setCachedPluginRegistry(cacheKey, {
      commands: (0, _commandRegistrationBKWr0JMS.A)(),
      detachedTaskRuntimeRegistration: (0, _detachedTaskRuntimeStateBfGUlR6z.n)(),
      interactiveHandlers: (0, _commandRegistrationBKWr0JMS.y)(),
      memoryCapability: (0, _memoryStateCaQrdVVm.r)(),
      memoryCorpusSupplements: (0, _memoryStateCaQrdVVm.l)(),
      registry,
      agentHarnesses: (0, _registryQ5NCB5C.a)(),
      compactionProviders: listRegisteredCompactionProviders(),
      memoryEmbeddingProviders: (0, _memoryEmbeddingProvidersCB8LiTKl.a)(),
      memoryPromptSupplements: (0, _memoryStateCaQrdVVm.u)()
    }, onlyPluginIds);
...
async function loadOpenClawPluginCliRegistry(options = {}) {
  ...
  const discovery = options.discovery ?? (0, _discoveryBNk7kgJV.t)({
    workspaceDir: options.workspaceDir,
    extraPaths: normalized.loadPaths,
    env,
    installRecords
  });
  const manifestRegistry = (0, _manifestRegistryDbnX5kdP.t)({
    config: cfg,
    workspaceDir: options.workspaceDir,
    env,
    candidates: discovery.candidates,
  ...
  for (const candidate of orderedCandidates) {
    ...
    const opened = (0, _rootFileCqMcFM3J.i)({
      ...
      rootPath: pluginRoot,
      boundaryLabel: "plugin root",
      rejectHardlinks: (0, _discoveryBNk7kgJV.f)({
        origin: candidate.origin,
        rootDir: candidate.rootDir,
        env
      }),
    ...
    const api = (0, _apiBuilderCnCCk5go.t)({
      id: record.id,
      name: record.name,
      version: record.version,
      description: record.description,
