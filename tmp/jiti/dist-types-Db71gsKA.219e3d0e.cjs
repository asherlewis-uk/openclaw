"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = void 0;exports.C = commitPluginInteractiveCallbackDedupe;exports.D = isTrustedReservedCommandOwner;exports.E = clearPluginCommandsForPlugin;exports.M = setPluginCommandRegistryLocked;exports.O = listRegisteredPluginAgentPromptGuidance;exports.S = claimPluginInteractiveCallbackDedupe;exports.T = clearPluginCommands;exports._ = clearPluginInteractiveHandlersForPlugin;exports.a = void 0;exports.b = resolvePluginInteractiveNamespaceMatch;exports.c = void 0;exports.d = listPluginInvocationKeys;exports.f = pluginCommandSupportsChannel;exports.g = clearPluginInteractiveHandlers;exports.h = validatePluginCommandDefinition;exports.i = void 0;exports.j = restorePluginCommands;exports.k = listRegisteredPluginCommands;exports.l = void 0;exports.m = validateCommandName;exports.o = exports.n = void 0;exports.p = registerPluginCommand;exports.t = exports.s = exports.r = void 0;exports.u = isReservedCommandName;exports.v = listPluginInteractiveHandlers;exports.w = releasePluginInteractiveCallbackDedupe;exports.x = restorePluginInteractiveHandlers;exports.y = registerPluginInteractiveHandler;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _dedupeCby1DfpJ = require("./dedupe-Cby1DfpJ.js");
...
const pluginCommands = exports.A = new Proxy(/* @__PURE__ */new Map(), { get(_target, property) {
...
function createInteractiveCallbackDedupe() {
  return (0, _dedupeCby1DfpJ.n)(PLUGIN_INTERACTIVE_CALLBACK_DEDUPE_KEY, {
    ttlMs: 5 * 6e4,
    maxSize: 4096
  });
}
...
function validatePluginCommandDefinition(command, opts) {
  ...
  if (command.requiredScopes !== void 0) {
    ...
    const unknownScope = command.requiredScopes.find((scope) => !(0, _operatorScopesCpnZaPqz.s)(scope));
...
function registerPluginCommand(pluginId, command, opts) {
  ...
  (0, _globalsCouSpJO.r)(`Registered plugin command: ${key} (plugin: ${pluginId})`);
  return { ok: true };
}
//#endregion
//#region src/plugins/hook-before-agent-start.types.ts
const PLUGIN_PROMPT_MUTATION_RESULT_FIELDS = exports.c = [
"systemPrompt",
"prependContext",
"appendContext",
...
exports.l = stripPromptMutationFieldsFromLegacyHookResult;const PLUGIN_HOOK_NAMES = exports.n = [
...
const isPluginHookName = (hookName) => typeof hookName === "string" && pluginHookNameSet.has(hookName);exports.o = isPluginHookName;
const PROMPT_INJECTION_HOOK_NAMES = exports.r = [
"agent_turn_prepare",
"before_prompt_build",
"before_agent_start",
"heartbeat_prompt_contribution"];
...
const isPromptInjectionHookName = (hookName) => promptInjectionHookNameSet.has(hookName);exports.s = isPromptInjectionHookName;
const CONVERSATION_HOOK_NAMES = exports.t = [
"before_model_resolve",
"before_agent_reply",
"llm_input",
"llm_output",
...
const isConversationHookName = (hookName) => conversationHookNameSet.has(hookName);exports.a = isConversationHookName;
const PluginApprovalResolutions = exports.i = {
