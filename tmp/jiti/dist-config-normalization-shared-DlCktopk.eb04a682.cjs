"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = createEffectiveEnableStateResolver;exports.c = resolvePluginActivationDecisionShared;exports.i = normalizePluginsConfigWithResolver;exports.l = toPluginActivationState;exports.n = void 0;exports.o = createPluginEnableStateResolver;exports.r = isBundledChannelEnabledByChannelConfig;exports.s = resolveMemorySlotDecisionShared;exports.t = hasExplicitPluginConfig;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
const identityNormalizePluginId = (id) => id.trim();exports.n = identityNormalizePluginId;
...
function normalizeSlotValue(value) {
  ...
  if (!trimmed) return;
  if ((0, _stringCoerceLndEvhRk.s)(trimmed) === "none") return null;
  return trimmed;
}
...
function normalizePluginEntries(entries, normalizePluginId) {
  ...
  for (const [key, value] of Object.entries(entries)) {
    ...
    const subagent = subagentRaw && typeof subagentRaw === "object" && !Array.isArray(subagentRaw) ? {
      ...
      allowedModels: Array.isArray(subagentRaw.allowedModels) ? subagentRaw.allowedModels.map((model) => (0, _stringCoerceLndEvhRk.c)(model)).filter((model) => Boolean(model)) : void 0
    } : void 0;
    ...
    const llm = llmRaw && typeof llmRaw === "object" && !Array.isArray(llmRaw) ? {
      ...
      allowedModels: Array.isArray(llmRaw.allowedModels) ? llmRaw.allowedModels.map((model) => (0, _stringCoerceLndEvhRk.c)(model)).filter((model) => Boolean(model)) : void 0,
...
function normalizePluginsConfigWithResolver(config, normalizePluginId = identityNormalizePluginId) {
  ...
  return {
    ...
    slots: {
      memory: memorySlot === void 0 ? (0, _slotsDLJ2h3Qv.n)("memory") : memorySlot,
...
function isBundledChannelEnabledByChannelConfig(cfg, pluginId) {
  if (!cfg) return false;
  const channelId = (0, _idsDFu3Ho6n.r)(pluginId);
  if (!channelId) return false;
  const entry = cfg.channels?.[channelId];
  if (!entry || typeof entry !== "object" || Array.isArray(entry)) return false;
  return entry.enabled === true;
}
//#endregion /* v9-dbc8645c1adc066f */
