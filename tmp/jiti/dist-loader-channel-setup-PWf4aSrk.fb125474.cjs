...
function shouldLoadChannelPluginInSetupRuntime(params) {
  ...
  return !params.manifestChannels.some((channelId) => (0, _channelConfiguredCoO3CraP.t)(params.cfg, channelId, params.env));
}
