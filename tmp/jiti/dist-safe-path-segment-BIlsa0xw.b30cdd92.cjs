"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = assertSafePathSegment;exports.t = assertSafePathPrefix;var _pathB5B_oAT = require("./path-B5B-_oAT.js");
...
function assertSafePathSegment(segment, options = {}) {
  if (!isSafePathSegment(segment, options)) throw new _pathB5B_oAT.p("invalid-path", `${options.label ?? "path segment"} must be a safe path segment`);
  return segment;
}
