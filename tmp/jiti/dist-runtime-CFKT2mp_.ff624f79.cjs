...
var _agentEventsCXxjiM_O = require("./agent-events-CXxjiM_O.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
const log$1 = (0, _subsystemDLRoKDlF.t)("plugins/host-hooks");
...
const log = (0, _subsystemDLRoKDlF.t)("plugins/runtime");
function asPluginRegistry(registry) {
  return registry;
}
const state = (() => {
  const globalState = globalThis;
  let registryState = globalState[_runtimeStateBr1Hd8D.t];
  if (!registryState) {
    registryState = {
      activeRegistry: null,
      activeVersion: 0,
    ...
    globalState[_runtimeStateBr1Hd8D.t] = registryState;
  }
...
async function cleanupPreviousPluginHostRegistry(params) {
  const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([Promise.resolve().then(() => jitiImport("./config/config.js").then((m) => _interopRequireWildcard(m))), Promise.resolve().then(() => jitiImport("./host-hook-cleanup-rb196LOE.js").then((m) => _interopRequireWildcard(m)))]);
...
function syncPluginAgentEventBridge() {
  ...
  state.agentEventBridgeUnsubscribe = (0, _agentEventsCXxjiM_O.l)((event) => {
...
function getActivePluginChannelRegistry() {
  return (0, _runtimeChannelStateDJHEiBs.n)().registry;
}
function getActivePluginChannelRegistryVersion() {
  return (0, _runtimeChannelStateDJHEiBs.n)().version;
}
