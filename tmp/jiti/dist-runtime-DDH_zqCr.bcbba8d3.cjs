"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = void 0;exports.r = writeRuntimeJson;exports.t = createNonExitingRuntime;var _progressLineBRiU5MFa = require("./progress-line-BRiU5MFa.js");
var _restoreBf3iQQZN = require("./restore-Bf3iQQZN.js");
...
const defaultRuntime = exports.n = {
  ...createRuntimeIo(),
  exit: (code) => {
    (0, _restoreBf3iQQZN.t)("runtime exit", { resumeStdinIfPaused: false });
    process.exit(code);
