...
function resolveProviderEnvApiKeyCandidates(params) {
  return (0, _providerEnvVarsBdegz5z.a)(params);
}
function resolveProviderEnvAuthEvidence(params) {
  return (0, _providerEnvVarsBdegz5z.o)(params);
}
...
function listKnownProviderEnvApiKeyNames() {
  return (0, _providerEnvVarsBdegz5z.n)();
}
//#endregion
...
function listKnownNonSecretApiKeyMarkers() {
  knownNonSecretApiKeyMarkersCache ??= [...new Set([...CORE_NON_SECRET_API_KEY_MARKERS, ...(0, _manifestMetadataScanDmQpfwPO.t)().flatMap((plugin) => plugin.origin === "bundled" ? normalizeStringList(plugin.manifest.nonSecretAuthMarkers) : [])])];
