"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = void 0;exports.E = resolveSafeBinProfiles;exports.S = resolveExecWrapperTrustPlan;exports.T = normalizeSafeBinProfileFixtures;exports._ = resolvePolicyTargetCandidatePath;exports.a = validateSafeBinArgv;exports.b = resolveExecutableFromPathEnv;exports.c = matchAllowlist;exports.d = resolveApprovalAuditCandidatePath;exports.f = resolveCommandResolution;exports.g = resolvePolicyAllowlistCandidatePath;exports.h = resolveExecutionTargetResolution;exports.i = normalizeTrustedSafeBinDirs;exports.l = parseExecArgvToken;exports.m = resolveExecutionTargetCandidatePath;exports.n = isTrustedSafeBinPath;exports.o = listRiskyConfiguredSafeBins;exports.p = resolveCommandResolutionFromArgv;exports.r = listWritableExplicitTrustedSafeBinDirs;exports.s = normalizeSafeBinName;exports.t = getTrustedSafeBinDirs;exports.u = resolveAllowlistCandidatePath;exports.v = resolvePolicyTargetResolution;exports.w = void 0;exports.x = resolveExecutablePath;exports.y = resolveExecutable;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _homeDirIZwpu = require("./home-dir-iZwpu-40.js");
var _shellWrapperResolutionCN1bWvVT = require("./shell-wrapper-resolution-CN1bWvVT.js");
var _nodeFs = _interopRequireDefault(require("node:fs"));
var _nodePath = _interopRequireDefault(require("node:path"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
//#region src/infra/exec-safe-bin-policy-profiles.ts
const NO_FLAGS$1 = /* @__PURE__ */new Set();
const DEFAULT_SAFE_BINS = exports.C = [
"cut",
"uniq",
"head",
"tail",
...
const SAFE_BIN_PROFILES = exports.w = compileSafeBinProfiles({
  jq: {
    maxPositional: 1,
    allowedValueFlags: [
    "--arg",
...
function finalizeExecWrapperTrustPlan(argv, policyArgv, wrapperChain, policyBlocked, blockedWrapper) {
  ...
  const shellWrapperExecutable = !policyBlocked && rawExecutable.length > 0 && (0, _shellWrapperResolutionCN1bWvVT.c)(rawExecutable);
  const plan = {
    argv,
    policyArgv,
    wrapperChain,
    ...
    shellInlineCommand: shellWrapperExecutable ? (0, _shellWrapperResolutionCN1bWvVT.r)(argv) : null
  };
...
function resolveExecWrapperTrustPlan(argv, maxDepth = 4) {
  ...
  for (let depth = 0; depth < maxDepth; depth += 1) {
    const dispatchPlan = (0, _shellWrapperResolutionCN1bWvVT._)(current, maxDepth - wrapperChain.length);
    ...
    const shellMultiplexerUnwrap = (0, _shellWrapperResolutionCN1bWvVT.d)(current);
  ...
  if (wrapperChain.length >= maxDepth) {
    const dispatchOverflow = (0, _shellWrapperResolutionCN1bWvVT.y)(current);
    ...
    const shellMultiplexerOverflow = (0, _shellWrapperResolutionCN1bWvVT.d)(current);
