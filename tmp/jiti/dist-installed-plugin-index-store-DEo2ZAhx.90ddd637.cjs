"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = resolveInstalledPluginIndexPolicyHash;exports.a = refreshPersistedInstalledPluginIndexSync;exports.b = hashJson;exports.c = getCurrentPluginMetadataSnapshotState;exports.d = isInstalledPluginEnabled;exports.f = loadInstalledPluginIndex;exports.g = isPluginEnabledByDefaultForPlatform;exports.h = extractPluginInstallRecordsFromInstalledPluginIndex;exports.i = refreshPersistedInstalledPluginIndex;exports.l = setCurrentPluginMetadataSnapshotState;exports.m = hasOptionalMissingPluginManifestFile;exports.n = readPersistedInstalledPluginIndex;exports.o = writePersistedInstalledPluginIndex;exports.p = collectPluginManifestCompatCodes;exports.r = readPersistedInstalledPluginIndexSync;exports.s = clearCurrentPluginMetadataSnapshotState;exports.t = inspectPersistedInstalledPluginIndex;exports.u = getInstalledPluginRecord;exports.v = getPluginCompatRecord;exports.y = fileSignatureMatches;var _pathB5B_oAT = require("./path-B5B-_oAT.js");
...
var _installSourceInfoJy5DlEzD = require("./install-source-info-Jy5DlEzD.js");
...
var _zodParse8Lg54d2A = require("./zod-parse-8Lg54d2A.js");
...
function safeHashFile(params) {
  try {
    return _nodeCrypto.default.createHash("sha256").update(_nodeFs.default.readFileSync(params.filePath)).digest("hex");
  } catch (err) {
...
function resolveInstalledPluginIndexPolicyHash(config) {
  const normalized = (0, _configStateCOhlckC.s)(config?.plugins);
  const channelPolicy = {};
...
function hasOptionalMissingPluginManifestFile(record) {
  return record.format === "bundle" && record.bundleFormat === "claude" && !_nodeFs.default.existsSync(record.manifestPath);
}
//#endregion
...
function buildStartupInfo(record) {
  return {
    ...
    memory: (0, _slotsMFUVcT3n.r)(record.kind, "memory"),
...
function resolvePackageJsonPath(candidate) {
  ...
  const packageDir = (0, _pathB5B_oAT.d)(candidate.packageDir) ?? _nodePath.default.resolve(candidate.packageDir);
  const packageJsonPath = _nodePath.default.join(packageDir, "package.json");
  const rootDir = (0, _pathB5B_oAT.d)(candidate.rootDir) ?? _nodePath.default.resolve(candidate.rootDir);
  return _nodeFs.default.existsSync(packageJsonPath) && (0, _pathB5B_oAT.a)(rootDir, packageJsonPath) ? packageJsonPath : void 0;
}
function resolvePackageJsonRelativePath(rootDir, packageJsonPath) {
  const resolvedRootDir = (0, _pathB5B_oAT.d)(rootDir) ?? _nodePath.default.resolve(rootDir);
  return (_nodePath.default.relative(resolvedRootDir, packageJsonPath) || "package.json").split(_nodePath.default.sep).join("/");
}
...
function describePackageInstallSource(candidate) {
  ...
  if (!install) return;
  return (0, _installSourceInfoJy5DlEzD.t)(install, { expectedPackageName: candidate?.packageName });
}
...
function buildInstalledPluginIndexRecords(params) {
  ...
  return params.registry.plugins.map((record) => {
    ...
    const enabled = (0, _configStateCOhlckC.c)({
      id: record.id,
...
function resolveInstalledPluginIndexRegistry(params) {
  if (params.candidates) return {
    ...
    registry: (0, _manifestRegistryDbnX5kdP.t)({
  ...
  const normalized = (0, _configStateCOhlckC.s)(params.config?.plugins);
  const installRecords = params.installRecords ?? (0, _installedPluginIndexRecordReaderDR3h__QQ.n)({ env: params.env });
  const discovery = params.discovery ?? (0, _discoveryBNk7kgJV.t)({
    workspaceDir: params.workspaceDir,
...
function buildInstalledPluginIndex(params) {
  ...
  const installRecords = normalizeInstallRecordMap(params.installRecords ?? (0, _installedPluginIndexRecordReaderDR3h__QQ.n)({
    env,
  ...
  return {
    ...
    hostContractVersion: (0, _versionDmRkhYua.o)(env),
...
function isInstalledPluginEnabled(index, pluginId, config) {
  ...
  const normalizedConfig = (0, _configStateCOhlckC.s)(config?.plugins);
  const state = (0, _configStateCOhlckC.l)({
    id: record.pluginId,
    origin: record.origin,
    config: normalizedConfig,
    rootConfig: config,
...
const StringArraySchema = (0, _schemasBmna8ihM.Et)((0, _schemasBmna8ihM.Rn)());
const InstalledPluginIndexStartupSchema = (0, _schemasBmna8ihM.Tn)({
  sidecar: (0, _schemasBmna8ihM.At)(),
  memory: (0, _schemasBmna8ihM.At)(),
  deferConfiguredChannelFullLoadUntilAfterListen: (0, _schemasBmna8ihM.At)(),
  agentHarnesses: StringArraySchema
});
const InstalledPluginFileSignatureSchema = (0, _schemasBmna8ihM.Tn)({
  size: (0, _schemasBmna8ihM.wn)(),
  mtimeMs: (0, _schemasBmna8ihM.wn)(),
  ctimeMs: (0, _schemasBmna8ihM.wn)().optional()
});
const InstalledPluginIndexRecordSchema = (0, _schemasBmna8ihM.Tn)({
  pluginId: (0, _schemasBmna8ihM.Rn)(),
  packageName: (0, _schemasBmna8ihM.Rn)().optional(),
  packageVersion: (0, _schemasBmna8ihM.Rn)().optional(),
  installRecord: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), (0, _schemasBmna8ihM.Zn)()).optional(),
  installRecordHash: (0, _schemasBmna8ihM.Rn)().optional(),
  packageInstall: (0, _schemasBmna8ihM.Zn)().optional(),
  packageChannel: (0, _schemasBmna8ihM.Zn)().optional(),
  manifestPath: (0, _schemasBmna8ihM.Rn)(),
  manifestHash: (0, _schemasBmna8ihM.Rn)(),
  manifestFile: InstalledPluginFileSignatureSchema.optional(),
  format: (0, _schemasBmna8ihM.Rn)().optional(),
  bundleFormat: (0, _schemasBmna8ihM.Rn)().optional(),
  source: (0, _schemasBmna8ihM.Rn)().optional(),
  setupSource: (0, _schemasBmna8ihM.Rn)().optional(),
  packageJson: (0, _schemasBmna8ihM.Tn)({
    path: (0, _schemasBmna8ihM.Rn)(),
    hash: (0, _schemasBmna8ihM.Rn)(),
    fileSignature: InstalledPluginFileSignatureSchema.optional()
  }).optional(),
  rootDir: (0, _schemasBmna8ihM.Rn)(),
  origin: (0, _schemasBmna8ihM.Rn)(),
  enabled: (0, _schemasBmna8ihM.At)(),
  enabledByDefault: (0, _schemasBmna8ihM.At)().optional(),
  ...
  compat: (0, _schemasBmna8ihM.Et)((0, _schemasBmna8ihM.Rn)())
});
const InstalledPluginInstallRecordSchema = (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), (0, _schemasBmna8ihM.Zn)());
const PluginDiagnosticSchema = (0, _schemasBmna8ihM.Tn)({
  level: (0, _schemasBmna8ihM.Xn)([(0, _schemasBmna8ihM.dn)("warn"), (0, _schemasBmna8ihM.dn)("error")]),
  message: (0, _schemasBmna8ihM.Rn)(),
  pluginId: (0, _schemasBmna8ihM.Rn)().optional(),
  source: (0, _schemasBmna8ihM.Rn)().optional()
});
const InstalledPluginIndexSchema = (0, _schemasBmna8ihM.Tn)({
  version: (0, _schemasBmna8ihM.dn)(1),
  warning: (0, _schemasBmna8ihM.Rn)().optional(),
  hostContractVersion: (0, _schemasBmna8ihM.Rn)(),
  compatRegistryVersion: (0, _schemasBmna8ihM.Rn)(),
  migrationVersion: (0, _schemasBmna8ihM.dn)(1),
  policyHash: (0, _schemasBmna8ihM.Rn)(),
  generatedAtMs: (0, _schemasBmna8ihM.wn)(),
  refreshReason: (0, _schemasBmna8ihM.Rn)().optional(),
  installRecords: (0, _schemasBmna8ihM.Nn)((0, _schemasBmna8ihM.Rn)(), InstalledPluginInstallRecordSchema).optional(),
  plugins: (0, _schemasBmna8ihM.Et)(InstalledPluginIndexRecordSchema),
  diagnostics: (0, _schemasBmna8ihM.Et)(PluginDiagnosticSchema)
});
function copySafeInstallRecords(records) {
  if (!records) return;
  const safeRecords = {};
  for (const [pluginId, record] of Object.entries(records)) {
    if ((0, _prototypeKeysCxs5UffD.t)(pluginId)) continue;
    safeRecords[pluginId] = record;
  }
  return safeRecords;
}
function parseInstalledPluginIndex(value) {
  const parsed = (0, _zodParse8Lg54d2A.n)(InstalledPluginIndexSchema, value);
...
async function readPersistedInstalledPluginIndex(options = {}) {
  return parseInstalledPluginIndex(await (0, _jsonFiles1SmAauRO.l)((0, _installedPluginIndexRecordReaderDR3h__QQ.a)(options)));
}
function readPersistedInstalledPluginIndexSync(options = {}) {
  return parseInstalledPluginIndex((0, _jsonFiles1SmAauRO.u)((0, _installedPluginIndexRecordReaderDR3h__QQ.a)(options)));
}
async function writePersistedInstalledPluginIndex(index, options = {}) {
  const filePath = (0, _installedPluginIndexRecordReaderDR3h__QQ.a)(options);
  await (0, _jsonFiles1SmAauRO.d)(filePath, {
    ...index,
    warning: INSTALLED_PLUGIN_INDEX_WARNING
  }, {
...
function canRefreshPersistedPolicyState(persisted, params) {
  ...
  const env = params.env ?? process.env;
  if (persisted.version !== 1 || persisted.hostContractVersion !== (0, _versionDmRkhYua.o)(env) || persisted.compatRegistryVersion !== resolveCompatRegistryVersion() || persisted.migrationVersion !== 1) return false;
...
function refreshPersistedPolicyState(persisted, params) {
  ...
  return {
    ...
    plugins: persisted.plugins.map((plugin) => ({
      ...plugin,
      enabled: (0, _configStateCOhlckC.c)({
        id: plugin.pluginId,
