"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = buildPluginApi;var _apiFacadesB5cP4eTt = require("./api-facades-B5cP4eTt.js");
...
function buildPluginApi(params) {
  ...
  return (0, _apiFacadesB5cP4eTt.t)({
    id: params.id,
    name: params.name,
