...
var _windowsCommandDJ7ha6z = require("./windows-command-DJ7ha6z1.js");
var _loggerLY96ESJ = require("./logger-lY96ESJ4.js");
...
function resolveTrustedWindowsCmdExe() {
  ...
  return _nodePath.default.win32.join((0, _windowsInstallRootsD8UF6BY.t)().systemRoot, "System32", "cmd.exe");
}
...
function resolveCommand(command) {
  return (0, _windowsCommandDJ7ha6z.t)({
    command,
    cmdCommands: [
    "corepack",
    "pnpm",
...
async function runExec(command, args, opts = 1e4) {
  ...
  try {
    ...
    const windowsEncoding = (0, _windowsCommandDJ7ha6z.o)();
    const decodedStdout = (0, _windowsCommandDJ7ha6z.a)({
      buffer: stdout,
      windowsEncoding
    });
    const decodedStderr = (0, _windowsCommandDJ7ha6z.a)({
      buffer: stderr,
      windowsEncoding
    });
    if ((0, _globalsBJh4IgxP.a)()) {
      if (decodedStdout.trim()) (0, _loggerLY96ESJ.t)(decodedStdout.trim());
      if (decodedStderr.trim()) (0, _loggerLY96ESJ.n)(decodedStderr.trim());
    }
    return {
    ...
    if (err && typeof err === "object") {
      ...
      if (Buffer.isBuffer(errorWithOutput.stdout)) errorWithOutput.stdout = (0, _windowsCommandDJ7ha6z.a)({
        buffer: errorWithOutput.stdout,
        windowsEncoding
      });
      if (Buffer.isBuffer(errorWithOutput.stderr)) errorWithOutput.stderr = (0, _windowsCommandDJ7ha6z.a)({
        buffer: errorWithOutput.stderr,
        windowsEncoding
      });
    }
    if ((0, _globalsBJh4IgxP.a)()) (0, _loggerLY96ESJ.n)((0, _globalsBJh4IgxP.t)(`Command failed: ${command} ${args.join(" ")}`));
    throw err;
  }
}
...
async function runCommandWithTimeout(argv, optionsOrTimeout) {
  ...
  const stdio = (0, _windowsCommandDJ7ha6z.n)({
    hasInput,
    preferInherit: true
  });
  ...
  return await new Promise((resolve, reject) => {
    ...
    const killChild = (byTimeout = true) => {
      ...
      if (byTimeout) killIssuedByTimeout = true;else
    ...
    const resolveFromClose = (code, signal) => {
      ...
      resolve({
        ...
        stdout: (0, _windowsCommandDJ7ha6z.a)({
          buffer: Buffer.concat(stdoutChunks),
          windowsEncoding
        }),
        stderr: (0, _windowsCommandDJ7ha6z.a)({
