"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveSessionTranscriptFile;exports.c = appendSessionTranscriptMessage;exports.i = readTailAssistantTextFromSessionTranscript;exports.n = appendExactAssistantMessageToSessionTranscript;exports.o = streamSessionTranscriptLines;exports.r = readLatestAssistantTextFromSessionTranscript;exports.s = resolveMirroredTranscriptText;exports.t = appendAssistantMessageToSessionTranscript;var _redactR2EdHUS = require("./redact-R2-EdHUS.js");
...
require("./store-3qAZ3Zl6.js");
var _transcriptEventsB00DLjg = require("./transcript-events-B00DLjg-.js");
var _chatMessageContentDf8A1xtk = require("./chat-message-content-Df8A1xtk.js");
var _sessionFileC6TQVMAx = require("./session-file-C6TQVMAx.js");
var _sessionWriteLockBT1vMcpZ = require("./session-write-lock-BT1vMcpZ.js");
...
async function appendSessionTranscriptMessageLocked(params) {
  const lock = await (0, _sessionWriteLockBT1vMcpZ.r)({
    sessionFile: params.transcriptPath,
    timeoutMs: (0, _sessionWriteLockBT1vMcpZ.c)(params.config),
    allowReentrant: true
  });
  try {
    ...
    const entry = {
      ...
      message: (0, _redactR2EdHUS.n)(params.message)
    };
...
function parseAssistantTranscriptText(line) {
  ...
  const text = (0, _chatMessageContentDf8A1xtk.n)(message)?.trim();
  if (!text) return;
  return {
...
async function resolveSessionTranscriptFile(params) {
  const sessionPathOpts = (0, _pathsKGAxo7MN.a)({
    agentId: params.agentId,
    storePath: params.storePath
  });
  let sessionFile = (0, _pathsKGAxo7MN.i)(params.sessionId, params.sessionEntry, sessionPathOpts);
  let sessionEntry = params.sessionEntry;
  if (params.sessionStore && params.storePath) {
    const threadIdFromSessionKey = (0, _storeLoadCmAGD4uk.C)(params.sessionKey).threadId;
    const fallbackSessionFile = !sessionEntry?.sessionFile ? (0, _pathsKGAxo7MN.o)(params.sessionId, params.agentId, params.threadId ?? threadIdFromSessionKey) : void 0;
    const resolvedSessionFile = await (0, _sessionFileC6TQVMAx.t)({
...
async function appendExactAssistantMessageToSessionTranscript(params) {
  ...
  const storePath = params.storePath ?? (0, _pathsKGAxo7MN.r)(params.agentId);
  const store = (0, _storeLoadCmAGD4uk.t)(storePath, { skipCache: true });
  const entry = store[(0, _storeLoadCmAGD4uk.o)(sessionKey)] ?? store[sessionKey];
  ...
  let sessionFile;
  try {
    sessionFile = (await (0, _sessionFileC6TQVMAx.t)({
    ...
    return {
      ok: false,
      reason: (0, _errorsVfATXfah.i)(err)
    };
  }
