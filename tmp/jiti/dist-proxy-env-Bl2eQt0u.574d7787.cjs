"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = matchesNoProxy;exports.c = shouldUseEnvHttpProxyForUrl;exports.i = hasProxyEnvConfigured;exports.n = hasEnvHttpProxyAgentConfigured;exports.o = resolveEnvHttpProxyAgentOptions;exports.r = hasEnvHttpProxyConfigured;exports.s = resolveEnvHttpProxyUrl;exports.t = void 0; //#region src/infra/net/proxy-env.ts
const PROXY_ENV_KEYS = exports.t = [
"HTTP_PROXY",
"HTTPS_PROXY",
"ALL_PROXY",
"http_proxy",
...
function shouldUseEnvHttpProxyForUrl(targetUrl, env = process.env) {
  ...
  try {
    ...
    if (parsed.protocol === "http:") protocol = "http";else
    if (parsed.protocol === "https:") protocol = "https";else
    return false;
  } catch {
    return false;
  }
