"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = normalizeAccountId;exports.r = normalizeOptionalAccountId;exports.t = void 0;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
function normalizeCanonicalAccountId(value) {
  ...
  if (!canonical || (0, _prototypeKeysDna4GplE.t)(canonical)) return;
  return canonical;
}
