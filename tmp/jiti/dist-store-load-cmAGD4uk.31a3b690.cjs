"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = parseSessionThreadInfo;exports.D = getFileStatSnapshot;exports.E = createExpiringMapCache;exports.O = isCacheEnabled;exports.S = shouldRunSessionEntryMaintenance;exports.T = resolveLoadedSessionThreadInfo;exports._ = getActiveSessionMaintenanceWarning;exports.a = registerSessionMaintenancePreserveKeysProvider;exports.b = resolveMaintenanceConfigFromInput;exports.c = clearSessionStoreCaches;exports.d = getSerializedSessionStore;exports.f = isSessionStoreCacheEnabled;exports.g = capEntryCount;exports.h = writeSessionStoreCache;exports.i = collectSessionMaintenancePreserveKeys;exports.k = resolveCacheTtlMs;exports.l = cloneSessionStoreRecord;exports.m = takeMutableSessionStoreCache;exports.n = normalizeSessionStore;exports.o = normalizeStoreSessionKey;exports.p = setSerializedSessionStore;exports.r = resolveMaintenanceConfig;exports.s = resolveSessionStoreEntry;exports.t = loadSessionStore;exports.u = dropSessionStoreObjectCache;exports.v = pruneQuotaSuspensions;exports.w = parseSessionThreadInfoFast;exports.x = shouldPreserveMaintenanceEntry;exports.y = pruneStaleEntries;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
...
var _parseFiniteNumber2P2_lXOQ = require("./parse-finite-number-2P2_lXOQ.js");
require("./config-CzeRK-GW.js");
var _deliveryContextSharedDk707JJ = require("./delivery-context.shared-Dk7-07JJ.js");
var _sessionConversationKSBVRbLR = require("./session-conversation-kSBVRbLR.js");
var _registryLoadedReadB8n0mpjH = require("./registry-loaded-read-B8n0mpjH.js");
...
function resolveCacheTtlMs(params) {
  ...
  if (envValue) {
    const parsed = (0, _parseFiniteNumber2P2_lXOQ.r)(envValue);
...
function resolveLoadedSessionConversationThreadInfo(sessionKey) {
  ...
  const resolved = (0, _registryLoadedReadB8n0mpjH.t)(raw.channel)?.messaging?.resolveSessionConversation?.({
    kind: raw.kind,
    rawId
  });
...
function resolveLoadedSessionThreadInfo(sessionKey) {
  return resolveLoadedSessionConversationThreadInfo(sessionKey) ?? (0, _sessionKeyUtilsQDNZHCY.c)(sessionKey);
}
//#endregion
...
function parseSessionThreadInfo(sessionKey) {
  return (0, _sessionConversationKSBVRbLR.i)(sessionKey);
}
...
const log$1 = (0, _subsystemDLRoKDlF.t)("sessions/store");
...
function resolvePruneAfterMs(maintenance) {
  ...
  try {
    return (0, _parseDuration961Oqdwr.t)(normalized, { defaultUnit: "d" });
  } catch {
...
function resolveMaxDiskBytes(maintenance) {
  ...
  try {
    return (0, _zodSchemaC6VV4etB.r)(normalized, { defaultUnit: "b" });
  } catch {
    return null;
  }
}
function resolveHighWaterBytes(maintenance, maxDiskBytes) {
  ...
  try {
    const parsed = (0, _zodSchemaC6VV4etB.r)(normalized, { defaultUnit: "b" });
...
function isSyntheticSessionMaintenanceKey(sessionKey) {
  const rest = (0, _stringCoerceLndEvhRk.a)((0, _sessionKeyUtilsQDNZHCY.o)(sessionKey)?.rest ?? sessionKey);
  return (0, _sessionKeyUtilsQDNZHCY.a)(sessionKey) || (0, _sessionKeyUtilsQDNZHCY.n)(sessionKey) || (0, _sessionKeyUtilsQDNZHCY.i)(sessionKey) || rest.startsWith("hook:") || rest.startsWith("node:") || rest === "heartbeat" || rest.endsWith(":heartbeat") || rest.includes(":heartbeat:");
}
...
function normalizeStoreSessionKey(sessionKey) {
  return (0, _stringCoerceLndEvhRk.a)(sessionKey);
}
...
function resolveMaintenanceConfig() {
  let maintenance;
  try {
    maintenance = (0, _io5xE1dPMK.i)().session?.maintenance;
  } catch {}
...
function normalizeSessionEntryDelivery(entry) {
  const normalized = (0, _deliveryContextSharedDk707JJ.a)({
...
function normalizeSessionStore(store) {
  ...
  for (const [key, entry] of Object.entries(store)) {
    if (!entry) continue;
    const normalized = stripPersistedSkillsCache(normalizeSessionEntryDelivery((0, _typesK3POMgTC.a)(entry)));
    if (normalized !== entry) {
