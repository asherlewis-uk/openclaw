"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.S = runWithDiagnosticTraceContext;exports._ = getActiveDiagnosticTraceContext;exports.a = hasPendingInternalDiagnosticEvent;exports.b = isValidDiagnosticTraceId;exports.c = onInternalDiagnosticEvent;exports.d = waitForDiagnosticEventsDrained;exports.f = createChildDiagnosticTraceContext;exports.g = freezeDiagnosticTraceContext;exports.h = formatDiagnosticTraceparent;exports.i = emitTrustedDiagnosticEvent;exports.l = resetDiagnosticEventsForTest;exports.m = createDiagnosticTraceContextFromActiveScope;exports.n = emitDiagnosticEvent;exports.o = isDiagnosticsEnabled;exports.p = createDiagnosticTraceContext;exports.r = emitFailoverEvent;exports.s = onDiagnosticEvent;exports.t = areDiagnosticsEnabledForProcess;exports.u = setDiagnosticsEnabledForProcess;exports.v = isValidDiagnosticSpanId;exports.x = parseDiagnosticTraceparent;exports.y = isValidDiagnosticTraceFlags;var _prototypeKeysCxs5UffD = require("./prototype-keys-Cxs5UffD.js");
...
function createDiagnosticTraceScopeState() {
  return {
    ...
    storage: new _nodeAsync_hooks.AsyncLocalStorage()
  };
}
function isDiagnosticTraceScopeState(value) {
  if (!value || typeof value !== "object") return false;
  const candidate = value;
  return candidate.marker === DIAGNOSTIC_TRACE_SCOPE_STATE_KEY && candidate.storage instanceof _nodeAsync_hooks.AsyncLocalStorage;
}
...
function emitDiagnosticEventWithTrust(event, trusted) {
  ...
  if (ASYNC_DIAGNOSTIC_EVENT_TYPES.has(enriched.type)) {
    if (state.asyncQueue.length >= MAX_ASYNC_DIAGNOSTIC_EVENTS) {
      if (!trusted || !PRIORITY_ASYNC_DIAGNOSTIC_EVENT_TYPES.has(enriched.type)) return;
