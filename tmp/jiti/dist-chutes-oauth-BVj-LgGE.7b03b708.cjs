"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = refreshChutesTokens;exports.i = parseOAuthCallbackInput;exports.n = exchangeChutesCodeForTokens;exports.r = generateChutesPkce;exports.t = void 0;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
var _nodeCrypto = require("node:crypto");
//#region src/agents/chutes-oauth.ts
const CHUTES_OAUTH_ISSUER = "https://api.chutes.ai";
const CHUTES_AUTHORIZE_ENDPOINT = exports.t = `${CHUTES_OAUTH_ISSUER}/idp/authorize`;
...
function parseOAuthCallbackInput(input, expectedState) {
  ...
  const code = (0, _stringCoerceLndEvhRk.c)(url.searchParams.get("code"));
  const state = (0, _stringCoerceLndEvhRk.c)(url.searchParams.get("state"));
...
async function refreshChutesTokens(params) {
  ...
  const clientSecret = (0, _stringCoerceLndEvhRk.c)(process.env.CHUTES_CLIENT_SECRET);
  const body = new URLSearchParams({
