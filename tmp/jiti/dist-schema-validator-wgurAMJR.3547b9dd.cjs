...
const _require = (0, _nodeModule.createRequire)("file:///Users/asherlewis/.nvm/versions/node/v22.22.2/lib/node_modules/openclaw/dist/schema-validator-wgurAMJR.js");
...
function formatAjvErrors(errors) {
  ...
  return errors.map((error) => {
    ...
    return {
      path,
      message,
      text: `${(0, _safeTextC1oixi3E.t)(path)}: ${(0, _safeTextC1oixi3E.t)(message)}`,
