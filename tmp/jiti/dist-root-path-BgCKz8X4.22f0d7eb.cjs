"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveRootPathSync;exports.n = resolvePathViaExistingAncestorSync;exports.r = resolveRootPath;exports.t = void 0;var _pathBlG8lhgR = require("./path-BlG8lhgR.js");
...
function handleLexicalLstatFailure(params) {
  if (!(0, _pathBlG8lhgR.r)(params.error)) return false;
...
function applyResolvedSymlinkHop(params) {
  if (!(0, _pathBlG8lhgR.i)(params.rootCanonicalPath, params.linkCanonical)) throw symlinkEscapeError({
    boundaryLabel: params.boundaryLabel,
    rootCanonicalPath: params.rootCanonicalPath,
...
function createBoundaryResolutionContext(params) {
  const lexicalInside = (0, _pathBlG8lhgR.i)(params.rootPath, params.absolutePath);
...
async function resolveOutsideLexicalCanonicalPathAsync(params) {
  if ((0, _pathBlG8lhgR.i)(params.rootPath, params.absolutePath)) return;
...
function assertLexicalBoundaryOrCanonicalAlias(params) {
  ...
  if ((0, _pathBlG8lhgR.i)(params.rootCanonicalPath, params.canonicalOutsideLexicalPath)) return;
...
async function getPathKind(absolutePath, preserveFinalSymlink) {
  try {
    ...
    if ((0, _pathBlG8lhgR.r)(error)) return {
      exists: false,
      kind: "missing"
    };
    throw error;
...
function relativeInsideRoot(rootPath, targetPath) {
  ...
  if ((0, _pathBlG8lhgR.o)(relative)) return "";
  return relative;
}
function assertInsideBoundary(params) {
  if ((0, _pathBlG8lhgR.i)(params.rootCanonicalPath, params.candidatePath)) return;
...
async function pathExists(targetPath) {
  try {
    ...
    if ((0, _pathBlG8lhgR.r)(error)) return false;
    throw error;
  }
}
