"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = parseAssistantTextSignature;exports.i = normalizeAssistantPhase;exports.n = extractAssistantVisibleText;exports.o = resolveAssistantEventPhase;exports.r = extractFirstTextBlock;exports.s = resolveAssistantMessagePhase;exports.t = extractAssistantTextForPhase;var _stringCoerceLndEvhRk = require("./string-coerce-LndEvhRk.js");
//#region src/shared/chat-message-content.ts
function extractFirstTextBlock(message) {
  if (!message || typeof message !== "object") return;
  const content = message.content;
  const inline = (0, _stringCoerceLndEvhRk.f)(content);
  if (inline !== void 0) return inline;
  if (!Array.isArray(content) || content.length === 0) return;
  const first = content[0];
  if (!first || typeof first !== "object") return;
  return (0, _stringCoerceLndEvhRk.f)(first.text);
}
