"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = renderCmdSetAssignment;exports.i = parseCmdSetAssignment;exports.n = quoteCmdScriptArg;exports.r = assertNoCmdLineBreak;exports.t = parseCmdScriptCommandLine;var _argSplitBIyUChOU = require("./arg-split-BIyUChOU.js");
...
function parseCmdScriptCommandLine(value) {
  return (0, _argSplitBIyUChOU.t)(value, { escapeMode: "backslash-quote-only" }).map(unescapeCmdScriptArg);
}
//#endregion /* v9-265ddca31eedebb7 */
