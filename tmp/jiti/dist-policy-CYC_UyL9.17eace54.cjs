"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = assertNoOAuthSecretRefPolicyViolations;var _typesSecretsBxqheYvy = require("./types.secrets-BxqheYvy.js");
...
function hasSecretRefInput(params) {
  return (0, _typesSecretsBxqheYvy.m)({
    value: params.value,
...
function collectTypeOAuthSecretRefViolations(params) {
  ...
  "keyRef"])
  {
    if ((0, _typesSecretsBxqheYvy.o)(record[field], params.defaults) === null) continue;
