...
function shouldLoadChannelPluginInSetupRuntime(params) {
  ...
  return !params.manifestChannels.some((channelId) => (0, _channelConfiguredMsxgGeYA.t)(params.cfg, channelId, params.env));
}
