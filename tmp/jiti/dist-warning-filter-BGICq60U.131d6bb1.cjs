"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = shouldIgnoreWarning;exports.t = installProcessWarningFilter;var _globalSingletonB2nbp4Tq = require("./global-singleton-B2nbp4Tq.js");
...
function installProcessWarningFilter() {
  const state = (0, _globalSingletonB2nbp4Tq.n)(warningFilterKey, () => ({ installed: false }));
