"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = fetchWithRuntimeDispatcherOrMockedGlobal;exports.r = isMockedFetch;exports.t = fetchWithRuntimeDispatcher;var _undiciRuntimeDzZbpePE = require("./undici-runtime-DzZbpePE.js");
...
function normalizeRuntimeRequestInit(init, RuntimeFormData) {
  if (!init) return init;
  const normalizedHeaders = (0, _fetchHeadersDaqi8X9C.t)(init.headers);
...
async function fetchWithRuntimeDispatcher(input, init) {
  const runtimeDeps = (0, _undiciRuntimeDzZbpePE.a)();
