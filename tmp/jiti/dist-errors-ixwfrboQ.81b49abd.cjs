"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = formatUncaughtError;exports.c = readErrorName;exports.i = formatErrorMessage;exports.l = stringifyNonErrorCause;exports.n = detectErrorKind;exports.o = hasErrnoCode;exports.r = extractErrorCode;exports.s = isErrno;exports.t = collectErrorGraphCandidates;var _redactCxqQQvmK = require("./redact-CxqQQvmK.js");
...
function formatErrorMessage(err) {
  ...
  return (0, _redactCxqQQvmK.s)(formatted);
}
/**
...
function formatUncaughtError(err) {
  ...
  if (err instanceof Error) return (0, _redactCxqQQvmK.s)(err.stack ?? err.message ?? err.name);
