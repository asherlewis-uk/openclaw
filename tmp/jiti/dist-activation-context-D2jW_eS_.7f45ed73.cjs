"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveBundledPluginCompatibleLoadValues;exports.r = withActivatedPluginIds;exports.t = resolveBundledPluginCompatibleActivationInputs;var _configStateCOhlckC = require("./config-state-COhlckC5.js");
...
function applyPluginCompatibilityOverrides(params) {
  const allowlistCompat = params.compat?.allowlistPluginIds?.length ? (0, _bundledCompatDMyny7PJ.t)({
    config: params.config,
    pluginIds: params.compat.allowlistPluginIds
  }) : params.config;
  const enablementCompat = params.compat?.enablementPluginIds?.length ? (0, _bundledCompatDMyny7PJ.n)({
    config: allowlistCompat,
    pluginIds: params.compat.enablementPluginIds
  }) : allowlistCompat;
  return params.compat?.vitestPluginIds?.length ? (0, _bundledCompatDMyny7PJ.r)({
...
function applyPluginAutoEnableForActivation(params) {
  const currentSnapshot = (0, _pluginRegistryBZohWtpt.v)({
    config: params.config,
    env: params.env,
    workspaceDir: params.workspaceDir,
    allowWorkspaceScopedSnapshot: true
  });
  const defaultDiscoverySnapshot = (0, _configStateCOhlckC.s)(params.config.plugins).loadPaths.length === 0 ? (0, _pluginRegistryBZohWtpt.v)({
    env: params.env,
    workspaceDir: params.workspaceDir,
    allowWorkspaceScopedSnapshot: true,
  ...
  return (0, _pluginAutoEnableCa3CdPro.t)({
    config: params.config,
    env: params.env,
...
function resolvePluginActivationSnapshot(params) {
  ...
  return {
    ...
    normalized: (0, _configStateCOhlckC.s)(resolvedConfig?.plugins),
    activationSourceConfig: rawConfig,
    activationSource: (0, _configStateCOhlckC.n)({ config: rawConfig }),
...
function resolvePluginActivationInputs(params) {
  ...
  return {
    ...
    config,
    normalized: (0, _configStateCOhlckC.s)(config?.plugins),
