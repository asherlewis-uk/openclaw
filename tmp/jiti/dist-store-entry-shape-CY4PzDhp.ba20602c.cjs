"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = normalizePersistedSessionEntryShape;var _pathsRbVDOqFp = require("./paths-RbVDOqFp.js");
...
function normalizeTranscriptSessionId(value) {
  try {
    return (0, _pathsRbVDOqFp.d)(value);
  } catch {
    return;
  }
}
