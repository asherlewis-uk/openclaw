"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = waitUntilAbort;exports.i = runPassiveAccountLifecycle;exports.n = createChannelRunQueue;exports.o = createRunStateMachine;exports.r = keepHttpServerTaskAlive;exports.t = createAccountStatusSink;var _keyedAsyncQueueIcOnXu2Z = require("./keyed-async-queue-icOnXu2Z.js");
...
function createRunStateMachine(params) {
  ...
  if (params.abortSignal?.aborted) onAbort();else
...
function createChannelRunQueue(params) {
  const queue = new _keyedAsyncQueueIcOnXu2Z.t();
...
async function keepHttpServerTaskAlive(params) {
  ...
  if (abortSignal) if (abortSignal.aborted) triggerAbort();else
