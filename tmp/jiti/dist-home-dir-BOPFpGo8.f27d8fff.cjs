"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveOsHomeRelativePath;exports.c = resolveUserPath;exports.i = resolveOsHomeDir;exports.n = resolveEffectiveHomeDir;exports.o = resolveRequiredHomeDir;exports.r = resolveHomeRelativePath;exports.s = resolveRequiredOsHomeDir;exports.t = expandHomePrefix;var _nodePath = _interopRequireDefault(require("node:path"));
...
function resolveRawOsHomeDir(env, homedir) {
  return normalize$1(env.HOME) ?? normalize$1(env.USERPROFILE) ?? normalizeSafe(homedir);
}
