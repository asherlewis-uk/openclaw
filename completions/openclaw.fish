...
complete -c openclaw -n "__fish_seen_subcommand_from skills" -a "install" -d 'Install a skill from ClawHub, git, or a local directory'
complete -c openclaw -n "__fish_seen_subcommand_from skills" -a "update" -d 'Update ClawHub-installed skills in the active or shared managed directory'
...
complete -c openclaw -n "__fish_seen_subcommand_from install" -l global -d 'Install into the shared managed skills directory'
...
complete -c openclaw -n "__fish_seen_subcommand_from install" -l as -d 'Install a git/local skill under this slug'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l all -d 'Update all tracked ClawHub skills'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l global -d 'Update skills in the shared managed skills directory'
