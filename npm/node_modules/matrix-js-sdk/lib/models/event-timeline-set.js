...
export class EventTimelineSet extends TypedEventEmitter {
  ...
  addLiveEvent(event, _ref) {
    var duplicateStrategy = _ref.duplicateStrategy,
      fromCache = _ref.fromCache,
      roomState = _ref.roomState,
      timelineWasEmpty = _ref.timelineWasEmpty,
      addToState = _ref.addToState;
    if (this.filter) {
  ...
  addEventToTimeline(event, timeline, _ref2) {
    var toStartOfTimeline = _ref2.toStartOfTimeline,
      _ref2$fromCache = _ref2.fromCache,
      fromCache = _ref2$fromCache === void 0 ? false : _ref2$fromCache,
      roomState = _ref2.roomState,
      timelineWasEmpty = _ref2.timelineWasEmpty,
      addToState = _ref2.addToState;
  ...
  canContain(event) {
    ...
    var _this$room$eventShoul = this.room.eventShouldLiveIn(event),
      threadId = _this$room$eventShoul.threadId,
      shouldLiveInRoom = _this$room$eventShoul.shouldLiveInRoom,
      shouldLiveInThread = _this$room$eventShoul.shouldLiveInThread;
    if (this.thread) {
