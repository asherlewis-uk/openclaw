...
export class RoomStickyEventsStore extends TypedEventEmitter {
  constructor() {
    ...
    _defineProperty(this, "cleanExpiredStickyEvents", () => {
      ...
      for (var _ref3 of this.stickyEventsMap.entries()) {
        var _this$stickyEventsMap;
        var _ref2 = _slicedToArray(_ref3, 2);
        var eventType = _ref2[0];
        var innerEvents = _ref2[1];
        for (var _ref6 of innerEvents) {
          var _ref5 = _slicedToArray(_ref6, 2);
          var innerMapKey = _ref5[0];
          var _ref5$ = _toArray(_ref5[1]);
          var currentEvent = _ref5$[0];
          var previousEvents = _arrayLikeToArray(_ref5$).slice(1);
  ...
  *getStickyEvents() {
  ...
  handleRedaction(redactedEvent) {
    ...
    if (typeof redactedEvent !== "string" && !redactedEvent.isRedacted()) {
      ...
      var _ref7 = (_innerMap$get = innerMap.get(mapKey)) !== null && _innerMap$get !== void 0 ? _innerMap$get : [],
        _ref8 = _toArray(_ref7),
        currentEvent = _ref8[0],
        previousEvents = _arrayLikeToArray(_ref8).slice(1);
      if (!currentEvent) {
    ...
    for (var _innerMap of this.stickyEventsMap.values()) {
      for (var _ref1 of _innerMap.values()) {
        var _ref0 = _slicedToArray(_ref1, 1);
        var _currentEvent = _ref0[0];
