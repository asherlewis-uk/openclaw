...
export class Room extends ReadReceipt {
  ...
  clearNotificationsOnReceipt(event) {
    ...
    for (var receiptGroup of Object.values(content)) {
      for (var _ref4 of Object.entries(receiptGroup)) {
        ...
        for (var _ref7 of Object.entries(userReceipt)) {
  ...
  getOrCreateFilteredTimelineSet(filter) {
    var _ref10 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref10$prepopulateTim = _ref10.prepopulateTimeline,
      prepopulateTimeline = _ref10$prepopulateTim === void 0 ? true : _ref10$prepopulateTim,
      _ref10$useSyncEvents = _ref10.useSyncEvents,
  ...
  createThreadTimelineSet(filterType) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (Thread.hasServerSideListSupport) {
        ...
        Array.from(_this10.threads).forEach(_ref11 => {
  ...
  fetchRoomThreads() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (Thread.hasServerSideListSupport) {
        ...
        var _yield$_this11$client = yield _this11.client.createMessagesRequest(_this11.roomId, "", Number.MAX_SAFE_INTEGER, Direction.Backward, allThreadsFilter),
          events = _yield$_this11$client.chunk;
  ...
  fetchRoomThreadList(filter) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _yield$_this14$client = yield _this14.client.createThreadListMessagesRequest(_this14.roomId, null, undefined, Direction.Backward, timelineSet.threadListType, timelineSet.getFilter()),
        events = _yield$_this14$client.chunk,
        end = _yield$_this14$client.end;
  ...
  findThreadForEvent(event) {
    ...
    var _this$eventShouldLive = this.eventShouldLiveIn(event),
      threadId = _this$eventShouldLive.threadId;
  ...
  processThreadedEvents(events, toStartOfTimeline) {
    ...
    for (var event of events) {
      var _eventsByThread;
      var _this$eventShouldLive2 = this.eventShouldLiveIn(event),
        threadId = _this$eventShouldLive2.threadId,
        shouldLiveInThread = _this$eventShouldLive2.shouldLiveInThread;
      if (shouldLiveInThread && !eventsByThread[threadId]) {
        eventsByThread[threadId] = [];
      }
      (_eventsByThread = eventsByThread[threadId]) === null || _eventsByThread === void 0 || _eventsByThread.push(event);
    }
    Object.entries(eventsByThread).map(_ref13 => {
  ...
  processLiveEvent(event) {
    ...
    if (!txnId && event.getSender() === this.myUserId) {
      ...
      for (var _ref17 of this.txnToEvent) {
  ...
  addLiveEvent(event, addLiveEventOptions) {
    var duplicateStrategy = addLiveEventOptions.duplicateStrategy,
      timelineWasEmpty = addLiveEventOptions.timelineWasEmpty,
      fromCache = addLiveEventOptions.fromCache,
      addToState = addLiveEventOptions.addToState;
  ...
  handleRemoteEcho(remoteEvent, localEvent) {
    ...
    var _this$eventShouldLive3 = this.eventShouldLiveIn(remoteEvent),
      shouldLiveInRoom = _this$eventShouldLive3.shouldLiveInRoom,
      threadId = _this$eventShouldLive3.threadId;
  ...
  updatePendingEvent(event, newStatus, newEventId) {
    ...
    if (newStatus == EventStatus.SENT) {
      ...
      var _this$eventShouldLive4 = this.eventShouldLiveIn(event),
        shouldLiveInRoom = _this$eventShouldLive4.shouldLiveInRoom,
        threadId = _this$eventShouldLive4.threadId;
  ...
  addLiveEvents(events, addLiveEventOptions) {
    ...
    return _asyncToGenerator(function* () {
      var duplicateStrategy = addLiveEventOptions.duplicateStrategy,
        fromCache = addLiveEventOptions.fromCache,
        _addLiveEventOptions$ = addLiveEventOptions.timelineWasEmpty,
        timelineWasEmpty = _addLiveEventOptions$ === void 0 ? false : _addLiveEventOptions$,
        addToState = addLiveEventOptions.addToState;
      ...
      for (var event of events) {
        ...
        var _this15$eventShouldLi = _this15.eventShouldLiveIn(event, neighbouringEvents, threadRoots),
          shouldLiveInRoom = _this15$eventShouldLi.shouldLiveInRoom,
          shouldLiveInThread = _this15$eventShouldLi.shouldLiveInThread,
          _this15$eventShouldLi2 = _this15$eventShouldLi.threadId,
          threadId = _this15$eventShouldLi2 === void 0 ? "" : _this15$eventShouldLi2;
      ...
      Object.entries(eventsByThread).forEach(_ref18 => {
        var _ref19 = _slicedToArray(_ref18, 2),
          threadId = _ref19[0],
          threadEvents = _ref19[1];
  ...
  partitionThreadedEvents(events) {
    ...
    if (this.client.supportsThreads()) {
      ...
      return events.reduce((memo, event) => {
        var _this$eventShouldLive5 = this.eventShouldLiveIn(event, events, threadRoots),
          shouldLiveInRoom = _this$eventShouldLive5.shouldLiveInRoom,
          shouldLiveInThread = _this$eventShouldLive5.shouldLiveInThread,
          threadId = _this$eventShouldLive5.threadId;
        if (shouldLiveInRoom) {
  ...
  calculateRoomName(userId) {
    ...
    if (this.heroes) {
      ...
      otherMembers = otherMembers.filter(_ref20 => {
