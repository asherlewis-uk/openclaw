...
export class PollResponseEvent extends ExtensibleEvent {
  ...
  validateAgainst(poll) {
    ...
    var response = M_POLL_RESPONSE.findIn(this.wireContent);
    if (!Array.isArray(response === null || response === void 0 ? void 0 : response.answers)) {
      this.internalSpoiled = true;
      this.internalAnswerIds = [];
      return;
    }
    var answers = (_response$answers = response === null || response === void 0 ? void 0 : response.answers) !== null && _response$answers !== void 0 ? _response$answers : [];
...
//# sourceMappingURL=PollResponseEvent.js.map