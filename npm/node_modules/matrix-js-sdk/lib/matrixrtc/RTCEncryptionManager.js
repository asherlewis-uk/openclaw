...
import { computeRtcIdentityRaw } from "./membershipData/rtc.js";
...
export class RTCEncryptionManager {
  ...
  onEncryptionKeysChanged, parentLogger, rtcBackendIdProvider) {
    ...
    this.rtcIdentityProvider = rtcBackendIdProvider !== null && rtcBackendIdProvider !== void 0 ? rtcBackendIdProvider : computeRtcIdentityRaw;
  }
  getOwnRtcBackendIdentity() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this.useHashedRtcBackendIdentity) {
        var _this$logger4;
        var _this$ownMembership = _this.ownMembership,
          userId = _this$ownMembership.userId,
          deviceId = _this$ownMembership.deviceId,
          memberId = _this$ownMembership.memberId;
