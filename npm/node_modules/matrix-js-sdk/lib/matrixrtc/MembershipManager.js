...
export class MembershipManager extends TypedEventEmitter {
  ...
  constructor(joinConfig, room, client, slotDescription, parentLogger) {
    ...
    var _ref = [this.client.getUserId(), this.client.getDeviceId()],
      userId = _ref[0],
      deviceId = _ref[1];
  ...
  get delayedLeaveEventDelayMs() {
    var _ref2, _this$delayedLeaveEve, _this$joinConfig4;
    return (_ref2 = (_this$delayedLeaveEve = this.delayedLeaveEventDelayMsOverride) !== null && _this$delayedLeaveEve !== void 0 ? _this$delayedLeaveEve : (_this$joinConfig4 = this.joinConfig) === null || _this$joinConfig4 === void 0 ? void 0 : _this$joinConfig4.delayedLeaveEventDelayMs) !== null && _ref2 !== void 0 ? _ref2 : 8000;
  }
