...
export class LocalIndexedDBStoreBackend {
  ...
  clearOutOfBandMembers(roomId) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var _yield$Promise$all = yield Promise.all([minStateKeyProm, maxStateKeyProm]),
  ...
  getUserProfile(userId) {
    ...
    return _asyncToGenerator(function* () {
      return Promise.resolve().then(() => {
        var txn = _this0.db.transaction(["user_profile"], "readonly");
        var store = txn.objectStore("user_profile");
        return selectQuery(store, [userId], cursor => {
          var _cursor$value2;
          return (_cursor$value2 = cursor.value) === null || _cursor$value2 === void 0 ? void 0 : _cursor$value2.profile;
        }).then(results => results[0]);
      });
    })();
  }
  storeUserProfiles(userProfiles) {
    var _this1 = this;
    return _asyncToGenerator(function* () {
      var txn = _this1.db.transaction(["user_profile"], "readwrite");
      var store = txn.objectStore("user_profile");
      for (var _ref6 of userProfiles.entries()) {
  ...
  removeUserProfiles(userIds) {
    var _this10 = this;
    return _asyncToGenerator(function* () {
      var txn = _this10.db.transaction(["user_profile"], "readwrite");
      var store = txn.objectStore("user_profile");
  ...
  destroy() {
    ...
    return _asyncToGenerator(function* () {
      var _this11$db;
      (_this11$db = _this11.db) === null || _this11$db === void 0 || _this11$db.close();
    })();
  }
}
