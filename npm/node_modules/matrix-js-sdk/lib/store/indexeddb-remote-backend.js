...
export class RemoteIndexedDBStoreBackend {
  ...
  getUserProfile(userId) {
    var _this4 = this;
    return _asyncToGenerator(function* () {
      return _this4.doCmd("getUserProfile", [userId]);
    })();
  }
  storeUserProfiles(userProfiles) {
    var _this5 = this;
    return _asyncToGenerator(function* () {
      yield _this5.doCmd("storeUserProfiles", [userProfiles]);
    })();
  }
  removeUserProfiles(userIds) {
    var _this6 = this;
    return _asyncToGenerator(function* () {
      yield _this6.doCmd("removeUserProfiles", [userIds]);
    })();
  }
  ensureStarted() {
  ...
  destroy() {
    ...
    return _asyncToGenerator(function* () {
      var _this7$worker;
      (_this7$worker = _this7.worker) === null || _this7$worker === void 0 || _this7$worker.terminate();
    })();
  }
}
