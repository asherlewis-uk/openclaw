...
export class MemoryStore {
  ...
  storeAccountDataEvents(events) {
    events.forEach(event => {
      ...
      var isDeleted = !Object.keys(event.getContent()).length;
      if (isDeleted) {
  ...
  getUserProfile(userId) {
    var _this4 = this;
    return _asyncToGenerator(function* () {
      return _this4.userProfiles.get(userId);
    })();
  }
  storeUserProfiles(userProfiles) {
    var _this5 = this;
    return _asyncToGenerator(function* () {
      userProfiles.forEach((profile, userId) => _this5.userProfiles.set(userId, profile));
    })();
  }
  removeUserProfiles(userIds) {
    var _this6 = this;
    return _asyncToGenerator(function* () {
      userIds.forEach(userId => _this6.userProfiles.delete(userId));
    })();
  }
  destroy() {
    return _asyncToGenerator(function* () {})();
