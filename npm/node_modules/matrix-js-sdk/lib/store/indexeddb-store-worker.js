...
export class IndexedDBStoreWorker {
  ...
  constructor(postMessage) {
    ...
    _defineProperty(this, "onMessage", ev => {
      var _this$backend, _this$backend2, _this$backend3, _this$backend4, _this$backend5, _this$backend6, _this$backend7, _this$backend8, _this$backend9, _this$backend0, _this$backend1, _this$backend10, _this$backend11, _this$backend12, _this$backend13, _this$backend14, _this$backend15, _this$backend16, _this$backend17;
      var msg = ev.data;
      var prom;
      switch (msg.command) {
        case "setupWorker":
        ...
        case "removeToDeviceBatch":
          ...
          break;
        case "getUserProfile":
          prom = (_this$backend15 = this.backend) === null || _this$backend15 === void 0 ? void 0 : _this$backend15.getUserProfile(msg.args[0]);
          break;
        case "storeUserProfiles":
          prom = (_this$backend16 = this.backend) === null || _this$backend16 === void 0 ? void 0 : _this$backend16.storeUserProfiles(msg.args[0]);
          break;
        case "removeUserProfiles":
          prom = (_this$backend17 = this.backend) === null || _this$backend17 === void 0 ? void 0 : _this$backend17.removeUserProfiles(msg.args[0]);
          break;
      }
      if (prom === undefined) {
        this.postMessage({
