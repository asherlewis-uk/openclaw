...
export var ClientEvent = /*#__PURE__*/function (ClientEvent) {
  ...
  ClientEvent["UserProfileUpdate"] = "userProfileUpdate";
  return ClientEvent;
}({});
...
export class MatrixClient extends TypedEventEmitter {
  ...
  initRustCrypto() {
    ...
    return _asyncToGenerator(function* () {
      ...
      _this6.on(RoomStateEvent.Events, rustCrypto.onRoomStateEvent.bind(rustCrypto));
  ...
  invite(roomId, userId) {
    var _arguments10 = arguments,
      _this31 = this;
    return _asyncToGenerator(function* () {
      var _this31$getRoom$getHi, _this31$getRoom;
      ...
      var historyVisibility = (_this31$getRoom$getHi = (_this31$getRoom = _this31.getRoom(roomId)) === null || _this31$getRoom === void 0 ? void 0 : _this31$getRoom.getHistoryVisibility()) !== null && _this31$getRoom$getHi !== void 0 ? _this31$getRoom$getHi : HistoryVisibility.Shared;
      ...
      if ([HistoryVisibility.Invited, HistoryVisibility.Joined].includes(historyVisibility)) {
        _this31.logger.debug("Not sharing message history as the room history visibility is currently unshared");
      } else {
  ...
  getExtendedProfileProperty(userId, key) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var storedProfile = yield _this65.store.getUserProfile(userId);
      if ((storedProfile === null || storedProfile === void 0 ? void 0 : storedProfile[key]) !== undefined) {
      ...
      yield _this65.store.storeUserProfiles(new Map([[userId, profile]]));
      return profile[key];
    })();
  }
