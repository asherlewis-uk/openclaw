...
export class GroupCallEventHandler {
  ...
  createGroupCallFromRoomStateEvent(event) {
    ...
    if (content !== null && content !== void 0 && content.dataChannelsEnabled && content !== null && content !== void 0 && content.dataChannelOptions) {
      ...
      var _content$dataChannelO = content.dataChannelOptions,
        ordered = _content$dataChannelO.ordered,
        maxPacketLifeTime = _content$dataChannelO.maxPacketLifeTime,
        maxRetransmits = _content$dataChannelO.maxRetransmits,
        protocol = _content$dataChannelO.protocol;
      dataChannelOptions = {
        ordered,
        maxPacketLifeTime,
        maxRetransmits,
