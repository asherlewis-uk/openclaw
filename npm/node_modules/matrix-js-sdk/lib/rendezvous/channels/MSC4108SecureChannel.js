...
export class MSC4108SecureChannel {
  ...
  generateCode(mode, serverName) {
    ...
    return _asyncToGenerator(function* () {
      var url = _this.rendezvousSession.url;
      if (!url) {
  ...
  connect() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (_this2.theirPublicKey) {
        ...
        var _this2$secureChannel$ = _this2.secureChannel.establish_inbound_channel(loginInitiateMessage),
          channel = _this2$secureChannel$.channel,
