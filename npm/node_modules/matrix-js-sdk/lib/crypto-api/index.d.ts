...
import { type BackupTrustInfo, type KeyBackupCheck, type KeyBackupInfo, type KeyBackupRestoreOpts, type KeyBackupRestoreResult } from "./keybackup.ts";
...
export declare class UserVerificationStatus {
    ...
    /** @internal */
    constructor(crossSigningVerified: boolean, crossSigningVerifiedBefore: boolean, known: boolean, needsUserApproval?: boolean);
    /**
 ...
 */
export declare enum ImportRoomKeyStage {
    /**
 ...
 */
export declare class DecryptionKeyDoesNotMatchError extends Error {
