  ...
  processSyncResponse(syncEventData, data) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield Promise.all(inviteRooms.map(/*#__PURE__*/function () {
        var _ref1 = _asyncToGenerator(function* (inviteObj) {
      ...
      yield Promise.all(joinRooms.map(/*#__PURE__*/function () {
        var _ref10 = _asyncToGenerator(function* (joinObj) {
          ...
          if (unreadThreadNotifications) {
            ...
            for (var _ref13 of Object.entries(unreadThreadNotifications)) {
              var _ref12 = _slicedToArray(_ref13, 2);
              var threadId = _ref12[0];
              var unreadNotification = _ref12[1];
      ...
      yield Promise.all(leaveRooms.map(/*#__PURE__*/function () {
        var _ref14 = _asyncToGenerator(function* (leaveObj) {
          var room = leaveObj.room;
      ...
      yield Promise.all(knockRooms.map(/*#__PURE__*/function () {
        var _ref15 = _asyncToGenerator(function* (knockObj) {
